...
public class _COMMCONFIG {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_LONG.withName("dwProviderSubType"),
        winapi.C_LONG.withName("dwProviderOffset"),
        winapi.C_LONG.withName("dwProviderSize"),
        MemoryLayout.sequenceLayout(1, winapi.C_SHORT).withName("wcProviderData"),
