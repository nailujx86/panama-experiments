...
public class _STORAGE_RPMB_DATA_FRAME {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.sequenceLayout(196, winapi.C_CHAR).withName("Stuff"),
        MemoryLayout.sequenceLayout(32, winapi.C_CHAR).withName("KeyOrMAC"),
        MemoryLayout.sequenceLayout(256, winapi.C_CHAR).withName("Data"),
        MemoryLayout.sequenceLayout(16, winapi.C_CHAR).withName("Nonce"),
        MemoryLayout.sequenceLayout(4, winapi.C_CHAR).withName("WriteCounter"),
        MemoryLayout.sequenceLayout(2, winapi.C_CHAR).withName("Address"),
        MemoryLayout.sequenceLayout(2, winapi.C_CHAR).withName("BlockCount"),
        MemoryLayout.sequenceLayout(2, winapi.C_CHAR).withName("OperationResult"),
        MemoryLayout.sequenceLayout(2, winapi.C_CHAR).withName("RequestOrResponseType")
