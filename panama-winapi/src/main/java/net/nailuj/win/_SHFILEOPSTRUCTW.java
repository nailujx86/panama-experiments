...
public class _SHFILEOPSTRUCTW {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_INT.withName("wFunc"),
        MemoryLayout.paddingLayout(4),
        winapi.C_POINTER.withName("pFrom"),
        winapi.C_POINTER.withName("pTo"),
        winapi.C_SHORT.withName("fFlags"),
        MemoryLayout.paddingLayout(2),
        winapi.C_INT.withName("fAnyOperationsAborted"),
        winapi.C_POINTER.withName("hNameMappings"),
        winapi.C_POINTER.withName("lpszProgressTitle")
