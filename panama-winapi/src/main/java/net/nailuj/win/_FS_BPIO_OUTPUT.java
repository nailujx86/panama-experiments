...
public class _FS_BPIO_OUTPUT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_INT.withName("Operation"),
        winapi.C_INT.withName("OutFlags"),
    ...
    private static final GroupLayout Enable$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$17581:5"), groupElement("Enable"));
    ...
    private static final GroupLayout Query$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$17581:5"), groupElement("Query"));
    ...
    private static final GroupLayout VolumeStackResume$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$17581:5"), groupElement("VolumeStackResume"));
    ...
    private static final GroupLayout StreamResume$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$17581:5"), groupElement("StreamResume"));
    ...
    private static final GroupLayout GetInfo$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$17581:5"), groupElement("GetInfo"));
