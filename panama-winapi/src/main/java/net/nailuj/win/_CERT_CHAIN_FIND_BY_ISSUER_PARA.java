...
public class _CERT_CHAIN_FIND_BY_ISSUER_PARA {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_POINTER.withName("pszUsageIdentifier"),
        winapi.C_LONG.withName("dwKeySpec"),
        winapi.C_LONG.withName("dwAcquirePrivateKeyFlags"),
        winapi.C_LONG.withName("cIssuer"),
        MemoryLayout.paddingLayout(4),
        winapi.C_POINTER.withName("rgIssuer"),
        winapi.C_POINTER.withName("pfnFindCallback"),
        winapi.C_POINTER.withName("pvFindArg")
