...
public class tagPAINTSTRUCT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_INT.withName("fErase"),
        tagRECT.layout().withName("rcPaint"),
        winapi.C_INT.withName("fRestore"),
        winapi.C_INT.withName("fIncUpdate"),
        MemoryLayout.sequenceLayout(32, winapi.C_CHAR).withName("rgbReserved"),
