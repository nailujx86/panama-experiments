...
public class _FILE_RENAME_INFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.unionLayout(
            winapi.C_CHAR.withName("ReplaceIfExists"),
            winapi.C_LONG.withName("Flags")
        ).withName("$anon$9113:5"),
        MemoryLayout.paddingLayout(4),
        winapi.C_POINTER.withName("RootDirectory"),
    ...
    private static final OfByte ReplaceIfExists$LAYOUT = (OfByte)$LAYOUT.select(groupElement("$anon$9113:5"), groupElement("ReplaceIfExists"));
    ...
    private static final OfInt Flags$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$9113:5"), groupElement("Flags"));
