...
public class OPENCARDNAMEW {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_LONG_LONG.withName("hSCardContext"),
        winapi.C_POINTER.withName("lpstrGroupNames"),
        winapi.C_LONG.withName("nMaxGroupNames"),
        MemoryLayout.paddingLayout(4),
        winapi.C_POINTER.withName("lpstrCardNames"),
        winapi.C_LONG.withName("nMaxCardNames"),
        MemoryLayout.paddingLayout(4),
        winapi.C_POINTER.withName("rgguidInterfaces"),
        winapi.C_LONG.withName("cguidInterfaces"),
        MemoryLayout.paddingLayout(4),
        winapi.C_POINTER.withName("lpstrRdr"),
        winapi.C_LONG.withName("nMaxRdr"),
        MemoryLayout.paddingLayout(4),
        winapi.C_POINTER.withName("lpstrCard"),
        winapi.C_LONG.withName("nMaxCard"),
        MemoryLayout.paddingLayout(4),
        winapi.C_POINTER.withName("lpstrTitle"),
        winapi.C_LONG.withName("dwFlags"),
        MemoryLayout.paddingLayout(4),
        winapi.C_POINTER.withName("pvUserData"),
        winapi.C_LONG.withName("dwShareMode"),
        winapi.C_LONG.withName("dwPreferredProtocols"),
        winapi.C_LONG.withName("dwActiveProtocol"),
        MemoryLayout.paddingLayout(4),
        winapi.C_POINTER.withName("lpfnConnect"),
        winapi.C_POINTER.withName("lpfnCheck"),
        winapi.C_POINTER.withName("lpfnDisconnect"),
        winapi.C_LONG_LONG.withName("hCardHandle")
