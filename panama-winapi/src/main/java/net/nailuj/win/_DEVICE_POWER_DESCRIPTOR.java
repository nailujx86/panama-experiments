...
public class _DEVICE_POWER_DESCRIPTOR {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_CHAR.withName("DeviceAttentionSupported"),
        winapi.C_CHAR.withName("AsynchronousNotificationSupported"),
        winapi.C_CHAR.withName("IdlePowerManagementEnabled"),
        winapi.C_CHAR.withName("D3ColdEnabled"),
        winapi.C_CHAR.withName("D3ColdSupported"),
        winapi.C_CHAR.withName("NoVerifyDuringIdlePower"),
        MemoryLayout.sequenceLayout(2, winapi.C_CHAR).withName("Reserved"),
        winapi.C_LONG.withName("IdleTimeoutInMS")
