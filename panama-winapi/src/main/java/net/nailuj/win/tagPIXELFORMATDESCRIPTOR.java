...
public class tagPIXELFORMATDESCRIPTOR {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_SHORT.withName("nSize"),
        winapi.C_SHORT.withName("nVersion"),
        winapi.C_LONG.withName("dwFlags"),
        winapi.C_CHAR.withName("iPixelType"),
        winapi.C_CHAR.withName("cColorBits"),
        winapi.C_CHAR.withName("cRedBits"),
        winapi.C_CHAR.withName("cRedShift"),
        winapi.C_CHAR.withName("cGreenBits"),
        winapi.C_CHAR.withName("cGreenShift"),
        winapi.C_CHAR.withName("cBlueBits"),
        winapi.C_CHAR.withName("cBlueShift"),
        winapi.C_CHAR.withName("cAlphaBits"),
        winapi.C_CHAR.withName("cAlphaShift"),
        winapi.C_CHAR.withName("cAccumBits"),
        winapi.C_CHAR.withName("cAccumRedBits"),
        winapi.C_CHAR.withName("cAccumGreenBits"),
        winapi.C_CHAR.withName("cAccumBlueBits"),
        winapi.C_CHAR.withName("cAccumAlphaBits"),
        winapi.C_CHAR.withName("cDepthBits"),
        winapi.C_CHAR.withName("cStencilBits"),
        winapi.C_CHAR.withName("cAuxBuffers"),
        winapi.C_CHAR.withName("iLayerType"),
        winapi.C_CHAR.withName("bReserved"),
        winapi.C_LONG.withName("dwLayerMask"),
        winapi.C_LONG.withName("dwVisibleMask"),
        winapi.C_LONG.withName("dwDamageMask")
