...
public class _STORAGE_ZONED_DEVICE_DESCRIPTOR {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_INT.withName("DeviceType"),
        winapi.C_LONG.withName("ZoneCount"),
        _STORAGE_ZONED_DEVICE_DESCRIPTOR.ZoneAttributes.layout().withName("ZoneAttributes"),
        winapi.C_LONG.withName("ZoneGroupCount"),
    ...
    public static class ZoneAttributes {
        ...
        public static class SequentialRequiredZone {
            ...
            private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
                winapi.C_LONG.withName("MaxOpenZoneCount"),
                winapi.C_CHAR.withName("UnrestrictedRead"),
                MemoryLayout.sequenceLayout(3, winapi.C_CHAR).withName("Reserved")
            ).withName("$anon$3314:9");
        ...
        public static class SequentialPreferredZone {
            ...
            private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
                winapi.C_LONG.withName("OptimalOpenZoneCount"),
                winapi.C_LONG.withName("Reserved")
            ).withName("$anon$3324:9");
