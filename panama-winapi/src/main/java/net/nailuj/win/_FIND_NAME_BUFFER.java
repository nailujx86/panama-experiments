...
public class _FIND_NAME_BUFFER {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_CHAR.withName("length"),
        winapi.C_CHAR.withName("access_control"),
        winapi.C_CHAR.withName("frame_control"),
        MemoryLayout.sequenceLayout(6, winapi.C_CHAR).withName("destination_addr"),
        MemoryLayout.sequenceLayout(6, winapi.C_CHAR).withName("source_addr"),
        MemoryLayout.sequenceLayout(18, winapi.C_CHAR).withName("routing_info")
