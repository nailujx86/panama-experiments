...
public class _SET_DISK_ATTRIBUTES {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_CHAR.withName("Persist"),
        MemoryLayout.sequenceLayout(3, winapi.C_CHAR).withName("Reserved1"),
        winapi.C_LONG_LONG.withName("Attributes"),
        winapi.C_LONG_LONG.withName("AttributesMask"),
