...
public class _VIDEOPARAMETERS {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_LONG.withName("dwOffset"),
        winapi.C_LONG.withName("dwCommand"),
        winapi.C_LONG.withName("dwFlags"),
        winapi.C_LONG.withName("dwMode"),
        winapi.C_LONG.withName("dwTVStandard"),
        winapi.C_LONG.withName("dwAvailableModes"),
        winapi.C_LONG.withName("dwAvailableTVStandard"),
        winapi.C_LONG.withName("dwFlickerFilter"),
        winapi.C_LONG.withName("dwOverScanX"),
        winapi.C_LONG.withName("dwOverScanY"),
        winapi.C_LONG.withName("dwMaxUnscaledX"),
        winapi.C_LONG.withName("dwMaxUnscaledY"),
        winapi.C_LONG.withName("dwPositionX"),
        winapi.C_LONG.withName("dwPositionY"),
        winapi.C_LONG.withName("dwBrightness"),
        winapi.C_LONG.withName("dwContrast"),
        winapi.C_LONG.withName("dwCPType"),
        winapi.C_LONG.withName("dwCPCommand"),
        winapi.C_LONG.withName("dwCPStandard"),
        winapi.C_LONG.withName("dwCPKey"),
        winapi.C_LONG.withName("bCP_APSTriggerBits"),
        MemoryLayout.sequenceLayout(256, winapi.C_CHAR).withName("bOEMCopyProtection")
