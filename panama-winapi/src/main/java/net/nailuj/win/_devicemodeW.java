...
public class _devicemodeW {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.sequenceLayout(32, winapi.C_SHORT).withName("dmDeviceName"),
        winapi.C_SHORT.withName("dmSpecVersion"),
        winapi.C_SHORT.withName("dmDriverVersion"),
        winapi.C_SHORT.withName("dmSize"),
        winapi.C_SHORT.withName("dmDriverExtra"),
        winapi.C_LONG.withName("dmFields"),
        MemoryLayout.unionLayout(
            MemoryLayout.structLayout(
                winapi.C_SHORT.withName("dmOrientation"),
                winapi.C_SHORT.withName("dmPaperSize"),
                winapi.C_SHORT.withName("dmPaperLength"),
                winapi.C_SHORT.withName("dmPaperWidth"),
                winapi.C_SHORT.withName("dmScale"),
                winapi.C_SHORT.withName("dmCopies"),
                winapi.C_SHORT.withName("dmDefaultSource"),
                winapi.C_SHORT.withName("dmPrintQuality")
            ).withName("$anon$2261:7"),
            MemoryLayout.structLayout(
                _POINTL.layout().withName("dmPosition"),
                winapi.C_LONG.withName("dmDisplayOrientation"),
                winapi.C_LONG.withName("dmDisplayFixedOutput")
            ).withName("$anon$2272:7")
        ).withName("$anon$2259:5"),
        winapi.C_SHORT.withName("dmColor"),
        winapi.C_SHORT.withName("dmDuplex"),
        winapi.C_SHORT.withName("dmYResolution"),
        winapi.C_SHORT.withName("dmTTOption"),
        winapi.C_SHORT.withName("dmCollate"),
        MemoryLayout.sequenceLayout(32, winapi.C_SHORT).withName("dmFormName"),
        winapi.C_SHORT.withName("dmLogPixels"),
        winapi.C_LONG.withName("dmBitsPerPel"),
        winapi.C_LONG.withName("dmPelsWidth"),
        winapi.C_LONG.withName("dmPelsHeight"),
        MemoryLayout.unionLayout(
            winapi.C_LONG.withName("dmDisplayFlags"),
            winapi.C_LONG.withName("dmNup")
        ).withName("$anon$2288:5"),
        winapi.C_LONG.withName("dmDisplayFrequency"),
        winapi.C_LONG.withName("dmICMMethod"),
        winapi.C_LONG.withName("dmICMIntent"),
        winapi.C_LONG.withName("dmMediaType"),
        winapi.C_LONG.withName("dmDitherType"),
        winapi.C_LONG.withName("dmReserved1"),
        winapi.C_LONG.withName("dmReserved2"),
        winapi.C_LONG.withName("dmPanningWidth"),
        winapi.C_LONG.withName("dmPanningHeight")
