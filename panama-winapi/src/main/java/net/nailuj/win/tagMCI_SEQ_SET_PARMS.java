...
public class tagMCI_SEQ_SET_PARMS {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.align(winapi.C_LONG, 1).withName("dwTempo"),
        winapi.align(winapi.C_LONG, 1).withName("dwPort"),
        winapi.align(winapi.C_LONG, 1).withName("dwSlave"),
        winapi.align(winapi.C_LONG, 1).withName("dwMaster"),
