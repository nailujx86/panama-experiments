...
public class _STORAGE_PROTOCOL_COMMAND {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_INT.withName("ProtocolType"),
        winapi.C_LONG.withName("Flags"),
        winapi.C_LONG.withName("ReturnStatus"),
        winapi.C_LONG.withName("ErrorCode"),
        winapi.C_LONG.withName("CommandLength"),
        winapi.C_LONG.withName("ErrorInfoLength"),
        winapi.C_LONG.withName("DataToDeviceTransferLength"),
        winapi.C_LONG.withName("DataFromDeviceTransferLength"),
        winapi.C_LONG.withName("TimeOutValue"),
        winapi.C_LONG.withName("ErrorInfoOffset"),
        winapi.C_LONG.withName("DataToDeviceBufferOffset"),
        winapi.C_LONG.withName("DataFromDeviceBufferOffset"),
        winapi.C_LONG.withName("CommandSpecific"),
        winapi.C_LONG.withName("Reserved0"),
        winapi.C_LONG.withName("FixedProtocolReturnData"),
        winapi.C_LONG.withName("FixedProtocolReturnData2"),
        MemoryLayout.sequenceLayout(2, winapi.C_LONG).withName("Reserved1"),
        MemoryLayout.sequenceLayout(1, winapi.C_CHAR).withName("Command"),
    ...
    private static final long FixedProtocolReturnData2$OFFSET = 68;
    ...
    private static final long Reserved1$OFFSET = 72;
