...
public class tagACTCTXA {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_POINTER.withName("lpSource"),
        winapi.C_SHORT.withName("wProcessorArchitecture"),
        winapi.C_SHORT.withName("wLangId"),
        MemoryLayout.paddingLayout(4),
        winapi.C_POINTER.withName("lpAssemblyDirectory"),
        winapi.C_POINTER.withName("lpResourceName"),
        winapi.C_POINTER.withName("lpApplicationName"),
        winapi.C_POINTER.withName("hModule")
    ).withName("tagACTCTXA");
