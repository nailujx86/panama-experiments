...
public class IMPORT_OBJECT_HEADER {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_SHORT.withName("Sig1"),
        winapi.C_SHORT.withName("Sig2"),
        winapi.C_SHORT.withName("Version"),
        winapi.C_SHORT.withName("Machine"),
        winapi.C_LONG.withName("TimeDateStamp"),
        winapi.C_LONG.withName("SizeOfData"),
        MemoryLayout.unionLayout(
            winapi.C_SHORT.withName("Ordinal"),
            winapi.C_SHORT.withName("Hint")
        ).withName("$anon$21711:5"),
    ...
    private static final OfShort Ordinal$LAYOUT = (OfShort)$LAYOUT.select(groupElement("$anon$21711:5"), groupElement("Ordinal"));
    ...
    private static final OfShort Hint$LAYOUT = (OfShort)$LAYOUT.select(groupElement("$anon$21711:5"), groupElement("Hint"));
