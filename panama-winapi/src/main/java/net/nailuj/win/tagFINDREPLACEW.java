...
public class tagFINDREPLACEW {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.paddingLayout(4),
        winapi.C_POINTER.withName("lpstrFindWhat"),
        winapi.C_POINTER.withName("lpstrReplaceWith"),
        winapi.C_SHORT.withName("wFindWhatLen"),
        winapi.C_SHORT.withName("wReplaceWithLen"),
        MemoryLayout.paddingLayout(4),
