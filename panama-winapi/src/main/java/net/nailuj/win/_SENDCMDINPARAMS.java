...
public class _SENDCMDINPARAMS {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.align(winapi.C_LONG, 1).withName("cBufferSize"),
        _IDEREGS.layout().withName("irDriveRegs"),
        winapi.C_CHAR.withName("bDriveNumber"),
        MemoryLayout.sequenceLayout(3, winapi.C_CHAR).withName("bReserved"),
        MemoryLayout.sequenceLayout(4, winapi.align(winapi.C_LONG, 1)).withName("dwReserved"),
        MemoryLayout.sequenceLayout(1, winapi.C_CHAR).withName("bBuffer")
