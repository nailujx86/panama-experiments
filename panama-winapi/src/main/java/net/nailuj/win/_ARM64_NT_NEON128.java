...
public class _ARM64_NT_NEON128 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.unionLayout(
        MemoryLayout.structLayout(
            winapi.C_LONG_LONG.withName("Low"),
            winapi.C_LONG_LONG.withName("High")
        ).withName("$anon$6768:5"),
        MemoryLayout.sequenceLayout(2, winapi.C_DOUBLE).withName("D"),
        MemoryLayout.sequenceLayout(4, winapi.C_FLOAT).withName("S"),
        MemoryLayout.sequenceLayout(8, winapi.C_SHORT).withName("H"),
        MemoryLayout.sequenceLayout(16, winapi.C_CHAR).withName("B")
    ...
    private static final OfLong Low$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$6768:5"), groupElement("Low"));
    ...
    private static final OfLong High$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$6768:5"), groupElement("High"));
