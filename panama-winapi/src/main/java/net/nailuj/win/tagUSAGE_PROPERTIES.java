...
public class tagUSAGE_PROPERTIES {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_SHORT.withName("level"),
        winapi.C_SHORT.withName("page"),
        winapi.C_SHORT.withName("usage"),
        MemoryLayout.paddingLayout(2),
        winapi.C_INT.withName("logicalMinimum"),
        winapi.C_INT.withName("logicalMaximum"),
        winapi.C_SHORT.withName("unit"),
        winapi.C_SHORT.withName("exponent"),
        winapi.C_CHAR.withName("count"),
        MemoryLayout.paddingLayout(3),
        winapi.C_INT.withName("physicalMinimum"),
        winapi.C_INT.withName("physicalMaximum")
