...
public class _IDEREGS {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_CHAR.withName("bFeaturesReg"),
        winapi.C_CHAR.withName("bSectorCountReg"),
        winapi.C_CHAR.withName("bSectorNumberReg"),
        winapi.C_CHAR.withName("bCylLowReg"),
        winapi.C_CHAR.withName("bCylHighReg"),
        winapi.C_CHAR.withName("bDriveHeadReg"),
        winapi.C_CHAR.withName("bCommandReg"),
