...
public class _TXFS_GET_TRANSACTED_VERSION {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_LONG.withName("ThisBaseVersion"),
        winapi.C_LONG.withName("LatestVersion"),
        winapi.C_SHORT.withName("ThisMiniVersion"),
        winapi.C_SHORT.withName("FirstMiniVersion"),
        winapi.C_SHORT.withName("LatestMiniVersion"),
