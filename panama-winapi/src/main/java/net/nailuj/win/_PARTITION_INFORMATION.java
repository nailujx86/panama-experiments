...
public class _PARTITION_INFORMATION {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_LONG.withName("HiddenSectors"),
        winapi.C_LONG.withName("PartitionNumber"),
        winapi.C_CHAR.withName("PartitionType"),
        winapi.C_CHAR.withName("BootIndicator"),
        winapi.C_CHAR.withName("RecognizedPartition"),
