...
public class _REFS_SMR_VOLUME_INFO_OUTPUT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_INT.withName("VolumeGcState"),
        winapi.C_LONG.withName("VolumeGcLastStatus"),
        winapi.C_LONG.withName("CurrentGcBandFillPercentage"),
        MemoryLayout.paddingLayout(4),
        MemoryLayout.sequenceLayout(6, winapi.C_LONG_LONG).withName("Unused")
