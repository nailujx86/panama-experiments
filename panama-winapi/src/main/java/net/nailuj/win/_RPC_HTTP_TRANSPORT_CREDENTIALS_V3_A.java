...
public class _RPC_HTTP_TRANSPORT_CREDENTIALS_V3_A {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_POINTER.withName("TransportCredentials"),
        winapi.C_LONG.withName("Flags"),
        winapi.C_LONG.withName("AuthenticationTarget"),
        winapi.C_LONG.withName("NumberOfAuthnSchemes"),
        MemoryLayout.paddingLayout(4),
        winapi.C_POINTER.withName("AuthnSchemes"),
        winapi.C_POINTER.withName("ServerCertificateSubject"),
        winapi.C_POINTER.withName("ProxyCredentials"),
        winapi.C_LONG.withName("NumberOfProxyAuthnSchemes"),
        MemoryLayout.paddingLayout(4),
        winapi.C_POINTER.withName("ProxyAuthnSchemes")
