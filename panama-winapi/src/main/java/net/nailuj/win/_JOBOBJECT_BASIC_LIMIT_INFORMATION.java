...
public class _JOBOBJECT_BASIC_LIMIT_INFORMATION {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_LONG.withName("ActiveProcessLimit"),
        MemoryLayout.paddingLayout(4),
        winapi.C_LONG_LONG.withName("Affinity"),
        winapi.C_LONG.withName("PriorityClass"),
        winapi.C_LONG.withName("SchedulingClass")
