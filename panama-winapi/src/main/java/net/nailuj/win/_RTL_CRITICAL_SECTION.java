...
public class _RTL_CRITICAL_SECTION {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_POINTER.withName("DebugInfo"),
        winapi.C_LONG.withName("LockCount"),
        winapi.C_LONG.withName("RecursionCount"),
        winapi.C_POINTER.withName("OwningThread"),
        winapi.C_POINTER.withName("LockSemaphore"),
        winapi.C_LONG_LONG.withName("SpinCount")
