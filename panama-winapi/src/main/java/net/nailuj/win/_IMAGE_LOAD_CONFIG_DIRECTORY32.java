...
public class _IMAGE_LOAD_CONFIG_DIRECTORY32 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_LONG.withName("DeCommitFreeBlockThreshold"),
        winapi.C_LONG.withName("DeCommitTotalFreeThreshold"),
        winapi.C_LONG.withName("LockPrefixTable"),
        winapi.C_LONG.withName("MaximumAllocationSize"),
        winapi.C_LONG.withName("VirtualMemoryThreshold"),
        winapi.C_LONG.withName("ProcessHeapFlags"),
        winapi.C_LONG.withName("ProcessAffinityMask"),
        winapi.C_SHORT.withName("CSDVersion"),
        winapi.C_SHORT.withName("DependentLoadFlags"),
        winapi.C_LONG.withName("EditList"),
        winapi.C_LONG.withName("SecurityCookie"),
        winapi.C_LONG.withName("SEHandlerTable"),
        winapi.C_LONG.withName("SEHandlerCount"),
        winapi.C_LONG.withName("GuardCFCheckFunctionPointer"),
        winapi.C_LONG.withName("GuardCFDispatchFunctionPointer"),
        winapi.C_LONG.withName("GuardCFFunctionTable"),
        winapi.C_LONG.withName("GuardCFFunctionCount"),
        winapi.C_LONG.withName("GuardFlags"),
        _IMAGE_LOAD_CONFIG_CODE_INTEGRITY.layout().withName("CodeIntegrity"),
        winapi.C_LONG.withName("GuardAddressTakenIatEntryTable"),
        winapi.C_LONG.withName("GuardAddressTakenIatEntryCount"),
        winapi.C_LONG.withName("GuardLongJumpTargetTable"),
        winapi.C_LONG.withName("GuardLongJumpTargetCount"),
        winapi.C_LONG.withName("DynamicValueRelocTable"),
        winapi.C_LONG.withName("CHPEMetadataPointer"),
        winapi.C_LONG.withName("GuardRFFailureRoutine"),
        winapi.C_LONG.withName("GuardRFFailureRoutineFunctionPointer"),
        ...
        winapi.C_LONG.withName("GuardRFVerifyStackPointerFunctionPointer"),
        winapi.C_LONG.withName("HotPatchTableOffset"),
        winapi.C_LONG.withName("Reserved3"),
        winapi.C_LONG.withName("EnclaveConfigurationPointer"),
        winapi.C_LONG.withName("VolatileMetadataPointer"),
        winapi.C_LONG.withName("GuardEHContinuationTable"),
        winapi.C_LONG.withName("GuardEHContinuationCount"),
        winapi.C_LONG.withName("GuardXFGCheckFunctionPointer"),
        winapi.C_LONG.withName("GuardXFGDispatchFunctionPointer"),
        winapi.C_LONG.withName("GuardXFGTableDispatchFunctionPointer"),
        winapi.C_LONG.withName("CastGuardOsDeterminedFailureMode"),
        winapi.C_LONG.withName("GuardMemcpyFunctionPointer")
    ...
    private static final long GuardMemcpyFunctionPointer$OFFSET = 188;
