...
public class _XSTATE_CONFIGURATION {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_LONG_LONG.withName("EnabledFeatures"),
        winapi.C_LONG_LONG.withName("EnabledVolatileFeatures"),
        winapi.C_LONG.withName("Size"),
        MemoryLayout.unionLayout(
            winapi.C_LONG.withName("ControlFlags"),
            MemoryLayout.structLayout(
                MemoryLayout.paddingLayout(4)
            ).withName("$anon$14430:9")
        ).withName("$anon$14428:5"),
        MemoryLayout.sequenceLayout(64, _XSTATE_FEATURE.layout()).withName("Features"),
        winapi.C_LONG_LONG.withName("EnabledSupervisorFeatures"),
        winapi.C_LONG_LONG.withName("AlignedFeatures"),
        winapi.C_LONG.withName("AllFeatureSize"),
        MemoryLayout.sequenceLayout(64, winapi.C_LONG).withName("AllFeatures"),
        MemoryLayout.paddingLayout(4),
        winapi.C_LONG_LONG.withName("EnabledUserVisibleSupervisorFeatures"),
        winapi.C_LONG_LONG.withName("ExtendedFeatureDisableFeatures"),
        winapi.C_LONG.withName("AllNonLargeFeatureSize"),
        winapi.C_SHORT.withName("MaxSveVectorLength"),
        winapi.C_SHORT.withName("Spare1")
    ...
    private static final OfInt ControlFlags$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$14428:5"), groupElement("ControlFlags"));
    ...
    private static final long MaxSveVectorLength$OFFSET = 836;
    ...
    private static final long Spare1$OFFSET = 838;
