...
public class _STORAGE_DEVICE_RESILIENCY_DESCRIPTOR {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_LONG.withName("NameOffset"),
        winapi.C_LONG.withName("NumberOfLogicalCopies"),
        winapi.C_LONG.withName("NumberOfPhysicalCopies"),
        winapi.C_LONG.withName("PhysicalDiskRedundancy"),
        winapi.C_LONG.withName("NumberOfColumns"),
        winapi.C_LONG.withName("Interleave")
