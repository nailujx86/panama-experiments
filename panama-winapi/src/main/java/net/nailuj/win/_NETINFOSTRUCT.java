...
public class _NETINFOSTRUCT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_LONG.withName("cbStructure"),
        winapi.C_LONG.withName("dwProviderVersion"),
        winapi.C_LONG.withName("dwStatus"),
        winapi.C_LONG.withName("dwCharacteristics"),
        winapi.C_LONG_LONG.withName("dwHandle"),
        winapi.C_SHORT.withName("wNetType"),
        MemoryLayout.paddingLayout(2),
        winapi.C_LONG.withName("dwPrinters"),
        winapi.C_LONG.withName("dwDrives"),
