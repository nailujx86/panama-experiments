...
public class _PERSISTENT_RESERVE_COMMAND {
    ...
    public static class PR_IN {
        ...
        private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
            ...
            winapi.C_SHORT.withName("AllocationLength")
        ).withName("$anon$6254:9");
    ...
    private static final GroupLayout PR_IN$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$6252:5"), groupElement("PR_IN"));
    ...
    public static class PR_OUT {
        ...
        private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
            MemoryLayout.paddingLayout(2),
            MemoryLayout.sequenceLayout(0, winapi.C_CHAR).withName("ParameterList")
        ).withName("$anon$6271:9");
    ...
    private static final GroupLayout PR_OUT$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$6252:5"), groupElement("PR_OUT"));
