...
public class tagMONCBSTRUCT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_INT.withName("cb"),
        winapi.C_LONG.withName("dwTime"),
        winapi.C_POINTER.withName("hTask"),
        winapi.C_LONG.withName("dwRet"),
        winapi.C_INT.withName("wType"),
        winapi.C_INT.withName("wFmt"),
        MemoryLayout.paddingLayout(4),
        winapi.C_POINTER.withName("hConv"),
        winapi.C_POINTER.withName("hsz1"),
        winapi.C_POINTER.withName("hsz2"),
        winapi.C_POINTER.withName("hData"),
        winapi.C_LONG_LONG.withName("dwData1"),
        winapi.C_LONG_LONG.withName("dwData2"),
        tagCONVCONTEXT.layout().withName("cc"),
        winapi.C_LONG.withName("cbData"),
        MemoryLayout.sequenceLayout(8, winapi.C_LONG).withName("Data")
