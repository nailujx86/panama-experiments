...
public class _EXCEPTION_RECORD32 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_LONG.withName("ExceptionRecord"),
        winapi.C_LONG.withName("ExceptionAddress"),
        winapi.C_LONG.withName("NumberParameters"),
        MemoryLayout.sequenceLayout(15, winapi.C_LONG).withName("ExceptionInformation")
