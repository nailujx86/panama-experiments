...
public class _DEVICEDUMP_STORAGESTACK_PUBLIC_STATE_RECORD {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.sequenceLayout(16, winapi.C_CHAR).withName("Cdb"),
        MemoryLayout.sequenceLayout(16, winapi.C_CHAR).withName("Command"),
        winapi.align(winapi.C_LONG_LONG, 1).withName("StartTime"),
        winapi.align(winapi.C_LONG_LONG, 1).withName("EndTime"),
        winapi.align(winapi.C_LONG, 1).withName("OperationStatus"),
        winapi.align(winapi.C_LONG, 1).withName("OperationError"),
    ...
    public static class StackSpecific {
        ...
        public static class ExternalStack {
            ...
            private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
                winapi.align(winapi.C_LONG, 1).withName("dwReserved")
            ).withName("$anon$6592:10");
        ...
        public static class AtaPort {
            ...
            private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
                winapi.align(winapi.C_LONG, 1).withName("dwAtaPortSpecific")
            ).withName("$anon$6596:10");
        ...
        public static class StorPort {
            ...
            private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
                winapi.align(winapi.C_LONG, 1).withName("SrbTag")
            ).withName("$anon$6600:10");
