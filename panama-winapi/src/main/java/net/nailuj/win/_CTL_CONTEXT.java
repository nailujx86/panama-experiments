...
public class _CTL_CONTEXT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_POINTER.withName("pbCtlEncoded"),
        winapi.C_LONG.withName("cbCtlEncoded"),
        MemoryLayout.paddingLayout(4),
        winapi.C_POINTER.withName("pCtlInfo"),
        winapi.C_POINTER.withName("hCertStore"),
        winapi.C_POINTER.withName("hCryptMsg"),
        winapi.C_POINTER.withName("pbCtlContent"),
        winapi.C_LONG.withName("cbCtlContent"),
        MemoryLayout.paddingLayout(4)
