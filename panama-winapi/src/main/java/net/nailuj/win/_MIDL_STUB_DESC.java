...
public class _MIDL_STUB_DESC {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_POINTER.withName("RpcInterfaceInformation"),
        ...
        winapi.C_POINTER.withName("apfnNdrRundownRoutines"),
        winapi.C_POINTER.withName("aGenericBindingRoutinePairs"),
        winapi.C_POINTER.withName("apfnExprEval"),
        winapi.C_POINTER.withName("aXmitQuintuple"),
        winapi.C_POINTER.withName("pFormatTypes"),
        winapi.C_INT.withName("fCheckBounds"),
        winapi.C_LONG.withName("Version"),
        winapi.C_POINTER.withName("pMallocFreeStruct"),
        winapi.C_LONG.withName("MIDLVersion"),
        MemoryLayout.paddingLayout(4),
        winapi.C_POINTER.withName("CommFaultOffsets"),
        winapi.C_POINTER.withName("aUserMarshalQuadruple"),
        winapi.C_POINTER.withName("NotifyRoutineTable"),
        winapi.C_LONG_LONG.withName("mFlags"),
        winapi.C_POINTER.withName("CsRoutineTables"),
        winapi.C_POINTER.withName("ProxyServerInfo"),
        winapi.C_POINTER.withName("pExprInfo")
    ...
    public static class IMPLICIT_HANDLE_INFO {
        ...
        private static final GroupLayout $LAYOUT = MemoryLayout.unionLayout(
            winapi.C_POINTER.withName("pAutoHandle"),
            winapi.C_POINTER.withName("pPrimitiveHandle"),
            winapi.C_POINTER.withName("pGenericBindingInfo")
