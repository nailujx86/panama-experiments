...
public class _BCRYPT_DSA_PARAMETER_HEADER_V2 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_LONG.withName("cbLength"),
        winapi.C_LONG.withName("dwMagic"),
        winapi.C_LONG.withName("cbKeyLength"),
        winapi.C_INT.withName("hashAlgorithm"),
        winapi.C_INT.withName("standardVersion"),
        winapi.C_LONG.withName("cbSeedLength"),
        winapi.C_LONG.withName("cbGroupSize"),
        MemoryLayout.sequenceLayout(4, winapi.C_CHAR).withName("Count")
