...
public class _userBITMAP {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_LONG.withName("bmType"),
        winapi.C_LONG.withName("bmWidth"),
        winapi.C_LONG.withName("bmHeight"),
        winapi.C_LONG.withName("bmWidthBytes"),
        winapi.C_SHORT.withName("bmPlanes"),
        winapi.C_SHORT.withName("bmBitsPixel"),
        winapi.C_LONG.withName("cbSize"),
        MemoryLayout.sequenceLayout(1, winapi.C_CHAR).withName("pBuffer"),
