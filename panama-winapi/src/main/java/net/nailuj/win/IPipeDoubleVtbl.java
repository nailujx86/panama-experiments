...
public class IPipeDoubleVtbl {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_POINTER.withName("Pull"),
        winapi.C_POINTER.withName("Push")
    ...
    public static class Pull {
        ...
        private static final MethodHandle UP$MH = winapi.upcallHandle(Pull.Function.class, "apply", $DESC);
    ...
    public static class Push {
        ...
        private static final MethodHandle UP$MH = winapi.upcallHandle(Push.Function.class, "apply", $DESC);
