...
public class _EVENTLOGRECORD {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_LONG.withName("RecordNumber"),
        winapi.C_LONG.withName("TimeGenerated"),
        winapi.C_LONG.withName("TimeWritten"),
        winapi.C_LONG.withName("EventID"),
        winapi.C_SHORT.withName("EventType"),
        winapi.C_SHORT.withName("NumStrings"),
        winapi.C_SHORT.withName("EventCategory"),
        winapi.C_SHORT.withName("ReservedFlags"),
        winapi.C_LONG.withName("ClosingRecordNumber"),
        winapi.C_LONG.withName("StringOffset"),
        winapi.C_LONG.withName("UserSidLength"),
        winapi.C_LONG.withName("UserSidOffset"),
        winapi.C_LONG.withName("DataLength"),
