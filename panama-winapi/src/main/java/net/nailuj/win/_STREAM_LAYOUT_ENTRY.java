...
public class _STREAM_LAYOUT_ENTRY {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_LONG.withName("NextStreamOffset"),
        winapi.C_LONG.withName("Flags"),
        winapi.C_LONG.withName("ExtentInformationOffset"),
        _LARGE_INTEGER.layout().withName("AllocationSize"),
        _LARGE_INTEGER.layout().withName("EndOfFile"),
        winapi.C_LONG.withName("StreamInformationOffset"),
        winapi.C_LONG.withName("AttributeTypeCode"),
        winapi.C_LONG.withName("AttributeFlags"),
        winapi.C_LONG.withName("StreamIdentifierLength"),
        MemoryLayout.sequenceLayout(1, winapi.C_SHORT).withName("StreamIdentifier"),
