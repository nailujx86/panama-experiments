...
public class _CRYPT_OBJECT_LOCATOR_PROVIDER_TABLE {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_POINTER.withName("pfnGet"),
        winapi.C_POINTER.withName("pfnRelease"),
        winapi.C_POINTER.withName("pfnFreePassword"),
        winapi.C_POINTER.withName("pfnFree"),
        winapi.C_POINTER.withName("pfnFreeIdentifier")
