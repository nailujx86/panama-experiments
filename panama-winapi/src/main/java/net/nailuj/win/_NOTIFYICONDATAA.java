...
public class _NOTIFYICONDATAA {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.sequenceLayout(128, winapi.C_CHAR).withName("szTip"),
        winapi.C_LONG.withName("dwState"),
        winapi.C_LONG.withName("dwStateMask"),
        MemoryLayout.sequenceLayout(256, winapi.C_CHAR).withName("szInfo"),
        MemoryLayout.unionLayout(
            winapi.C_INT.withName("uTimeout"),
            winapi.C_INT.withName("uVersion")
        ).withName("$anon$1027:5"),
        MemoryLayout.sequenceLayout(64, winapi.C_CHAR).withName("szInfoTitle"),
