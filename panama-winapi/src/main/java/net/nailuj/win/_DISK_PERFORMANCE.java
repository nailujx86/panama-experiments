...
public class _DISK_PERFORMANCE {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_LONG.withName("QueueDepth"),
        winapi.C_LONG.withName("SplitCount"),
        _LARGE_INTEGER.layout().withName("QueryTime"),
        winapi.C_LONG.withName("StorageDeviceNumber"),
        MemoryLayout.sequenceLayout(8, winapi.C_SHORT).withName("StorageManagerName"),
