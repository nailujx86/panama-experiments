...
public class _SCM_PD_MANAGEMENT_STATUS {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_INT.withName("Health"),
        winapi.C_LONG.withName("NumberOfOperationalStatus"),
        winapi.C_LONG.withName("NumberOfAdditionalReasons"),
        MemoryLayout.sequenceLayout(16, winapi.C_INT).withName("OperationalStatus"),
        MemoryLayout.sequenceLayout(1, winapi.C_INT).withName("AdditionalReasons")
