...
public class _GET_CHANGER_PARAMETERS {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_SHORT.withName("NumberTransportElements"),
        winapi.C_SHORT.withName("NumberStorageElements"),
        winapi.C_SHORT.withName("NumberCleanerSlots"),
        winapi.C_SHORT.withName("NumberIEElements"),
        winapi.C_SHORT.withName("NumberDataTransferElements"),
        winapi.C_SHORT.withName("NumberOfDoors"),
        winapi.C_SHORT.withName("FirstSlotNumber"),
        winapi.C_SHORT.withName("FirstDriveNumber"),
        winapi.C_SHORT.withName("FirstTransportNumber"),
        winapi.C_SHORT.withName("FirstIEPortNumber"),
        winapi.C_SHORT.withName("FirstCleanerSlotAddress"),
        winapi.C_SHORT.withName("MagazineSize"),
        winapi.C_LONG.withName("DriveCleanTimeout"),
        winapi.C_LONG.withName("Features0"),
        winapi.C_LONG.withName("Features1"),
        winapi.C_CHAR.withName("MoveFromTransport"),
        winapi.C_CHAR.withName("MoveFromSlot"),
        winapi.C_CHAR.withName("MoveFromIePort"),
        winapi.C_CHAR.withName("MoveFromDrive"),
        winapi.C_CHAR.withName("ExchangeFromTransport"),
        winapi.C_CHAR.withName("ExchangeFromSlot"),
        winapi.C_CHAR.withName("ExchangeFromIePort"),
        winapi.C_CHAR.withName("ExchangeFromDrive"),
        winapi.C_CHAR.withName("LockUnlockCapabilities"),
        winapi.C_CHAR.withName("PositionCapabilities"),
        MemoryLayout.sequenceLayout(2, winapi.C_CHAR).withName("Reserved1"),
        MemoryLayout.sequenceLayout(2, winapi.C_LONG).withName("Reserved2")
