...
public class _STORAGE_PHYSICAL_NODE_DATA {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_LONG.withName("NodeId"),
        winapi.C_LONG.withName("AdapterCount"),
        winapi.C_LONG.withName("AdapterDataLength"),
        winapi.C_LONG.withName("AdapterDataOffset"),
        winapi.C_LONG.withName("DeviceCount"),
        winapi.C_LONG.withName("DeviceDataLength"),
        winapi.C_LONG.withName("DeviceDataOffset"),
        MemoryLayout.sequenceLayout(3, winapi.C_LONG).withName("Reserved")
