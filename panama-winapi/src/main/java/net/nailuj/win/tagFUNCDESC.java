...
public class tagFUNCDESC {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_LONG.withName("memid"),
        MemoryLayout.paddingLayout(4),
        winapi.C_POINTER.withName("lprgscode"),
        winapi.C_POINTER.withName("lprgelemdescParam"),
        winapi.C_INT.withName("funckind"),
        winapi.C_INT.withName("invkind"),
        winapi.C_INT.withName("callconv"),
        winapi.C_SHORT.withName("cParams"),
        winapi.C_SHORT.withName("cParamsOpt"),
        winapi.C_SHORT.withName("oVft"),
        winapi.C_SHORT.withName("cScodes"),
        MemoryLayout.paddingLayout(4),
        tagELEMDESC.layout().withName("elemdescFunc"),
        winapi.C_SHORT.withName("wFuncFlags"),
