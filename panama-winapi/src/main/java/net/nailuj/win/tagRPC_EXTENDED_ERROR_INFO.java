...
public class tagRPC_EXTENDED_ERROR_INFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_POINTER.withName("ComputerName"),
        winapi.C_LONG.withName("ProcessID"),
        tagRPC_EXTENDED_ERROR_INFO.u.layout().withName("u"),
        winapi.C_LONG.withName("GeneratingComponent"),
        winapi.C_LONG.withName("Status"),
        winapi.C_SHORT.withName("DetectionLocation"),
        winapi.C_SHORT.withName("Flags"),
        winapi.C_INT.withName("NumberOfParameters"),
        MemoryLayout.paddingLayout(4),
