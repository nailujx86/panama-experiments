...
public class _STORAGE_TEMPERATURE_INFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_SHORT.withName("Index"),
        winapi.C_SHORT.withName("Temperature"),
        winapi.C_SHORT.withName("OverThreshold"),
        winapi.C_SHORT.withName("UnderThreshold"),
        winapi.C_CHAR.withName("OverThresholdChangable"),
        winapi.C_CHAR.withName("UnderThresholdChangable"),
        winapi.C_CHAR.withName("EventGenerated"),
