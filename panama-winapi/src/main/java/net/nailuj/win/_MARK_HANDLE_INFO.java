...
public class _MARK_HANDLE_INFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.unionLayout(
            winapi.C_LONG.withName("UsnSourceInfo"),
            winapi.C_LONG.withName("CopyNumber")
        ).withName("$anon$12214:5"),
        MemoryLayout.paddingLayout(4),
        winapi.C_POINTER.withName("VolumeHandle"),
        winapi.C_LONG.withName("HandleInfo"),
        MemoryLayout.paddingLayout(4)
    ...
    private static final OfInt UsnSourceInfo$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$12214:5"), groupElement("UsnSourceInfo"));
    ...
    private static final OfInt CopyNumber$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$12214:5"), groupElement("CopyNumber"));
