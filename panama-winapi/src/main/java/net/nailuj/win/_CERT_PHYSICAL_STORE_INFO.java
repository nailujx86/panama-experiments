...
public class _CERT_PHYSICAL_STORE_INFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_POINTER.withName("pszOpenStoreProvider"),
        winapi.C_LONG.withName("dwOpenEncodingType"),
        winapi.C_LONG.withName("dwOpenFlags"),
        _CRYPTOAPI_BLOB.layout().withName("OpenParameters"),
        winapi.C_LONG.withName("dwFlags"),
        winapi.C_LONG.withName("dwPriority")
