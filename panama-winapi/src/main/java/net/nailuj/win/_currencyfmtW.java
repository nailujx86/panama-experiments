...
public class _currencyfmtW {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_INT.withName("NumDigits"),
        winapi.C_INT.withName("LeadingZero"),
        winapi.C_INT.withName("Grouping"),
        MemoryLayout.paddingLayout(4),
        winapi.C_POINTER.withName("lpDecimalSep"),
        winapi.C_POINTER.withName("lpThousandSep"),
        winapi.C_INT.withName("NegativeOrder"),
        winapi.C_INT.withName("PositiveOrder"),
        winapi.C_POINTER.withName("lpCurrencySymbol")
