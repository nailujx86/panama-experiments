...
public class _FILE_LAYOUT_ENTRY {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_LONG.withName("NextFileOffset"),
        winapi.C_LONG.withName("Flags"),
        winapi.C_LONG.withName("FileAttributes"),
        winapi.C_LONG_LONG.withName("FileReferenceNumber"),
        winapi.C_LONG.withName("FirstNameOffset"),
        winapi.C_LONG.withName("FirstStreamOffset"),
        winapi.C_LONG.withName("ExtraInfoOffset"),
        winapi.C_LONG.withName("ExtraInfoLength")
