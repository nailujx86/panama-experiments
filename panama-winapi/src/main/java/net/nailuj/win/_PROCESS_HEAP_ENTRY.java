...
public class _PROCESS_HEAP_ENTRY {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_POINTER.withName("lpData"),
        winapi.C_LONG.withName("cbData"),
        winapi.C_CHAR.withName("cbOverhead"),
        winapi.C_CHAR.withName("iRegionIndex"),
        winapi.C_SHORT.withName("wFlags"),
    ...
    public static class Block {
        ...
        private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
            winapi.C_POINTER.withName("hMem"),
            MemoryLayout.sequenceLayout(3, winapi.C_LONG).withName("dwReserved"),
    ...
    public static class Region {
        ...
        private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
            winapi.C_LONG.withName("dwCommittedSize"),
            winapi.C_LONG.withName("dwUnCommittedSize"),
            winapi.C_POINTER.withName("lpFirstBlock"),
            winapi.C_POINTER.withName("lpLastBlock")
        ).withName("$anon$257:9");
