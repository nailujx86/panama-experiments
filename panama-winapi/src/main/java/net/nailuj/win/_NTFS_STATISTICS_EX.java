...
public class _NTFS_STATISTICS_EX {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_LONG.withName("LogFileFullExceptions"),
        winapi.C_LONG.withName("OtherExceptions"),
        winapi.C_LONG_LONG.withName("MftReads"),
        winapi.C_LONG_LONG.withName("MftReadBytes"),
        winapi.C_LONG_LONG.withName("MftWrites"),
        winapi.C_LONG_LONG.withName("MftWriteBytes"),
        _NTFS_STATISTICS_EX.MftWritesUserLevel.layout().withName("MftWritesUserLevel"),
        winapi.C_LONG.withName("MftWritesFlushForLogFileFull"),
        winapi.C_LONG.withName("MftWritesLazyWriter"),
        winapi.C_LONG.withName("MftWritesUserRequest"),
        MemoryLayout.paddingLayout(4),
        winapi.C_LONG_LONG.withName("Mft2Writes"),
        winapi.C_LONG_LONG.withName("Mft2WriteBytes"),
        _NTFS_STATISTICS_EX.Mft2WritesUserLevel.layout().withName("Mft2WritesUserLevel"),
        winapi.C_LONG.withName("Mft2WritesFlushForLogFileFull"),
        winapi.C_LONG.withName("Mft2WritesLazyWriter"),
        winapi.C_LONG.withName("Mft2WritesUserRequest"),
        MemoryLayout.paddingLayout(4),
        winapi.C_LONG_LONG.withName("RootIndexReads"),
        winapi.C_LONG_LONG.withName("RootIndexReadBytes"),
        winapi.C_LONG_LONG.withName("RootIndexWrites"),
        winapi.C_LONG_LONG.withName("RootIndexWriteBytes"),
        winapi.C_LONG_LONG.withName("BitmapReads"),
        winapi.C_LONG_LONG.withName("BitmapReadBytes"),
        winapi.C_LONG_LONG.withName("BitmapWrites"),
        winapi.C_LONG_LONG.withName("BitmapWriteBytes"),
        winapi.C_LONG.withName("BitmapWritesFlushForLogFileFull"),
        winapi.C_LONG.withName("BitmapWritesLazyWriter"),
        winapi.C_LONG.withName("BitmapWritesUserRequest"),
        _NTFS_STATISTICS_EX.BitmapWritesUserLevel.layout().withName("BitmapWritesUserLevel"),
        MemoryLayout.paddingLayout(4),
        winapi.C_LONG_LONG.withName("MftBitmapReads"),
        winapi.C_LONG_LONG.withName("MftBitmapReadBytes"),
        winapi.C_LONG_LONG.withName("MftBitmapWrites"),
        winapi.C_LONG_LONG.withName("MftBitmapWriteBytes"),
        winapi.C_LONG.withName("MftBitmapWritesFlushForLogFileFull"),
        winapi.C_LONG.withName("MftBitmapWritesLazyWriter"),
        winapi.C_LONG.withName("MftBitmapWritesUserRequest"),
        _NTFS_STATISTICS_EX.MftBitmapWritesUserLevel.layout().withName("MftBitmapWritesUserLevel"),
        MemoryLayout.paddingLayout(4),
        winapi.C_LONG_LONG.withName("UserIndexReads"),
        winapi.C_LONG_LONG.withName("UserIndexReadBytes"),
        winapi.C_LONG_LONG.withName("UserIndexWrites"),
        winapi.C_LONG_LONG.withName("UserIndexWriteBytes"),
        winapi.C_LONG_LONG.withName("LogFileReads"),
        winapi.C_LONG_LONG.withName("LogFileReadBytes"),
        winapi.C_LONG_LONG.withName("LogFileWrites"),
        winapi.C_LONG_LONG.withName("LogFileWriteBytes"),
        _NTFS_STATISTICS_EX.Allocate.layout().withName("Allocate"),
        winapi.C_LONG.withName("DiskResourcesExhausted"),
        MemoryLayout.paddingLayout(4),
        winapi.C_LONG_LONG.withName("VolumeTrimCount"),
        winapi.C_LONG_LONG.withName("VolumeTrimTime"),
        winapi.C_LONG_LONG.withName("VolumeTrimByteCount"),
        winapi.C_LONG_LONG.withName("FileLevelTrimCount"),
        winapi.C_LONG_LONG.withName("FileLevelTrimTime"),
        winapi.C_LONG_LONG.withName("FileLevelTrimByteCount"),
        winapi.C_LONG_LONG.withName("VolumeTrimSkippedCount"),
        winapi.C_LONG_LONG.withName("VolumeTrimSkippedByteCount"),
        winapi.C_LONG_LONG.withName("NtfsFillStatInfoFromMftRecordCalledCount"),
        winapi.C_LONG_LONG.withName("NtfsFillStatInfoFromMftRecordBailedBecauseOfAttributeListCount"),
        winapi.C_LONG_LONG.withName("NtfsFillStatInfoFromMftRecordBailedBecauseOfNonResReparsePointCount")
    ...
    public static class MftWritesUserLevel {
        ...
        private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
            winapi.C_LONG.withName("Write"),
            winapi.C_LONG.withName("Create"),
            winapi.C_LONG.withName("SetInfo"),
            winapi.C_LONG.withName("Flush")
        ).withName("$anon$12688:5");
    ...
    public static class Allocate {
        ...
        private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
            winapi.C_LONG.withName("Calls"),
            winapi.C_LONG.withName("RunsReturned"),
            winapi.C_LONG.withName("Hints"),
            winapi.C_LONG.withName("HintsHonored"),
            winapi.C_LONG.withName("Cache"),
            winapi.C_LONG.withName("CacheMiss"),
            winapi.C_LONG_LONG.withName("Clusters"),
            winapi.C_LONG_LONG.withName("HintsClusters"),
            winapi.C_LONG_LONG.withName("CacheClusters"),
            winapi.C_LONG_LONG.withName("CacheMissClusters")
        ).withName("$anon$12763:5");
