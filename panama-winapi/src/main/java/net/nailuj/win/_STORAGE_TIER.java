...
public class _STORAGE_TIER {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.sequenceLayout(256, winapi.C_SHORT).withName("Name"),
        MemoryLayout.sequenceLayout(256, winapi.C_SHORT).withName("Description"),
        winapi.C_LONG_LONG.withName("Flags"),
        winapi.C_LONG_LONG.withName("ProvisionedCapacity"),
    ...
    private static final long Class_$OFFSET = 1060;
