...
public class _RTL_CRITICAL_SECTION_DEBUG {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_SHORT.withName("CreatorBackTraceIndex"),
        MemoryLayout.paddingLayout(4),
        winapi.C_POINTER.withName("CriticalSection"),
        _LIST_ENTRY.layout().withName("ProcessLocksList"),
        winapi.C_LONG.withName("EntryCount"),
        winapi.C_LONG.withName("ContentionCount"),
        winapi.C_LONG.withName("Flags"),
        winapi.C_SHORT.withName("CreatorBackTraceIndexHigh"),
        winapi.C_SHORT.withName("Identifier")
    ...
    private static final long Identifier$OFFSET = 46;
