...
public class _UNWIND_HISTORY_TABLE {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_CHAR.withName("LocalHint"),
        winapi.C_CHAR.withName("GlobalHint"),
        winapi.C_CHAR.withName("Search"),
        winapi.C_CHAR.withName("Once"),
        winapi.C_LONG_LONG.withName("LowAddress"),
        winapi.C_LONG_LONG.withName("HighAddress"),
