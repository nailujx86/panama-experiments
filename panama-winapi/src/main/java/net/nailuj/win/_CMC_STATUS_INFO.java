...
public class _CMC_STATUS_INFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_LONG.withName("cBodyList"),
        winapi.C_POINTER.withName("rgdwBodyList"),
        winapi.C_POINTER.withName("pwszStatusString"),
        winapi.C_LONG.withName("dwOtherInfoChoice"),
        MemoryLayout.paddingLayout(4),
        MemoryLayout.unionLayout(
            winapi.C_LONG.withName("dwFailInfo"),
            winapi.C_POINTER.withName("pPendInfo")
        ).withName("$anon$5336:5")
    ...
    private static final OfInt dwFailInfo$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$5336:5"), groupElement("dwFailInfo"));
    ...
    private static final AddressLayout pPendInfo$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$5336:5"), groupElement("pPendInfo"));
