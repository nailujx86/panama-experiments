...
public class _DISPLAY_DEVICEA {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.sequenceLayout(32, winapi.C_CHAR).withName("DeviceName"),
        MemoryLayout.sequenceLayout(128, winapi.C_CHAR).withName("DeviceString"),
        winapi.C_LONG.withName("StateFlags"),
        MemoryLayout.sequenceLayout(128, winapi.C_CHAR).withName("DeviceID"),
        MemoryLayout.sequenceLayout(128, winapi.C_CHAR).withName("DeviceKey")
