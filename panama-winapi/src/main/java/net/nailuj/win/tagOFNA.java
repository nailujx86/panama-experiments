...
public class tagOFNA {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_POINTER.withName("lpstrFilter"),
        winapi.C_POINTER.withName("lpstrCustomFilter"),
        winapi.C_LONG.withName("nMaxCustFilter"),
        winapi.C_LONG.withName("nFilterIndex"),
        winapi.C_POINTER.withName("lpstrFile"),
        winapi.C_LONG.withName("nMaxFile"),
        MemoryLayout.paddingLayout(4),
        winapi.C_POINTER.withName("lpstrFileTitle"),
        winapi.C_LONG.withName("nMaxFileTitle"),
        MemoryLayout.paddingLayout(4),
        winapi.C_POINTER.withName("lpstrInitialDir"),
        winapi.C_POINTER.withName("lpstrTitle"),
        winapi.C_LONG.withName("Flags"),
        winapi.C_SHORT.withName("nFileOffset"),
        winapi.C_SHORT.withName("nFileExtension"),
        winapi.C_POINTER.withName("lpstrDefExt"),
        winapi.C_LONG_LONG.withName("lCustData"),
        winapi.C_POINTER.withName("lpfnHook"),
        winapi.C_POINTER.withName("lpTemplateName"),
        winapi.C_POINTER.withName("pvReserved"),
        winapi.C_LONG.withName("dwReserved"),
        winapi.C_LONG.withName("FlagsEx")
    ).withName("tagOFNA");
