...
public class __NCRYPT_PCP_TPM_WEB_AUTHN_ATTESTATION_STATEMENT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_INT.withName("Magic"),
        winapi.C_INT.withName("Version"),
        winapi.C_INT.withName("HeaderSize"),
        winapi.C_INT.withName("cbCertifyInfo"),
        winapi.C_INT.withName("cbSignature"),
        winapi.C_INT.withName("cbTpmPublic")
