...
public class _MARK_HANDLE_INFO32 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        ).withName("$anon$12235:5"),
        winapi.C_INT.withName("VolumeHandle"),
    ...
    private static final OfInt UsnSourceInfo$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$12235:5"), groupElement("UsnSourceInfo"));
    ...
    private static final OfInt CopyNumber$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$12235:5"), groupElement("CopyNumber"));
