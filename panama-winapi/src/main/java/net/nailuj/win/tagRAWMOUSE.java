...
public class tagRAWMOUSE {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_SHORT.withName("usFlags"),
        MemoryLayout.paddingLayout(2),
        MemoryLayout.unionLayout(
            winapi.C_LONG.withName("ulButtons"),
            MemoryLayout.structLayout(
                winapi.C_SHORT.withName("usButtonFlags"),
                winapi.C_SHORT.withName("usButtonData")
            ).withName("$anon$15001:9")
        ).withName("$anon$14999:5"),
        winapi.C_LONG.withName("ulRawButtons"),
        winapi.C_LONG.withName("lLastX"),
        winapi.C_LONG.withName("lLastY"),
        winapi.C_LONG.withName("ulExtraInformation")
    ...
    private static final OfInt ulButtons$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$14999:5"), groupElement("ulButtons"));
    ...
    private static final OfShort usButtonFlags$LAYOUT = (OfShort)$LAYOUT.select(groupElement("$anon$14999:5"), groupElement("$anon$15001:9"), groupElement("usButtonFlags"));
    ...
    private static final OfShort usButtonData$LAYOUT = (OfShort)$LAYOUT.select(groupElement("$anon$14999:5"), groupElement("$anon$15001:9"), groupElement("usButtonData"));
