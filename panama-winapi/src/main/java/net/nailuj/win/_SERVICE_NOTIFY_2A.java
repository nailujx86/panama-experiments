...
public class _SERVICE_NOTIFY_2A {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_POINTER.withName("pfnNotifyCallback"),
        winapi.C_POINTER.withName("pContext"),
        winapi.C_LONG.withName("dwNotificationStatus"),
        _SERVICE_STATUS_PROCESS.layout().withName("ServiceStatus"),
        winapi.C_LONG.withName("dwNotificationTriggered"),
        MemoryLayout.paddingLayout(4),
        winapi.C_POINTER.withName("pszServiceNames")
