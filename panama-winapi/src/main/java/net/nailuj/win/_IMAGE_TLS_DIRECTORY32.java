...
public class _IMAGE_TLS_DIRECTORY32 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_LONG.withName("StartAddressOfRawData"),
        winapi.C_LONG.withName("EndAddressOfRawData"),
        winapi.C_LONG.withName("AddressOfIndex"),
        winapi.C_LONG.withName("AddressOfCallBacks"),
        winapi.C_LONG.withName("SizeOfZeroFill"),
        MemoryLayout.unionLayout(
            winapi.C_LONG.withName("Characteristics"),
            MemoryLayout.structLayout(
                MemoryLayout.paddingLayout(4)
            ).withName("$anon$20657:9")
        ).withName("$anon$20655:5")
    ...
    private static final OfInt Characteristics$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$20655:5"), groupElement("Characteristics"));
