...
public class DLGTEMPLATE {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.align(winapi.C_LONG, 2).withName("style"),
        winapi.align(winapi.C_LONG, 2).withName("dwExtendedStyle"),
        winapi.C_SHORT.withName("cdit"),
        winapi.C_SHORT.withName("x"),
        winapi.C_SHORT.withName("y"),
        winapi.C_SHORT.withName("cx"),
        winapi.C_SHORT.withName("cy")
    ).withName("$anon$4912:9");
