...
public class _SYSTEM_CPU_SET_INFORMATION {
    ...
    public static class CpuSet {
        ...
        private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
            winapi.C_LONG.withName("Id"),
            winapi.C_SHORT.withName("Group"),
            winapi.C_CHAR.withName("LogicalProcessorIndex"),
            winapi.C_CHAR.withName("CoreIndex"),
            winapi.C_CHAR.withName("LastLevelCacheIndex"),
            winapi.C_CHAR.withName("NumaNodeIndex"),
            winapi.C_CHAR.withName("EfficiencyClass"),
            MemoryLayout.unionLayout(
                winapi.C_CHAR.withName("AllFlags"),
                MemoryLayout.structLayout(
                    MemoryLayout.paddingLayout(1)
                ).withName("$anon$14074:17")
            ).withName("$anon$14066:13"),
            MemoryLayout.unionLayout(
                winapi.C_LONG.withName("Reserved"),
                winapi.C_CHAR.withName("SchedulingClass")
            ).withName("$anon$14083:13"),
            winapi.C_LONG_LONG.withName("AllocationTag")
        ).withName("$anon$14058:9");
        ...
        private static final OfByte AllFlags$LAYOUT = (OfByte)$LAYOUT.select(groupElement("$anon$14066:13"), groupElement("AllFlags"));
        ...
        private static final OfInt Reserved$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$14083:13"), groupElement("Reserved"));
        ...
        private static final OfByte SchedulingClass$LAYOUT = (OfByte)$LAYOUT.select(groupElement("$anon$14083:13"), groupElement("SchedulingClass"));
    ...
    private static final GroupLayout CpuSet$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$14057:5"), groupElement("CpuSet"));
