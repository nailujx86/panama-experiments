...
public class _OSVERSIONINFOEXA {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.sequenceLayout(128, winapi.C_CHAR).withName("szCSDVersion"),
        winapi.C_SHORT.withName("wServicePackMajor"),
        winapi.C_SHORT.withName("wServicePackMinor"),
        winapi.C_SHORT.withName("wSuiteMask"),
        winapi.C_CHAR.withName("wProductType"),
        winapi.C_CHAR.withName("wReserved")
