...
public class _DEVICE_DATA_SET_LB_PROVISIONING_STATE_V2 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_LONG_LONG.withName("SlabSizeInBytes"),
        winapi.C_LONG_LONG.withName("SlabOffsetDeltaInBytes"),
        winapi.C_LONG.withName("SlabAllocationBitMapBitCount"),
        winapi.C_LONG.withName("SlabAllocationBitMapLength"),
        MemoryLayout.sequenceLayout(1, winapi.C_LONG).withName("SlabAllocationBitMap"),
