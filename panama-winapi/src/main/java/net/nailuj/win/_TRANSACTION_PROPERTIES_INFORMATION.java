...
public class _TRANSACTION_PROPERTIES_INFORMATION {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_LONG.withName("IsolationLevel"),
        winapi.C_LONG.withName("IsolationFlags"),
        _LARGE_INTEGER.layout().withName("Timeout"),
        winapi.C_LONG.withName("Outcome"),
        winapi.C_LONG.withName("DescriptionLength"),
        MemoryLayout.sequenceLayout(1, winapi.C_SHORT).withName("Description"),
