...
public class _SESSION_BUFFER {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_CHAR.withName("lsn"),
        winapi.C_CHAR.withName("state"),
        MemoryLayout.sequenceLayout(16, winapi.C_CHAR).withName("local_name"),
        MemoryLayout.sequenceLayout(16, winapi.C_CHAR).withName("remote_name"),
        winapi.C_CHAR.withName("rcvs_outstanding"),
        winapi.C_CHAR.withName("sends_outstanding")
