...
public class _FS_BPIO_INFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_LONG.withName("ActiveBypassIoCount"),
        winapi.C_SHORT.withName("StorageDriverNameLen"),
        MemoryLayout.sequenceLayout(32, winapi.C_SHORT).withName("StorageDriverName"),
