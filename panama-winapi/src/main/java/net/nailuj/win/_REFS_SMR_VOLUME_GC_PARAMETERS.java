...
public class _REFS_SMR_VOLUME_GC_PARAMETERS {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_INT.withName("Action"),
        winapi.C_INT.withName("Method"),
        winapi.C_LONG.withName("IoGranularity"),
        winapi.C_LONG.withName("CompressionFormat"),
        MemoryLayout.sequenceLayout(8, winapi.C_LONG_LONG).withName("Unused")
