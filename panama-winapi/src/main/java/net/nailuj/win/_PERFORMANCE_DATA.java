...
public class _PERFORMANCE_DATA {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_CHAR.withName("Version"),
        winapi.C_CHAR.withName("HwCountersCount"),
        winapi.C_LONG.withName("ContextSwitchCount"),
        winapi.C_LONG_LONG.withName("WaitReasonBitMap"),
        winapi.C_LONG_LONG.withName("CycleTime"),
        winapi.C_LONG.withName("RetryCount"),
