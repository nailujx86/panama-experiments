...
public class _SEC_WINNT_AUTH_IDENTITY_A {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_POINTER.withName("User"),
        winapi.C_LONG.withName("UserLength"),
        MemoryLayout.paddingLayout(4),
        winapi.C_POINTER.withName("Domain"),
        winapi.C_LONG.withName("DomainLength"),
        MemoryLayout.paddingLayout(4),
        winapi.C_POINTER.withName("Password"),
        winapi.C_LONG.withName("PasswordLength"),
