...
public class _STORAGE_WRITE_CACHE_PROPERTY {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_INT.withName("WriteCacheType"),
        winapi.C_INT.withName("WriteCacheEnabled"),
        winapi.C_INT.withName("WriteCacheChangeable"),
        winapi.C_INT.withName("WriteThroughSupported"),
        winapi.C_CHAR.withName("FlushCacheSupported"),
        winapi.C_CHAR.withName("UserDefinedPowerProtection"),
        winapi.C_CHAR.withName("NVCacheEnabled"),
