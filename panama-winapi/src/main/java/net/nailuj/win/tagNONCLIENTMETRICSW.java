...
public class tagNONCLIENTMETRICSW {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_INT.withName("iBorderWidth"),
        winapi.C_INT.withName("iScrollWidth"),
        winapi.C_INT.withName("iScrollHeight"),
        winapi.C_INT.withName("iCaptionWidth"),
        winapi.C_INT.withName("iCaptionHeight"),
        tagLOGFONTW.layout().withName("lfCaptionFont"),
        winapi.C_INT.withName("iSmCaptionWidth"),
        winapi.C_INT.withName("iSmCaptionHeight"),
        tagLOGFONTW.layout().withName("lfSmCaptionFont"),
        winapi.C_INT.withName("iMenuWidth"),
        winapi.C_INT.withName("iMenuHeight"),
        tagLOGFONTW.layout().withName("lfMenuFont"),
        tagLOGFONTW.layout().withName("lfStatusFont"),
        tagLOGFONTW.layout().withName("lfMessageFont"),
        winapi.C_INT.withName("iPaddedBorderWidth")
