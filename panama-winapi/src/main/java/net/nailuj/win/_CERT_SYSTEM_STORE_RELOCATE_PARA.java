...
public class _CERT_SYSTEM_STORE_RELOCATE_PARA {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.unionLayout(
            winapi.C_POINTER.withName("hKeyBase"),
            winapi.C_POINTER.withName("pvBase")
        ).withName("$anon$9538:5"),
        MemoryLayout.unionLayout(
            winapi.C_POINTER.withName("pvSystemStore"),
            winapi.C_POINTER.withName("pszSystemStore"),
            winapi.C_POINTER.withName("pwszSystemStore")
        ).withName("$anon$9542:5")
    ...
    private static final AddressLayout hKeyBase$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$9538:5"), groupElement("hKeyBase"));
    ...
    private static final AddressLayout pvBase$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$9538:5"), groupElement("pvBase"));
    ...
    private static final AddressLayout pvSystemStore$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$9542:5"), groupElement("pvSystemStore"));
    ...
    private static final AddressLayout pszSystemStore$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$9542:5"), groupElement("pszSystemStore"));
    ...
    private static final AddressLayout pwszSystemStore$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$9542:5"), groupElement("pwszSystemStore"));
