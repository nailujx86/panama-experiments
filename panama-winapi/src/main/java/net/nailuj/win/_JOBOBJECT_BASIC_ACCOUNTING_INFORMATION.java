...
public class _JOBOBJECT_BASIC_ACCOUNTING_INFORMATION {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_LONG.withName("TotalPageFaultCount"),
        winapi.C_LONG.withName("TotalProcesses"),
        winapi.C_LONG.withName("ActiveProcesses"),
        winapi.C_LONG.withName("TotalTerminatedProcesses")
