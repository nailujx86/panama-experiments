...
public class SYSTEM_POWER_CAPABILITIES {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_CHAR.withName("PowerButtonPresent"),
        winapi.C_CHAR.withName("SleepButtonPresent"),
        winapi.C_CHAR.withName("LidPresent"),
        winapi.C_CHAR.withName("SystemS1"),
        winapi.C_CHAR.withName("SystemS2"),
        winapi.C_CHAR.withName("SystemS3"),
        winapi.C_CHAR.withName("SystemS4"),
        winapi.C_CHAR.withName("SystemS5"),
        winapi.C_CHAR.withName("HiberFilePresent"),
        winapi.C_CHAR.withName("FullWake"),
        winapi.C_CHAR.withName("VideoDimPresent"),
        winapi.C_CHAR.withName("ApmPresent"),
        winapi.C_CHAR.withName("UpsPresent"),
        winapi.C_CHAR.withName("ThermalControl"),
        winapi.C_CHAR.withName("ProcessorThrottle"),
        winapi.C_CHAR.withName("ProcessorMinThrottle"),
        winapi.C_CHAR.withName("ProcessorMaxThrottle"),
        winapi.C_CHAR.withName("FastSystemS4"),
        winapi.C_CHAR.withName("Hiberboot"),
        winapi.C_CHAR.withName("WakeAlarmPresent"),
        winapi.C_CHAR.withName("AoAc"),
        winapi.C_CHAR.withName("DiskSpinDown"),
        winapi.C_CHAR.withName("HiberFileType"),
        winapi.C_CHAR.withName("AoAcConnectivitySupported"),
        MemoryLayout.sequenceLayout(6, winapi.C_CHAR).withName("spare3"),
        winapi.C_CHAR.withName("SystemBatteriesPresent"),
        winapi.C_CHAR.withName("BatteriesAreShortTerm"),
        MemoryLayout.sequenceLayout(3, BATTERY_REPORTING_SCALE.layout()).withName("BatteryScale"),
        winapi.C_INT.withName("AcOnLineWake"),
        winapi.C_INT.withName("SoftLidWake"),
        winapi.C_INT.withName("RtcWake"),
        winapi.C_INT.withName("MinDeviceWakeState"),
        winapi.C_INT.withName("DefaultLowLatencyWake")
    ).withName("$anon$19130:9");
