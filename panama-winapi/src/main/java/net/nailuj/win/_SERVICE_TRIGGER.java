...
public class _SERVICE_TRIGGER {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_LONG.withName("dwTriggerType"),
        winapi.C_LONG.withName("dwAction"),
        winapi.C_POINTER.withName("pTriggerSubtype"),
        winapi.C_LONG.withName("cDataItems"),
        MemoryLayout.paddingLayout(4),
        winapi.C_POINTER.withName("pDataItems")
