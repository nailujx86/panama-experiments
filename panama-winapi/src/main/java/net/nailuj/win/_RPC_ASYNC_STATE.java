...
public class _RPC_ASYNC_STATE {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_LONG.withName("Lock"),
        winapi.C_LONG.withName("Flags"),
        winapi.C_POINTER.withName("StubInfo"),
        winapi.C_POINTER.withName("UserInfo"),
        winapi.C_POINTER.withName("RuntimeInfo"),
        winapi.C_INT.withName("Event"),
        winapi.C_INT.withName("NotificationType"),
        _RPC_ASYNC_NOTIFICATION_INFO.layout().withName("u"),
        MemoryLayout.sequenceLayout(4, winapi.C_LONG_LONG).withName("Reserved")
