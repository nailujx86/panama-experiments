...
public class _REQUEST_OPLOCK_OUTPUT_BUFFER {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_SHORT.withName("StructureLength"),
        winapi.C_LONG.withName("OriginalOplockLevel"),
        winapi.C_LONG.withName("NewOplockLevel"),
        winapi.C_LONG.withName("Flags"),
        winapi.C_LONG.withName("AccessMode"),
        winapi.C_SHORT.withName("ShareMode"),
