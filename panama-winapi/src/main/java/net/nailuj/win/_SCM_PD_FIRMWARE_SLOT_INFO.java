...
public class _SCM_PD_FIRMWARE_SLOT_INFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_CHAR.withName("SlotNumber"),
        MemoryLayout.paddingLayout(1),
        MemoryLayout.sequenceLayout(6, winapi.C_CHAR).withName("Reserved1"),
        MemoryLayout.sequenceLayout(32, winapi.C_CHAR).withName("Revision")
