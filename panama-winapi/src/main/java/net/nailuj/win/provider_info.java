...
public class provider_info {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_POINTER.withName("pi_R0_1val"),
        winapi.C_POINTER.withName("pi_R0_allvals"),
        winapi.C_POINTER.withName("pi_R3_1val"),
        winapi.C_POINTER.withName("pi_R3_allvals"),
        winapi.C_LONG.withName("pi_flags"),
        MemoryLayout.paddingLayout(4),
        winapi.C_POINTER.withName("pi_key_context")
