...
public class _CMC_ADD_ATTRIBUTES_INFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_LONG.withName("dwCmcDataReference"),
        winapi.C_LONG.withName("cCertReference"),
        winapi.C_POINTER.withName("rgdwCertReference"),
        winapi.C_LONG.withName("cAttribute"),
        MemoryLayout.paddingLayout(4),
        winapi.C_POINTER.withName("rgAttribute")
