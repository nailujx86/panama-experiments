...
public class tagLOGFONTW {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_LONG.withName("lfHeight"),
        winapi.C_LONG.withName("lfWidth"),
        winapi.C_LONG.withName("lfEscapement"),
        winapi.C_LONG.withName("lfOrientation"),
        winapi.C_LONG.withName("lfWeight"),
        winapi.C_CHAR.withName("lfItalic"),
        winapi.C_CHAR.withName("lfUnderline"),
        winapi.C_CHAR.withName("lfStrikeOut"),
        winapi.C_CHAR.withName("lfCharSet"),
        winapi.C_CHAR.withName("lfOutPrecision"),
        winapi.C_CHAR.withName("lfClipPrecision"),
        winapi.C_CHAR.withName("lfQuality"),
        winapi.C_CHAR.withName("lfPitchAndFamily"),
        MemoryLayout.sequenceLayout(32, winapi.C_SHORT).withName("lfFaceName")
