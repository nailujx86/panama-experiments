...
public class _DEVICE_LB_PROVISIONING_DESCRIPTOR {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.sequenceLayout(7, winapi.C_CHAR).withName("Reserved1"),
        winapi.C_LONG_LONG.withName("OptimalUnmapGranularity"),
        winapi.C_LONG_LONG.withName("UnmapGranularityAlignment"),
        winapi.C_LONG.withName("MaxUnmapLbaCount"),
        winapi.C_LONG.withName("MaxUnmapBlockDescriptorCount")
