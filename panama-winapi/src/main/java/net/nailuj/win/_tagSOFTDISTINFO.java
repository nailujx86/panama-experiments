...
public class _tagSOFTDISTINFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_LONG.withName("dwAdState"),
        MemoryLayout.paddingLayout(4),
        winapi.C_POINTER.withName("szTitle"),
        winapi.C_POINTER.withName("szAbstract"),
        winapi.C_POINTER.withName("szHREF"),
        winapi.C_LONG.withName("dwInstalledVersionMS"),
        winapi.C_LONG.withName("dwInstalledVersionLS"),
        winapi.C_LONG.withName("dwUpdateVersionMS"),
        winapi.C_LONG.withName("dwUpdateVersionLS"),
        winapi.C_LONG.withName("dwAdvertisedVersionMS"),
        winapi.C_LONG.withName("dwAdvertisedVersionLS"),
