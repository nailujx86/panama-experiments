...
public class CM_Power_Data_s {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_LONG.withName("PD_Size"),
        winapi.C_INT.withName("PD_MostRecentPowerState"),
        winapi.C_LONG.withName("PD_Capabilities"),
        winapi.C_LONG.withName("PD_D1Latency"),
        winapi.C_LONG.withName("PD_D2Latency"),
        winapi.C_LONG.withName("PD_D3Latency"),
        MemoryLayout.sequenceLayout(7, winapi.C_INT).withName("PD_PowerStateMapping"),
        winapi.C_INT.withName("PD_DeepestSystemWake")
