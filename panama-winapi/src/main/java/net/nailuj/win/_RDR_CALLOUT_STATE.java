...
public class _RDR_CALLOUT_STATE {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_LONG.withName("LastError"),
        MemoryLayout.paddingLayout(4),
        winapi.C_POINTER.withName("LastEEInfo"),
        winapi.C_INT.withName("LastCalledStage"),
        MemoryLayout.paddingLayout(4),
        winapi.C_POINTER.withName("ServerName"),
        winapi.C_POINTER.withName("ServerPort"),
        winapi.C_POINTER.withName("RemoteUser"),
        winapi.C_POINTER.withName("AuthType"),
        winapi.C_CHAR.withName("ResourceTypePresent"),
        winapi.C_CHAR.withName("SessionIdPresent"),
        winapi.C_CHAR.withName("InterfacePresent"),
        MemoryLayout.paddingLayout(1),
        _GUID.layout().withName("ResourceType"),
        _GUID.layout().withName("SessionId"),
        _RPC_SYNTAX_IDENTIFIER.layout().withName("Interface"),
        winapi.C_POINTER.withName("CertContext")
