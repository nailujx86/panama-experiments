...
public class _FORM_INFO_2A {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_POINTER.withName("pKeyword"),
        winapi.C_LONG.withName("StringType"),
        MemoryLayout.paddingLayout(4),
        winapi.C_POINTER.withName("pMuiDll"),
        winapi.C_LONG.withName("dwResourceId"),
        MemoryLayout.paddingLayout(4),
        winapi.C_POINTER.withName("pDisplayName"),
