...
public class _CERT_STRONG_SIGN_PARA {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_LONG.withName("dwInfoChoice"),
        MemoryLayout.unionLayout(
            winapi.C_POINTER.withName("pvInfo"),
            winapi.C_POINTER.withName("pSerializedInfo"),
            winapi.C_POINTER.withName("pszOID")
        ).withName("$anon$6576:5")
    ...
    private static final AddressLayout pvInfo$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$6576:5"), groupElement("pvInfo"));
    ...
    private static final AddressLayout pSerializedInfo$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$6576:5"), groupElement("pSerializedInfo"));
    ...
    private static final AddressLayout pszOID$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$6576:5"), groupElement("pszOID"));
