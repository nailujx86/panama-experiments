...
public class _CMSG_SIGNER_ENCODE_INFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.unionLayout(
            ...
            winapi.C_LONG_LONG.withName("hNCryptKey")
        ).withName("$anon$6775:5"),
        winapi.C_LONG.withName("dwKeySpec"),
        MemoryLayout.paddingLayout(4),
        _CRYPT_ALGORITHM_IDENTIFIER.layout().withName("HashAlgorithm"),
        winapi.C_POINTER.withName("pvHashAuxInfo"),
        winapi.C_LONG.withName("cAuthAttr"),
        MemoryLayout.paddingLayout(4),
        winapi.C_POINTER.withName("rgAuthAttr"),
        winapi.C_LONG.withName("cUnauthAttr"),
        MemoryLayout.paddingLayout(4),
        winapi.C_POINTER.withName("rgUnauthAttr")
    ...
    private static final OfLong hCryptProv$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$6775:5"), groupElement("hCryptProv"));
    ...
    private static final OfLong hNCryptKey$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$6775:5"), groupElement("hNCryptKey"));
