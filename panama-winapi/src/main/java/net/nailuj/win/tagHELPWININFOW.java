...
public class tagHELPWININFOW {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_INT.withName("wStructSize"),
        winapi.C_INT.withName("x"),
        winapi.C_INT.withName("y"),
        winapi.C_INT.withName("dx"),
        winapi.C_INT.withName("dy"),
        winapi.C_INT.withName("wMax"),
        MemoryLayout.sequenceLayout(2, winapi.C_SHORT).withName("rgchMember")
