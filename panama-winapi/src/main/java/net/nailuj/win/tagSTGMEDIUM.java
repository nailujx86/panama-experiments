...
public class tagSTGMEDIUM {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_LONG.withName("tymed"),
        MemoryLayout.paddingLayout(4),
        MemoryLayout.unionLayout(
            winapi.C_POINTER.withName("hBitmap"),
            winapi.C_POINTER.withName("hMetaFilePict"),
            winapi.C_POINTER.withName("hEnhMetaFile"),
            winapi.C_POINTER.withName("hGlobal"),
            winapi.C_POINTER.withName("lpszFileName"),
            winapi.C_POINTER.withName("pstm"),
            winapi.C_POINTER.withName("pstg")
        ).withName("$anon$12046:36"),
        winapi.C_POINTER.withName("pUnkForRelease")
