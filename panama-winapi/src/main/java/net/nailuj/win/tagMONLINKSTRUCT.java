...
public class tagMONLINKSTRUCT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_INT.withName("fEstablished"),
        winapi.C_INT.withName("fNoData"),
        winapi.C_POINTER.withName("hszSvc"),
        winapi.C_POINTER.withName("hszTopic"),
        winapi.C_POINTER.withName("hszItem"),
        winapi.C_INT.withName("wFmt"),
        winapi.C_INT.withName("fServer"),
        winapi.C_POINTER.withName("hConvServer"),
        winapi.C_POINTER.withName("hConvClient")
