...
public class USN_JOURNAL_DATA_V2 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_LONG_LONG.withName("UsnJournalID"),
        winapi.C_LONG_LONG.withName("FirstUsn"),
        winapi.C_LONG_LONG.withName("NextUsn"),
        winapi.C_LONG_LONG.withName("LowestValidUsn"),
        winapi.C_LONG_LONG.withName("MaxUsn"),
        winapi.C_LONG_LONG.withName("MaximumSize"),
        winapi.C_LONG_LONG.withName("AllocationDelta"),
        winapi.C_SHORT.withName("MinSupportedMajorVersion"),
        winapi.C_SHORT.withName("MaxSupportedMajorVersion"),
        winapi.C_LONG.withName("Flags"),
        winapi.C_LONG_LONG.withName("RangeTrackChunkSize"),
        winapi.C_LONG_LONG.withName("RangeTrackFileSizeThreshold")
    ).withName("$anon$12155:9");
