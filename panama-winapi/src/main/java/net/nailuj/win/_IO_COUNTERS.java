...
public class _IO_COUNTERS {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_LONG_LONG.withName("ReadOperationCount"),
        winapi.C_LONG_LONG.withName("WriteOperationCount"),
        winapi.C_LONG_LONG.withName("OtherOperationCount"),
        winapi.C_LONG_LONG.withName("ReadTransferCount"),
        winapi.C_LONG_LONG.withName("WriteTransferCount"),
        winapi.C_LONG_LONG.withName("OtherTransferCount")
