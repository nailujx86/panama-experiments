...
public class _HMAC_Info {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_INT.withName("HashAlgid"),
        MemoryLayout.paddingLayout(4),
        winapi.C_POINTER.withName("pbInnerString"),
        winapi.C_LONG.withName("cbInnerString"),
        MemoryLayout.paddingLayout(4),
        winapi.C_POINTER.withName("pbOuterString"),
        winapi.C_LONG.withName("cbOuterString"),
        MemoryLayout.paddingLayout(4)
    ).withName("_HMAC_Info");
