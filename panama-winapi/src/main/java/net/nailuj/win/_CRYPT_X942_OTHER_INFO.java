...
public class _CRYPT_X942_OTHER_INFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_POINTER.withName("pszContentEncryptionObjId"),
        MemoryLayout.sequenceLayout(4, winapi.C_CHAR).withName("rgbCounter"),
        MemoryLayout.sequenceLayout(4, winapi.C_CHAR).withName("rgbKeyLength"),
