...
public class _ZONEATTRIBUTES {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.sequenceLayout(260, winapi.C_SHORT).withName("szDisplayName"),
        MemoryLayout.sequenceLayout(200, winapi.C_SHORT).withName("szDescription"),
        MemoryLayout.sequenceLayout(260, winapi.C_SHORT).withName("szIconPath"),
        winapi.C_LONG.withName("dwTemplateMinLevel"),
        winapi.C_LONG.withName("dwTemplateRecommended"),
        winapi.C_LONG.withName("dwTemplateCurrentLevel"),
