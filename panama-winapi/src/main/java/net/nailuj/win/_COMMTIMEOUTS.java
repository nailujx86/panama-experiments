...
public class _COMMTIMEOUTS {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_LONG.withName("ReadIntervalTimeout"),
        winapi.C_LONG.withName("ReadTotalTimeoutMultiplier"),
        winapi.C_LONG.withName("ReadTotalTimeoutConstant"),
        winapi.C_LONG.withName("WriteTotalTimeoutMultiplier"),
        winapi.C_LONG.withName("WriteTotalTimeoutConstant")
