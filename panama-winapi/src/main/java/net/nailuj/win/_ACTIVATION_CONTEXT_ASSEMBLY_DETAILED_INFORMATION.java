...
public class _ACTIVATION_CONTEXT_ASSEMBLY_DETAILED_INFORMATION {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_LONG.withName("ulEncodedAssemblyIdentityLength"),
        winapi.C_LONG.withName("ulManifestPathType"),
        winapi.C_LONG.withName("ulManifestPathLength"),
        _LARGE_INTEGER.layout().withName("liManifestLastWriteTime"),
        winapi.C_LONG.withName("ulPolicyPathType"),
        winapi.C_LONG.withName("ulPolicyPathLength"),
        _LARGE_INTEGER.layout().withName("liPolicyLastWriteTime"),
        winapi.C_LONG.withName("ulMetadataSatelliteRosterIndex"),
        winapi.C_LONG.withName("ulManifestVersionMajor"),
        winapi.C_LONG.withName("ulManifestVersionMinor"),
        winapi.C_LONG.withName("ulPolicyVersionMajor"),
        winapi.C_LONG.withName("ulPolicyVersionMinor"),
        winapi.C_LONG.withName("ulAssemblyDirectoryNameLength"),
        winapi.C_POINTER.withName("lpAssemblyEncodedAssemblyIdentity"),
        winapi.C_POINTER.withName("lpAssemblyManifestPath"),
        winapi.C_POINTER.withName("lpAssemblyPolicyPath"),
        winapi.C_POINTER.withName("lpAssemblyDirectoryName"),
        winapi.C_LONG.withName("ulFileCount"),
