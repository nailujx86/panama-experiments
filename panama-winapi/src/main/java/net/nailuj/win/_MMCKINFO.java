...
public class _MMCKINFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.align(winapi.C_LONG, 1).withName("ckid"),
        winapi.align(winapi.C_LONG, 1).withName("cksize"),
        winapi.align(winapi.C_LONG, 1).withName("fccType"),
        winapi.align(winapi.C_LONG, 1).withName("dwDataOffset"),
