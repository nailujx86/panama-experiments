...
public class joyinfo_tag {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.align(winapi.C_INT, 1).withName("wXpos"),
        winapi.align(winapi.C_INT, 1).withName("wYpos"),
        winapi.align(winapi.C_INT, 1).withName("wZpos"),
        winapi.align(winapi.C_INT, 1).withName("wButtons")
