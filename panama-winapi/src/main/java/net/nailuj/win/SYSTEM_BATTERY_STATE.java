...
public class SYSTEM_BATTERY_STATE {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_CHAR.withName("AcOnLine"),
        winapi.C_CHAR.withName("BatteryPresent"),
        winapi.C_CHAR.withName("Charging"),
        winapi.C_CHAR.withName("Discharging"),
        MemoryLayout.sequenceLayout(3, winapi.C_CHAR).withName("Spare1"),
        winapi.C_CHAR.withName("Tag"),
        winapi.C_LONG.withName("MaxCapacity"),
        winapi.C_LONG.withName("RemainingCapacity"),
        winapi.C_LONG.withName("Rate"),
        winapi.C_LONG.withName("EstimatedTime"),
        winapi.C_LONG.withName("DefaultAlert1"),
        winapi.C_LONG.withName("DefaultAlert2")
    ).withName("$anon$19187:9");
