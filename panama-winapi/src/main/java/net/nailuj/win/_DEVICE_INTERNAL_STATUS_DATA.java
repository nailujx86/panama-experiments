...
public class _DEVICE_INTERNAL_STATUS_DATA {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_LONG_LONG.withName("T10VendorId"),
        winapi.C_LONG.withName("DataSet1Length"),
        winapi.C_LONG.withName("DataSet2Length"),
        winapi.C_LONG.withName("DataSet3Length"),
        winapi.C_LONG.withName("DataSet4Length"),
        winapi.C_CHAR.withName("StatusDataVersion"),
        MemoryLayout.sequenceLayout(3, winapi.C_CHAR).withName("Reserved"),
        MemoryLayout.sequenceLayout(128, winapi.C_CHAR).withName("ReasonIdentifier"),
        winapi.C_LONG.withName("StatusDataLength"),
        MemoryLayout.sequenceLayout(1, winapi.C_CHAR).withName("StatusData"),
