...
public class _CERT_LOGOTYPE_EXT_INFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_LONG.withName("cCommunityLogo"),
        MemoryLayout.paddingLayout(4),
        winapi.C_POINTER.withName("rgCommunityLogo"),
        winapi.C_POINTER.withName("pIssuerLogo"),
        winapi.C_POINTER.withName("pSubjectLogo"),
        winapi.C_LONG.withName("cOtherLogo"),
        MemoryLayout.paddingLayout(4),
        winapi.C_POINTER.withName("rgOtherLogo")
