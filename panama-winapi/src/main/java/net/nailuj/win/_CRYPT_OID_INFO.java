...
public class _CRYPT_OID_INFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_POINTER.withName("pwszName"),
        winapi.C_LONG.withName("dwGroupId"),
        MemoryLayout.unionLayout(
            winapi.C_LONG.withName("dwValue"),
            winapi.C_INT.withName("Algid"),
            winapi.C_LONG.withName("dwLength")
        ).withName("$anon$6249:5"),
    ...
    private static final OfInt dwValue$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$6249:5"), groupElement("dwValue"));
    ...
    private static final OfInt Algid$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$6249:5"), groupElement("Algid"));
    ...
    private static final OfInt dwLength$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$6249:5"), groupElement("dwLength"));
