...
public class _DRIVERSTATUS {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_CHAR.withName("bDriverError"),
        winapi.C_CHAR.withName("bIDEError"),
        MemoryLayout.sequenceLayout(2, winapi.C_CHAR).withName("bReserved"),
        MemoryLayout.sequenceLayout(2, winapi.align(winapi.C_LONG, 1)).withName("dwReserved")
