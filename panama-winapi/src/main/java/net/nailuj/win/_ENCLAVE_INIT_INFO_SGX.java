...
public class _ENCLAVE_INIT_INFO_SGX {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.sequenceLayout(1808, winapi.C_CHAR).withName("SigStruct"),
        MemoryLayout.sequenceLayout(240, winapi.C_CHAR).withName("Reserved1"),
        MemoryLayout.sequenceLayout(304, winapi.C_CHAR).withName("EInitToken"),
        MemoryLayout.sequenceLayout(1744, winapi.C_CHAR).withName("Reserved2")
