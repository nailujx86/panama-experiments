    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.unionLayout(
            MemoryLayout.structLayout(
                winapi.C_SHORT.withName("vt"),
                winapi.C_SHORT.withName("wReserved1"),
                winapi.C_SHORT.withName("wReserved2"),
                winapi.C_SHORT.withName("wReserved3"),
                MemoryLayout.unionLayout(
                    winapi.C_LONG_LONG.withName("llVal"),
                    winapi.C_LONG.withName("lVal"),
                    winapi.C_CHAR.withName("bVal"),
                    winapi.C_SHORT.withName("iVal"),
                    winapi.C_FLOAT.withName("fltVal"),
                    winapi.C_DOUBLE.withName("dblVal"),
                    winapi.C_SHORT.withName("boolVal"),
                    winapi.C_SHORT.withName("__OBSOLETE__VARIANT_BOOL"),
                    winapi.C_LONG.withName("scode"),
                    tagCY.layout().withName("cyVal"),
                    winapi.C_DOUBLE.withName("date"),
                    winapi.C_POINTER.withName("bstrVal"),
                    winapi.C_POINTER.withName("punkVal"),
                    winapi.C_POINTER.withName("pdispVal"),
                    winapi.C_POINTER.withName("parray"),
                    winapi.C_POINTER.withName("pbVal"),
                    winapi.C_POINTER.withName("piVal"),
                    winapi.C_POINTER.withName("plVal"),
                    winapi.C_POINTER.withName("pllVal"),
                    winapi.C_POINTER.withName("pfltVal"),
                    winapi.C_POINTER.withName("pdblVal"),
                    winapi.C_POINTER.withName("pboolVal"),
                    winapi.C_POINTER.withName("__OBSOLETE__VARIANT_PBOOL"),
                    winapi.C_POINTER.withName("pscode"),
                    winapi.C_POINTER.withName("pcyVal"),
                    winapi.C_POINTER.withName("pdate"),
                    winapi.C_POINTER.withName("pbstrVal"),
                    winapi.C_POINTER.withName("ppunkVal"),
                    winapi.C_POINTER.withName("ppdispVal"),
                    winapi.C_POINTER.withName("pparray"),
                    winapi.C_POINTER.withName("pvarVal"),
                    winapi.C_POINTER.withName("byref"),
                    winapi.C_CHAR.withName("cVal"),
                    winapi.C_SHORT.withName("uiVal"),
                    winapi.C_LONG.withName("ulVal"),
                    winapi.C_LONG_LONG.withName("ullVal"),
                    winapi.C_INT.withName("intVal"),
                    winapi.C_INT.withName("uintVal"),
                    winapi.C_POINTER.withName("pdecVal"),
                    winapi.C_POINTER.withName("pcVal"),
                    winapi.C_POINTER.withName("puiVal"),
                    winapi.C_POINTER.withName("pulVal"),
                    winapi.C_POINTER.withName("pullVal"),
                    winapi.C_POINTER.withName("pintVal"),
                    winapi.C_POINTER.withName("puintVal"),
                    MemoryLayout.structLayout(
                        winapi.C_POINTER.withName("pvRecord"),
                        winapi.C_POINTER.withName("pRecInfo")
