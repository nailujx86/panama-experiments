...
public class _CSV_QUERY_VETO_FILE_DIRECT_IO_OUTPUT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_LONG_LONG.withName("VetoedFromAltitudeIntegral"),
        winapi.C_LONG_LONG.withName("VetoedFromAltitudeDecimal"),
        MemoryLayout.sequenceLayout(256, winapi.C_SHORT).withName("Reason")
