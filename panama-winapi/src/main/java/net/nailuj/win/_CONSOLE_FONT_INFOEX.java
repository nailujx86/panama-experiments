...
public class _CONSOLE_FONT_INFOEX {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_LONG.withName("nFont"),
        _COORD.layout().withName("dwFontSize"),
        winapi.C_INT.withName("FontFamily"),
        winapi.C_INT.withName("FontWeight"),
        MemoryLayout.sequenceLayout(32, winapi.C_SHORT).withName("FaceName")
