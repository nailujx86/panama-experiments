...
public class _DRIVER_INFO_8A {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_LONG.withName("cVersion"),
        MemoryLayout.paddingLayout(4),
        winapi.C_POINTER.withName("pName"),
        winapi.C_POINTER.withName("pEnvironment"),
        winapi.C_POINTER.withName("pDriverPath"),
        winapi.C_POINTER.withName("pDataFile"),
        winapi.C_POINTER.withName("pConfigFile"),
        winapi.C_POINTER.withName("pHelpFile"),
        winapi.C_POINTER.withName("pDependentFiles"),
        winapi.C_POINTER.withName("pMonitorName"),
        winapi.C_POINTER.withName("pDefaultDataType"),
        winapi.C_POINTER.withName("pszzPreviousNames"),
        _FILETIME.layout().withName("ftDriverDate"),
        winapi.C_LONG_LONG.withName("dwlDriverVersion"),
        winapi.C_POINTER.withName("pszMfgName"),
        winapi.C_POINTER.withName("pszOEMUrl"),
        winapi.C_POINTER.withName("pszHardwareID"),
        winapi.C_POINTER.withName("pszProvider"),
        winapi.C_POINTER.withName("pszPrintProcessor"),
        winapi.C_POINTER.withName("pszVendorSetup"),
        winapi.C_POINTER.withName("pszzColorProfiles"),
        winapi.C_POINTER.withName("pszInfPath"),
        winapi.C_LONG.withName("dwPrinterDriverAttributes"),
        MemoryLayout.paddingLayout(4),
        winapi.C_POINTER.withName("pszzCoreDriverDependencies"),
        _FILETIME.layout().withName("ftMinInboxDriverVerDate"),
        winapi.C_LONG_LONG.withName("dwlMinInboxDriverVerVersion")
