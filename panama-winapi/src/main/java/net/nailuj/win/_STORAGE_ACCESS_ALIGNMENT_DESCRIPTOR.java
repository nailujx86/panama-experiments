...
public class _STORAGE_ACCESS_ALIGNMENT_DESCRIPTOR {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_LONG.withName("BytesPerCacheLine"),
        winapi.C_LONG.withName("BytesOffsetForCacheAlignment"),
        winapi.C_LONG.withName("BytesPerLogicalSector"),
        winapi.C_LONG.withName("BytesPerPhysicalSector"),
        winapi.C_LONG.withName("BytesOffsetForSectorAlignment")
