...
public class tagPOINTER_DEVICE_PROPERTY {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_INT.withName("logicalMin"),
        winapi.C_INT.withName("logicalMax"),
        winapi.C_INT.withName("physicalMin"),
        winapi.C_INT.withName("physicalMax"),
        winapi.C_INT.withName("unit"),
        winapi.C_INT.withName("unitExponent"),
        winapi.C_SHORT.withName("usagePageId"),
        winapi.C_SHORT.withName("usageId")
