...
public class tagMIDIOUTCAPS2A {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.align(winapi.C_SHORT, 1).withName("wTechnology"),
        winapi.align(winapi.C_SHORT, 1).withName("wVoices"),
        winapi.align(winapi.C_SHORT, 1).withName("wNotes"),
        winapi.align(winapi.C_SHORT, 1).withName("wChannelMask"),
        winapi.align(winapi.C_LONG, 1).withName("dwSupport"),
