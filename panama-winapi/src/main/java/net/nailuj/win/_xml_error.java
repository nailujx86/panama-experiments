...
public class _xml_error {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_INT.withName("_nLine"),
        MemoryLayout.paddingLayout(4),
        winapi.C_POINTER.withName("_pchBuf"),
        winapi.C_INT.withName("_cchBuf"),
        winapi.C_INT.withName("_ich"),
        winapi.C_POINTER.withName("_pszFound"),
        winapi.C_POINTER.withName("_pszExpected"),
        winapi.C_LONG.withName("_reserved1"),
        winapi.C_LONG.withName("_reserved2")
    ).withName("_xml_error");
