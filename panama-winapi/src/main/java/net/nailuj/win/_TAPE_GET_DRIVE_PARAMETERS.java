...
public class _TAPE_GET_DRIVE_PARAMETERS {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_CHAR.withName("ECC"),
        winapi.C_CHAR.withName("Compression"),
        winapi.C_CHAR.withName("DataPadding"),
        winapi.C_CHAR.withName("ReportSetmarks"),
        winapi.C_LONG.withName("DefaultBlockSize"),
        winapi.C_LONG.withName("MaximumBlockSize"),
        winapi.C_LONG.withName("MinimumBlockSize"),
        winapi.C_LONG.withName("MaximumPartitionCount"),
        winapi.C_LONG.withName("FeaturesLow"),
        winapi.C_LONG.withName("FeaturesHigh"),
        winapi.C_LONG.withName("EOTWarningZoneSize")
