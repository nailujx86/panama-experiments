...
public class _CLAIM_SECURITY_ATTRIBUTE_RELATIVE_V1 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_SHORT.withName("ValueType"),
        winapi.C_SHORT.withName("Reserved"),
        winapi.C_LONG.withName("Flags"),
        winapi.C_LONG.withName("ValueCount"),
    ...
    public static class Values {
        ...
        private static final GroupLayout $LAYOUT = MemoryLayout.unionLayout(
            MemoryLayout.sequenceLayout(1, winapi.C_LONG).withName("pInt64"),
            MemoryLayout.sequenceLayout(1, winapi.C_LONG).withName("pUint64"),
            MemoryLayout.sequenceLayout(1, winapi.C_LONG).withName("ppString"),
            MemoryLayout.sequenceLayout(1, winapi.C_LONG).withName("pFqbn"),
            MemoryLayout.sequenceLayout(1, winapi.C_LONG).withName("pOctetString")
