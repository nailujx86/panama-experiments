...
public class tagMCI_WAVE_SET_PARMS {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.align(winapi.C_LONG, 1).withName("dwTimeFormat"),
        winapi.align(winapi.C_LONG, 1).withName("dwAudio"),
        winapi.align(winapi.C_INT, 1).withName("wInput"),
        winapi.align(winapi.C_INT, 1).withName("wOutput"),
        winapi.align(winapi.C_SHORT, 1).withName("wFormatTag"),
        winapi.align(winapi.C_SHORT, 1).withName("wReserved2"),
        winapi.align(winapi.C_SHORT, 1).withName("nChannels"),
        winapi.align(winapi.C_SHORT, 1).withName("wReserved3"),
        winapi.align(winapi.C_LONG, 1).withName("nSamplesPerSec"),
        winapi.align(winapi.C_LONG, 1).withName("nAvgBytesPerSec"),
        winapi.align(winapi.C_SHORT, 1).withName("nBlockAlign"),
        winapi.align(winapi.C_SHORT, 1).withName("wReserved4"),
        winapi.align(winapi.C_SHORT, 1).withName("wBitsPerSample"),
        winapi.align(winapi.C_SHORT, 1).withName("wReserved5")
