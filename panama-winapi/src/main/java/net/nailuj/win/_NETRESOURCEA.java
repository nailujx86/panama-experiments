...
public class _NETRESOURCEA {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_LONG.withName("dwScope"),
        winapi.C_LONG.withName("dwType"),
        winapi.C_LONG.withName("dwDisplayType"),
        winapi.C_LONG.withName("dwUsage"),
        winapi.C_POINTER.withName("lpLocalName"),
        winapi.C_POINTER.withName("lpRemoteName"),
        winapi.C_POINTER.withName("lpComment"),
        winapi.C_POINTER.withName("lpProvider")
