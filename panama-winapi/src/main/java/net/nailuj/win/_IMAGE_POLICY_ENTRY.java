...
public class _IMAGE_POLICY_ENTRY {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_INT.withName("PolicyId"),
    ...
    public static class u {
        ...
        private static final GroupLayout $LAYOUT = MemoryLayout.unionLayout(
            winapi.C_POINTER.withName("None"),
            winapi.C_CHAR.withName("BoolValue"),
            winapi.C_CHAR.withName("Int8Value"),
            winapi.C_CHAR.withName("UInt8Value"),
            winapi.C_SHORT.withName("Int16Value"),
            winapi.C_SHORT.withName("UInt16Value"),
            winapi.C_INT.withName("Int32Value"),
            winapi.C_INT.withName("UInt32Value"),
            winapi.C_LONG_LONG.withName("Int64Value"),
            winapi.C_LONG_LONG.withName("UInt64Value"),
            winapi.C_POINTER.withName("AnsiStringValue"),
            winapi.C_POINTER.withName("UnicodeStringValue")
        ).withName("$anon$23775:5");
