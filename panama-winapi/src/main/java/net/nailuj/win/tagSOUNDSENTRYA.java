...
public class tagSOUNDSENTRYA {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_INT.withName("cbSize"),
        winapi.C_LONG.withName("dwFlags"),
        winapi.C_LONG.withName("iFSTextEffect"),
        winapi.C_LONG.withName("iFSTextEffectMSec"),
        winapi.C_LONG.withName("iFSTextEffectColorBits"),
        winapi.C_LONG.withName("iFSGrafEffect"),
        winapi.C_LONG.withName("iFSGrafEffectMSec"),
        winapi.C_LONG.withName("iFSGrafEffectColor"),
        winapi.C_LONG.withName("iWindowsEffect"),
        winapi.C_LONG.withName("iWindowsEffectMSec"),
        winapi.C_POINTER.withName("lpszWindowsEffectDLL"),
        winapi.C_LONG.withName("iWindowsEffectOrdinal"),
