...
public class _STORAGE_IDENTIFIER {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_INT.withName("CodeSet"),
        winapi.C_INT.withName("Type"),
        winapi.C_SHORT.withName("IdentifierSize"),
        winapi.C_SHORT.withName("NextOffset"),
        winapi.C_INT.withName("Association"),
        MemoryLayout.sequenceLayout(1, winapi.C_CHAR).withName("Identifier"),
