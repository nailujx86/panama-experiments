...
public class tagJOYCAPS2W {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.sequenceLayout(32, winapi.align(winapi.C_SHORT, 1)).withName("szRegKey"),
        MemoryLayout.sequenceLayout(260, winapi.align(winapi.C_SHORT, 1)).withName("szOEMVxD"),
