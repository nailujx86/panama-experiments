...
public class _FSCTL_OFFLOAD_WRITE_INPUT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_LONG_LONG.withName("FileOffset"),
        winapi.C_LONG_LONG.withName("CopyLength"),
        winapi.C_LONG_LONG.withName("TransferOffset"),
        MemoryLayout.sequenceLayout(512, winapi.C_CHAR).withName("Token")
