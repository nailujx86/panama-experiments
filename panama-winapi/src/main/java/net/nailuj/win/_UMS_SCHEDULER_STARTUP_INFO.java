...
public class _UMS_SCHEDULER_STARTUP_INFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_LONG.withName("UmsVersion"),
        MemoryLayout.paddingLayout(4),
        winapi.C_POINTER.withName("CompletionList"),
        winapi.C_POINTER.withName("SchedulerProc"),
        winapi.C_POINTER.withName("SchedulerParam")
