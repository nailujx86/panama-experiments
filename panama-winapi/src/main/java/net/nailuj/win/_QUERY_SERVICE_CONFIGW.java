...
public class _QUERY_SERVICE_CONFIGW {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_LONG.withName("dwServiceType"),
        winapi.C_LONG.withName("dwStartType"),
        winapi.C_LONG.withName("dwErrorControl"),
        MemoryLayout.paddingLayout(4),
        winapi.C_POINTER.withName("lpBinaryPathName"),
        winapi.C_POINTER.withName("lpLoadOrderGroup"),
        winapi.C_LONG.withName("dwTagId"),
        MemoryLayout.paddingLayout(4),
        winapi.C_POINTER.withName("lpDependencies"),
        winapi.C_POINTER.withName("lpServiceStartName"),
        winapi.C_POINTER.withName("lpDisplayName")
