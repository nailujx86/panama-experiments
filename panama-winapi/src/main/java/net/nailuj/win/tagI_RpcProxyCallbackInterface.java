...
public class tagI_RpcProxyCallbackInterface {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_POINTER.withName("IsValidMachineFn"),
        winapi.C_POINTER.withName("GetClientAddressFn"),
        winapi.C_POINTER.withName("GetConnectionTimeoutFn"),
        winapi.C_POINTER.withName("PerformCalloutFn"),
        winapi.C_POINTER.withName("FreeCalloutStateFn"),
        winapi.C_POINTER.withName("GetClientSessionAndResourceUUIDFn"),
        winapi.C_POINTER.withName("ProxyFilterIfFn"),
        winapi.C_POINTER.withName("RpcProxyUpdatePerfCounterFn"),
        winapi.C_POINTER.withName("RpcProxyUpdatePerfCounterBackendServerFn")
