...
public class _DISK_CACHE_INFORMATION {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_CHAR.withName("ParametersSavable"),
        winapi.C_CHAR.withName("ReadCacheEnabled"),
        winapi.C_CHAR.withName("WriteCacheEnabled"),
        MemoryLayout.paddingLayout(1),
        winapi.C_INT.withName("ReadRetentionPriority"),
        winapi.C_INT.withName("WriteRetentionPriority"),
        winapi.C_SHORT.withName("DisablePrefetchTransferLength"),
        winapi.C_CHAR.withName("PrefetchScalar"),
        MemoryLayout.paddingLayout(1),
    ...
    public static class ScalarPrefetch {
        ...
        private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
            winapi.C_SHORT.withName("Minimum"),
            winapi.C_SHORT.withName("Maximum"),
            winapi.C_SHORT.withName("MaximumBlocks")
        ).withName("$anon$9887:9");
    ...
    private static final GroupLayout ScalarPrefetch$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$9886:5"), groupElement("ScalarPrefetch"));
    ...
    private static final GroupLayout BlockPrefetch$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$9886:5"), groupElement("BlockPrefetch"));
