...
public class _IMAGE_COFF_SYMBOLS_HEADER {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_LONG.withName("NumberOfSymbols"),
        winapi.C_LONG.withName("LvaToFirstSymbol"),
        winapi.C_LONG.withName("NumberOfLinenumbers"),
        winapi.C_LONG.withName("LvaToFirstLinenumber"),
        winapi.C_LONG.withName("RvaToFirstByteOfCode"),
        winapi.C_LONG.withName("RvaToLastByteOfCode"),
        winapi.C_LONG.withName("RvaToFirstByteOfData"),
        winapi.C_LONG.withName("RvaToLastByteOfData")
