...
public class _MEMORYSTATUSEX {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_LONG.withName("dwMemoryLoad"),
        winapi.C_LONG_LONG.withName("ullTotalPhys"),
        winapi.C_LONG_LONG.withName("ullAvailPhys"),
        winapi.C_LONG_LONG.withName("ullTotalPageFile"),
        winapi.C_LONG_LONG.withName("ullAvailPageFile"),
        winapi.C_LONG_LONG.withName("ullTotalVirtual"),
        winapi.C_LONG_LONG.withName("ullAvailVirtual"),
        winapi.C_LONG_LONG.withName("ullAvailExtendedVirtual")
