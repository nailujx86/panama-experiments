...
public class _SHCREATEPROCESSINFOW {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_POINTER.withName("pszParameters"),
        winapi.C_POINTER.withName("pszCurrentDirectory"),
        winapi.C_POINTER.withName("hUserToken"),
        winapi.C_POINTER.withName("lpProcessAttributes"),
        winapi.C_POINTER.withName("lpThreadAttributes"),
        winapi.C_INT.withName("bInheritHandles"),
        winapi.C_LONG.withName("dwCreationFlags"),
        winapi.C_POINTER.withName("lpStartupInfo"),
        winapi.C_POINTER.withName("lpProcessInformation")
