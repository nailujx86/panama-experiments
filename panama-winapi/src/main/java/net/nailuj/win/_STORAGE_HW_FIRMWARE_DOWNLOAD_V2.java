...
public class _STORAGE_HW_FIRMWARE_DOWNLOAD_V2 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_CHAR.withName("Slot"),
        MemoryLayout.sequenceLayout(3, winapi.C_CHAR).withName("Reserved"),
        winapi.C_LONG_LONG.withName("Offset"),
        winapi.C_LONG_LONG.withName("BufferSize"),
        winapi.C_LONG.withName("ImageSize"),
        winapi.C_LONG.withName("Reserved2"),
        MemoryLayout.sequenceLayout(1, winapi.C_CHAR).withName("ImageBuffer"),
