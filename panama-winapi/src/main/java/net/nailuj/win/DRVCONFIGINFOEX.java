...
public class DRVCONFIGINFOEX {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.align(winapi.C_LONG, 1).withName("dwDCISize"),
        winapi.align(winapi.C_POINTER, 1).withName("lpszDCISectionName"),
        winapi.align(winapi.C_POINTER, 1).withName("lpszDCIAliasName"),
        winapi.align(winapi.C_LONG, 1).withName("dnDevNode")
