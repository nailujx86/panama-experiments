...
public class _DEVICEDUMP_STORAGESTACK_PUBLIC_DUMP {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.align(winapi.C_LONG, 1).withName("dwReasonForCollection"),
        MemoryLayout.sequenceLayout(16, winapi.C_CHAR).withName("cDriverName"),
        winapi.align(winapi.C_LONG, 1).withName("uiNumRecords"),
