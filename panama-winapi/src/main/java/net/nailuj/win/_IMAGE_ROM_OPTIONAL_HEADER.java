...
public class _IMAGE_ROM_OPTIONAL_HEADER {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_LONG.withName("BaseOfBss"),
        winapi.C_LONG.withName("GprMask"),
        MemoryLayout.sequenceLayout(4, winapi.C_LONG).withName("CprMask"),
        winapi.C_LONG.withName("GpValue")
