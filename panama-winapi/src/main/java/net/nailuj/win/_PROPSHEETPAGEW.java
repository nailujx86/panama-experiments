...
public class _PROPSHEETPAGEW {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.unionLayout(
            winapi.C_POINTER.withName("pszTemplate"),
            winapi.C_POINTER.withName("pResource")
        ).withName("$anon$271:5"),
        MemoryLayout.unionLayout(
            winapi.C_POINTER.withName("hIcon"),
            winapi.C_POINTER.withName("pszIcon")
        ).withName("$anon$271:5"),
        winapi.C_POINTER.withName("pszTitle"),
        winapi.C_POINTER.withName("pfnDlgProc"),
        winapi.C_LONG_LONG.withName("lParam"),
        winapi.C_POINTER.withName("pfnCallback"),
        winapi.C_POINTER.withName("pcRefParent"),
        winapi.C_POINTER.withName("pszHeaderTitle"),
        winapi.C_POINTER.withName("pszHeaderSubTitle"),
        winapi.C_POINTER.withName("hActCtx"),
        MemoryLayout.unionLayout(
            winapi.C_POINTER.withName("hbmHeader"),
            winapi.C_POINTER.withName("pszbmHeader")
        ).withName("$anon$278:5")
