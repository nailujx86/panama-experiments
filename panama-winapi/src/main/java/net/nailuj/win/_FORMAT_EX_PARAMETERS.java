...
public class _FORMAT_EX_PARAMETERS {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_LONG.withName("StartCylinderNumber"),
        winapi.C_LONG.withName("EndCylinderNumber"),
        winapi.C_LONG.withName("StartHeadNumber"),
        winapi.C_LONG.withName("EndHeadNumber"),
        winapi.C_SHORT.withName("FormatGapLength"),
        winapi.C_SHORT.withName("SectorsPerTrack"),
        MemoryLayout.sequenceLayout(1, winapi.C_SHORT).withName("SectorNumber"),
