...
public class tagMENUITEMINFOA {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_INT.withName("fMask"),
        winapi.C_INT.withName("fType"),
        winapi.C_INT.withName("fState"),
        winapi.C_INT.withName("wID"),
        MemoryLayout.paddingLayout(4),
        winapi.C_POINTER.withName("hSubMenu"),
        winapi.C_POINTER.withName("hbmpChecked"),
        winapi.C_POINTER.withName("hbmpUnchecked"),
        winapi.C_LONG_LONG.withName("dwItemData"),
        winapi.C_POINTER.withName("dwTypeData"),
        winapi.C_INT.withName("cch"),
        MemoryLayout.paddingLayout(4),
        winapi.C_POINTER.withName("hbmpItem")
