...
public class _STREAM_INFORMATION_ENTRY {
    ...
    public static class _StreamInformation {
        ...
        public static class _DesiredStorageClass {
            ...
            private static final long Class_$OFFSET = 0;
        ...
        public static class _DataStream {
            ...
            private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
                winapi.C_SHORT.withName("Length"),
                winapi.C_SHORT.withName("Flags"),
                winapi.C_LONG.withName("Reserved"),
                winapi.C_LONG_LONG.withName("Vdl")
        ...
        public static class _Reparse {
            ...
            private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
                winapi.C_SHORT.withName("Length"),
                winapi.C_SHORT.withName("Flags"),
                winapi.C_LONG.withName("ReparseDataSize"),
                winapi.C_LONG.withName("ReparseDataOffset")
            ).withName("_Reparse");
        ...
        public static class _Ea {
            ...
            private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
                ...
                winapi.C_LONG.withName("EaInformationOffset")
            ).withName("_Ea");
