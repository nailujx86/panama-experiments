...
public class _GETVERSIONINPARAMS {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_CHAR.withName("bVersion"),
        winapi.C_CHAR.withName("bRevision"),
        winapi.C_CHAR.withName("bReserved"),
        winapi.C_CHAR.withName("bIDEDeviceMap"),
        winapi.align(winapi.C_LONG, 1).withName("fCapabilities"),
