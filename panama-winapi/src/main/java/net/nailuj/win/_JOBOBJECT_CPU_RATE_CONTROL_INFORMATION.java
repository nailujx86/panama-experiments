...
public class _JOBOBJECT_CPU_RATE_CONTROL_INFORMATION {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.unionLayout(
            winapi.C_LONG.withName("CpuRate"),
            winapi.C_LONG.withName("Weight"),
            MemoryLayout.structLayout(
                winapi.C_SHORT.withName("MinRate"),
                winapi.C_SHORT.withName("MaxRate")
            ).withName("$anon$13504:9")
        ).withName("$anon$13501:5")
    ...
    private static final OfInt CpuRate$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$13501:5"), groupElement("CpuRate"));
    ...
    private static final OfInt Weight$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$13501:5"), groupElement("Weight"));
    ...
    private static final OfShort MinRate$LAYOUT = (OfShort)$LAYOUT.select(groupElement("$anon$13501:5"), groupElement("$anon$13504:9"), groupElement("MinRate"));
    ...
    private static final OfShort MaxRate$LAYOUT = (OfShort)$LAYOUT.select(groupElement("$anon$13501:5"), groupElement("$anon$13504:9"), groupElement("MaxRate"));
