...
public class _CERT_CHAIN_CONTEXT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_LONG.withName("cChain"),
        winapi.C_POINTER.withName("rgpChain"),
        winapi.C_LONG.withName("cLowerQualityChainContext"),
        MemoryLayout.paddingLayout(4),
        winapi.C_POINTER.withName("rgpLowerQualityChainContext"),
        winapi.C_INT.withName("fHasRevocationFreshnessTime"),
        winapi.C_LONG.withName("dwRevocationFreshnessTime"),
        winapi.C_LONG.withName("dwCreateFlags"),
