...
public class _CERT_REVOCATION_PARA {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_POINTER.withName("pIssuerCert"),
        winapi.C_LONG.withName("cCertStore"),
        MemoryLayout.paddingLayout(4),
        winapi.C_POINTER.withName("rgCertStore"),
        winapi.C_POINTER.withName("hCrlStore"),
        winapi.C_POINTER.withName("pftTimeToUse")
