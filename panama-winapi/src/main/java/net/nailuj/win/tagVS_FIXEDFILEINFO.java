...
public class tagVS_FIXEDFILEINFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_LONG.withName("dwSignature"),
        winapi.C_LONG.withName("dwStrucVersion"),
        winapi.C_LONG.withName("dwFileVersionMS"),
        winapi.C_LONG.withName("dwFileVersionLS"),
        winapi.C_LONG.withName("dwProductVersionMS"),
        winapi.C_LONG.withName("dwProductVersionLS"),
        winapi.C_LONG.withName("dwFileFlagsMask"),
        winapi.C_LONG.withName("dwFileFlags"),
        winapi.C_LONG.withName("dwFileOS"),
        winapi.C_LONG.withName("dwFileType"),
        winapi.C_LONG.withName("dwFileSubtype"),
        winapi.C_LONG.withName("dwFileDateMS"),
        winapi.C_LONG.withName("dwFileDateLS")
