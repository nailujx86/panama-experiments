...
public class tagEXCEPINFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_SHORT.withName("wCode"),
        winapi.C_SHORT.withName("wReserved"),
        MemoryLayout.paddingLayout(4),
        winapi.C_POINTER.withName("bstrSource"),
        winapi.C_POINTER.withName("bstrDescription"),
        winapi.C_POINTER.withName("bstrHelpFile"),
        winapi.C_LONG.withName("dwHelpContext"),
        MemoryLayout.paddingLayout(4),
        winapi.C_POINTER.withName("pvReserved"),
        winapi.C_POINTER.withName("pfnDeferredFillIn"),
    ...
    public static class pfnDeferredFillIn {
        ...
        private static final MethodHandle UP$MH = winapi.upcallHandle(pfnDeferredFillIn.Function.class, "apply", $DESC);
