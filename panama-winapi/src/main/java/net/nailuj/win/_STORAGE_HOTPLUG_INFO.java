...
public class _STORAGE_HOTPLUG_INFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_CHAR.withName("MediaRemovable"),
        winapi.C_CHAR.withName("MediaHotplug"),
        winapi.C_CHAR.withName("DeviceHotplug"),
        winapi.C_CHAR.withName("WriteCacheEnableOverride")
