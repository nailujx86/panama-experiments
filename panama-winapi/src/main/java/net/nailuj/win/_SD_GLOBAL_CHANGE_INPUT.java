...
public class _SD_GLOBAL_CHANGE_INPUT {
    ...
    private static final GroupLayout SdChange$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$14912:5"), groupElement("SdChange"));
    ...
    private static final GroupLayout SdQueryStats$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$14912:5"), groupElement("SdQueryStats"));
    ...
    private static final GroupLayout SdEnumSds$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$14912:5"), groupElement("SdEnumSds"));
