...
public class tagEXTLOGFONTW {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.sequenceLayout(64, winapi.C_SHORT).withName("elfFullName"),
        MemoryLayout.sequenceLayout(32, winapi.C_SHORT).withName("elfStyle"),
        winapi.C_LONG.withName("elfVersion"),
        winapi.C_LONG.withName("elfStyleSize"),
        winapi.C_LONG.withName("elfMatch"),
        winapi.C_LONG.withName("elfReserved"),
        MemoryLayout.sequenceLayout(4, winapi.C_CHAR).withName("elfVendorId"),
        winapi.C_LONG.withName("elfCulture"),
