...
public class _STORAGE_PHYSICAL_ADAPTER_DATA {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_LONG.withName("AdapterId"),
        winapi.C_INT.withName("HealthStatus"),
        winapi.C_INT.withName("CommandProtocol"),
        _STORAGE_SPEC_VERSION.layout().withName("SpecVersion"),
        MemoryLayout.sequenceLayout(8, winapi.C_CHAR).withName("Vendor"),
        MemoryLayout.sequenceLayout(40, winapi.C_CHAR).withName("Model"),
        MemoryLayout.sequenceLayout(16, winapi.C_CHAR).withName("FirmwareRevision"),
        MemoryLayout.sequenceLayout(32, winapi.C_CHAR).withName("PhysicalLocation"),
        winapi.C_CHAR.withName("ExpanderConnected"),
        MemoryLayout.sequenceLayout(3, winapi.C_CHAR).withName("Reserved0"),
        MemoryLayout.sequenceLayout(3, winapi.C_LONG).withName("Reserved1")
