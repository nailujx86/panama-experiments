...
public class tagPOINTER_PEN_INFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_INT.withName("penFlags"),
        winapi.C_INT.withName("penMask"),
        winapi.C_INT.withName("pressure"),
        winapi.C_INT.withName("rotation"),
        winapi.C_INT.withName("tiltX"),
        winapi.C_INT.withName("tiltY")
