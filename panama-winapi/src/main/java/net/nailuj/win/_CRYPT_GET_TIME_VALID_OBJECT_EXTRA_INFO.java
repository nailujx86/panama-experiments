...
public class _CRYPT_GET_TIME_VALID_OBJECT_EXTRA_INFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_INT.withName("iDeltaCrlIndicator"),
        winapi.C_POINTER.withName("pftCacheResync"),
        winapi.C_POINTER.withName("pLastSyncTime"),
        winapi.C_POINTER.withName("pMaxAgeTime"),
        winapi.C_POINTER.withName("pChainPara"),
        winapi.C_POINTER.withName("pDeltaCrlIndicator")
