...
public class _VIRTUALIZATION_INSTANCE_INFO_INPUT_EX {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_SHORT.withName("HeaderSize"),
        MemoryLayout.paddingLayout(2),
        winapi.C_LONG.withName("Flags"),
        winapi.C_LONG.withName("NotificationInfoSize"),
        winapi.C_SHORT.withName("NotificationInfoOffset"),
        winapi.C_SHORT.withName("ProviderMajorVersion")
