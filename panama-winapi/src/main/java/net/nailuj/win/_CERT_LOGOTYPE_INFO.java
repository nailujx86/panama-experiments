...
public class _CERT_LOGOTYPE_INFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_LONG.withName("dwLogotypeInfoChoice"),
        MemoryLayout.paddingLayout(4),
        MemoryLayout.unionLayout(
            winapi.C_POINTER.withName("pLogotypeDirectInfo"),
            winapi.C_POINTER.withName("pLogotypeIndirectInfo")
    ...
    private static final AddressLayout pLogotypeDirectInfo$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$5555:5"), groupElement("pLogotypeDirectInfo"));
    ...
    private static final AddressLayout pLogotypeIndirectInfo$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$5555:5"), groupElement("pLogotypeIndirectInfo"));
