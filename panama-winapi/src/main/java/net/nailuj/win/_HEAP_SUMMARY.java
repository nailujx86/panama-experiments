...
public class _HEAP_SUMMARY {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_LONG_LONG.withName("cbAllocated"),
        winapi.C_LONG_LONG.withName("cbCommitted"),
        winapi.C_LONG_LONG.withName("cbReserved"),
        winapi.C_LONG_LONG.withName("cbMaxReserve")
