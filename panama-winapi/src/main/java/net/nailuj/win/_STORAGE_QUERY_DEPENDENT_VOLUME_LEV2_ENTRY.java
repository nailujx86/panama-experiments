...
public class _STORAGE_QUERY_DEPENDENT_VOLUME_LEV2_ENTRY {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_LONG.withName("EntryLength"),
        winapi.C_LONG.withName("DependencyTypeFlags"),
        winapi.C_LONG.withName("ProviderSpecificFlags"),
        _VIRTUAL_STORAGE_TYPE.layout().withName("VirtualStorageType"),
        winapi.C_LONG.withName("AncestorLevel"),
        winapi.C_LONG.withName("HostVolumeNameOffset"),
        winapi.C_LONG.withName("HostVolumeNameSize"),
        winapi.C_LONG.withName("DependentVolumeNameOffset"),
        winapi.C_LONG.withName("DependentVolumeNameSize"),
        winapi.C_LONG.withName("RelativePathOffset"),
        winapi.C_LONG.withName("RelativePathSize"),
        winapi.C_LONG.withName("DependentDeviceNameOffset"),
        winapi.C_LONG.withName("DependentDeviceNameSize")
