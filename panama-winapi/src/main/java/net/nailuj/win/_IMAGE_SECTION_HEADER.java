...
public class _IMAGE_SECTION_HEADER {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.sequenceLayout(8, winapi.C_CHAR).withName("Name"),
        _IMAGE_SECTION_HEADER.Misc.layout().withName("Misc"),
        winapi.C_LONG.withName("VirtualAddress"),
        winapi.C_LONG.withName("SizeOfRawData"),
        winapi.C_LONG.withName("PointerToRawData"),
        winapi.C_LONG.withName("PointerToRelocations"),
        winapi.C_LONG.withName("PointerToLinenumbers"),
    ...
    public static class Misc {
        ...
        private static final GroupLayout $LAYOUT = MemoryLayout.unionLayout(
            winapi.C_LONG.withName("PhysicalAddress"),
            winapi.C_LONG.withName("VirtualSize")
        ).withName("$anon$19704:5");
