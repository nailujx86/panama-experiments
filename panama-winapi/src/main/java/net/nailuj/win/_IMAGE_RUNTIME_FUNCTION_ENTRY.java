...
public class _IMAGE_RUNTIME_FUNCTION_ENTRY {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_LONG.withName("BeginAddress"),
        winapi.C_LONG.withName("EndAddress"),
        MemoryLayout.unionLayout(
            winapi.C_LONG.withName("UnwindInfoAddress"),
            winapi.C_LONG.withName("UnwindData")
        ).withName("$anon$21385:5")
    ...
    private static final OfInt UnwindInfoAddress$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$21385:5"), groupElement("UnwindInfoAddress"));
    ...
    private static final OfInt UnwindData$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$21385:5"), groupElement("UnwindData"));
