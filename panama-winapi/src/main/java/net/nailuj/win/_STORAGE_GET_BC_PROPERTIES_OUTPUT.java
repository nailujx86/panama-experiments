...
public class _STORAGE_GET_BC_PROPERTIES_OUTPUT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_LONG.withName("MaximumRequestsPerPeriod"),
        winapi.C_LONG.withName("MinimumPeriod"),
        winapi.C_LONG_LONG.withName("MaximumRequestSize"),
        winapi.C_LONG.withName("EstimatedTimePerRequest"),
        winapi.C_LONG.withName("NumOutStandingRequests"),
        winapi.C_LONG_LONG.withName("RequestSize")
