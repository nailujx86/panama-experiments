...
public class _tagBINDINFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_POINTER.withName("szExtraInfo"),
        tagSTGMEDIUM.layout().withName("stgmedData"),
        winapi.C_LONG.withName("grfBindInfoF"),
        winapi.C_LONG.withName("dwBindVerb"),
        winapi.C_POINTER.withName("szCustomVerb"),
        winapi.C_LONG.withName("cbstgmedData"),
        winapi.C_LONG.withName("dwOptions"),
        winapi.C_LONG.withName("dwOptionsFlags"),
        winapi.C_LONG.withName("dwCodePage"),
        _SECURITY_ATTRIBUTES.layout().withName("securityAttributes"),
        _GUID.layout().withName("iid"),
        winapi.C_POINTER.withName("pUnk"),
