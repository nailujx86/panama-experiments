...
public class _SCM_PD_PASSTHROUGH_INVDIMM_OUTPUT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_SHORT.withName("GeneralStatus"),
        winapi.C_SHORT.withName("ExtendedStatus"),
        winapi.C_LONG.withName("OutputDataLength"),
        MemoryLayout.sequenceLayout(1, winapi.C_CHAR).withName("OutputData"),
