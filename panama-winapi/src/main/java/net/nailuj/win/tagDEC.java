    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.unionLayout(
            MemoryLayout.structLayout(
                winapi.C_CHAR.withName("scale"),
                winapi.C_CHAR.withName("sign")
            ).withName("$anon$706:9"),
            winapi.C_SHORT.withName("signscale")
        ).withName("$anon$705:5"),
        winapi.C_LONG.withName("Hi32"),
        MemoryLayout.unionLayout(
            MemoryLayout.structLayout(
                winapi.C_LONG.withName("Lo32"),
                winapi.C_LONG.withName("Mid32")
            ).withName("$anon$714:9"),
            winapi.C_LONG_LONG.withName("Lo64")
        ).withName("$anon$713:5")
    ).withName("tagDEC");
