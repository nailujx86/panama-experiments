...
public class tagRID_DEVICE_INFO_HID {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_LONG.withName("dwVendorId"),
        winapi.C_LONG.withName("dwProductId"),
        winapi.C_LONG.withName("dwVersionNumber"),
        winapi.C_SHORT.withName("usUsagePage"),
        winapi.C_SHORT.withName("usUsage")
