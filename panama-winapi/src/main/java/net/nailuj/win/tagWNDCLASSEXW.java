...
public class tagWNDCLASSEXW {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_INT.withName("style"),
        winapi.C_POINTER.withName("lpfnWndProc"),
        winapi.C_INT.withName("cbClsExtra"),
        winapi.C_INT.withName("cbWndExtra"),
        winapi.C_POINTER.withName("hInstance"),
        winapi.C_POINTER.withName("hIcon"),
        winapi.C_POINTER.withName("hCursor"),
        winapi.C_POINTER.withName("hbrBackground"),
        winapi.C_POINTER.withName("lpszMenuName"),
        winapi.C_POINTER.withName("lpszClassName"),
        winapi.C_POINTER.withName("hIconSm")
