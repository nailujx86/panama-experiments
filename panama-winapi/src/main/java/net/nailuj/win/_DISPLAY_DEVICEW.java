...
public class _DISPLAY_DEVICEW {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.sequenceLayout(32, winapi.C_SHORT).withName("DeviceName"),
        MemoryLayout.sequenceLayout(128, winapi.C_SHORT).withName("DeviceString"),
        winapi.C_LONG.withName("StateFlags"),
        MemoryLayout.sequenceLayout(128, winapi.C_SHORT).withName("DeviceID"),
        MemoryLayout.sequenceLayout(128, winapi.C_SHORT).withName("DeviceKey")
