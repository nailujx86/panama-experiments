...
public class _DISPATCHER_CONTEXT_NONVOLREG_ARM64 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.unionLayout(
        MemoryLayout.sequenceLayout(152, winapi.C_CHAR).withName("Buffer"),
        MemoryLayout.structLayout(
            MemoryLayout.sequenceLayout(11, winapi.C_LONG_LONG).withName("GpNvRegs"),
            MemoryLayout.sequenceLayout(8, winapi.C_DOUBLE).withName("FpNvRegs")
        ).withName("$anon$7103:5")
    ...
    private static final SequenceLayout GpNvRegs$LAYOUT = (SequenceLayout)$LAYOUT.select(groupElement("$anon$7103:5"), groupElement("GpNvRegs"));
    ...
    private static final SequenceLayout FpNvRegs$LAYOUT = (SequenceLayout)$LAYOUT.select(groupElement("$anon$7103:5"), groupElement("FpNvRegs"));
