...
public class _IMAGE_DOS_HEADER {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_SHORT.withName("e_magic"),
        winapi.C_SHORT.withName("e_cblp"),
        winapi.C_SHORT.withName("e_cp"),
        winapi.C_SHORT.withName("e_crlc"),
        winapi.C_SHORT.withName("e_cparhdr"),
        winapi.C_SHORT.withName("e_minalloc"),
        winapi.C_SHORT.withName("e_maxalloc"),
        winapi.C_SHORT.withName("e_ss"),
        winapi.C_SHORT.withName("e_sp"),
        winapi.C_SHORT.withName("e_csum"),
        winapi.C_SHORT.withName("e_ip"),
        winapi.C_SHORT.withName("e_cs"),
        winapi.C_SHORT.withName("e_lfarlc"),
        winapi.C_SHORT.withName("e_ovno"),
        MemoryLayout.sequenceLayout(4, winapi.C_SHORT).withName("e_res"),
        winapi.C_SHORT.withName("e_oemid"),
        winapi.C_SHORT.withName("e_oeminfo"),
        MemoryLayout.sequenceLayout(10, winapi.C_SHORT).withName("e_res2"),
        winapi.align(winapi.C_LONG, 2).withName("e_lfanew")
