...
public class _FILE_OBJECTID_BUFFER {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.sequenceLayout(16, winapi.C_CHAR).withName("ObjectId"),
        MemoryLayout.unionLayout(
            MemoryLayout.structLayout(
                MemoryLayout.sequenceLayout(16, winapi.C_CHAR).withName("BirthVolumeId"),
                MemoryLayout.sequenceLayout(16, winapi.C_CHAR).withName("BirthObjectId"),
                MemoryLayout.sequenceLayout(16, winapi.C_CHAR).withName("DomainId")
            ).withName("$anon$12838:9"),
            MemoryLayout.sequenceLayout(48, winapi.C_CHAR).withName("ExtendedInfo")
        ).withName("$anon$12837:5")
    ...
    private static final SequenceLayout BirthVolumeId$LAYOUT = (SequenceLayout)$LAYOUT.select(groupElement("$anon$12837:5"), groupElement("$anon$12838:9"), groupElement("BirthVolumeId"));
    ...
    private static final SequenceLayout BirthObjectId$LAYOUT = (SequenceLayout)$LAYOUT.select(groupElement("$anon$12837:5"), groupElement("$anon$12838:9"), groupElement("BirthObjectId"));
    ...
    private static final SequenceLayout DomainId$LAYOUT = (SequenceLayout)$LAYOUT.select(groupElement("$anon$12837:5"), groupElement("$anon$12838:9"), groupElement("DomainId"));
    ...
    private static final SequenceLayout ExtendedInfo$LAYOUT = (SequenceLayout)$LAYOUT.select(groupElement("$anon$12837:5"), groupElement("ExtendedInfo"));
