...
public class _CMSG_CMS_RECIPIENT_INFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_LONG.withName("dwRecipientChoice"),
        MemoryLayout.paddingLayout(4),
        MemoryLayout.unionLayout(
            winapi.C_POINTER.withName("pKeyTrans"),
            winapi.C_POINTER.withName("pKeyAgree"),
            winapi.C_POINTER.withName("pMailList")
        ).withName("$anon$7872:5")
    ...
    private static final AddressLayout pKeyTrans$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$7872:5"), groupElement("pKeyTrans"));
    ...
    private static final AddressLayout pKeyAgree$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$7872:5"), groupElement("pKeyAgree"));
    ...
    private static final AddressLayout pMailList$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$7872:5"), groupElement("pMailList"));
