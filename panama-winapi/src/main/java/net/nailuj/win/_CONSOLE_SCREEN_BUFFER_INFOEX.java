...
public class _CONSOLE_SCREEN_BUFFER_INFOEX {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_SHORT.withName("wAttributes"),
        _SMALL_RECT.layout().withName("srWindow"),
        _COORD.layout().withName("dwMaximumWindowSize"),
        winapi.C_SHORT.withName("wPopupAttributes"),
        winapi.C_INT.withName("bFullscreenSupported"),
        MemoryLayout.sequenceLayout(16, winapi.C_LONG).withName("ColorTable")
