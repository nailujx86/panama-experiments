...
public class _SI_COPYFILE {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_LONG.withName("SourceFileNameLength"),
        winapi.C_LONG.withName("DestinationFileNameLength"),
        winapi.C_LONG.withName("Flags"),
        MemoryLayout.sequenceLayout(1, winapi.C_SHORT).withName("FileNameBuffer"),
