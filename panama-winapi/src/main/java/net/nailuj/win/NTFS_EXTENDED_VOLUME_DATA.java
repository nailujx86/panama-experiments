...
public class NTFS_EXTENDED_VOLUME_DATA {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_SHORT.withName("LfsMajorVersion"),
        winapi.C_SHORT.withName("LfsMinorVersion"),
        winapi.C_LONG.withName("MaxDeviceTrimExtentCount"),
        winapi.C_LONG.withName("MaxDeviceTrimByteCount"),
        winapi.C_LONG.withName("MaxVolumeTrimExtentCount"),
        winapi.C_LONG.withName("MaxVolumeTrimByteCount")
    ).withName("$anon$11629:9");
