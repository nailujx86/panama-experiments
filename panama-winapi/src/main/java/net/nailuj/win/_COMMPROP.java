...
public class _COMMPROP {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_SHORT.withName("wPacketLength"),
        winapi.C_SHORT.withName("wPacketVersion"),
        winapi.C_LONG.withName("dwServiceMask"),
        winapi.C_LONG.withName("dwReserved1"),
        winapi.C_LONG.withName("dwMaxTxQueue"),
        winapi.C_LONG.withName("dwMaxRxQueue"),
        winapi.C_LONG.withName("dwMaxBaud"),
        winapi.C_LONG.withName("dwProvSubType"),
        winapi.C_LONG.withName("dwProvCapabilities"),
        winapi.C_LONG.withName("dwSettableParams"),
        winapi.C_LONG.withName("dwSettableBaud"),
        winapi.C_SHORT.withName("wSettableData"),
        winapi.C_SHORT.withName("wSettableStopParity"),
        winapi.C_LONG.withName("dwCurrentTxQueue"),
        winapi.C_LONG.withName("dwCurrentRxQueue"),
        winapi.C_LONG.withName("dwProvSpec1"),
        winapi.C_LONG.withName("dwProvSpec2"),
        MemoryLayout.sequenceLayout(1, winapi.C_SHORT).withName("wcProvChar"),
