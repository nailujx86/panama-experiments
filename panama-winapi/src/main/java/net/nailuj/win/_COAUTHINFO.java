...
public class _COAUTHINFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_LONG.withName("dwAuthnSvc"),
        winapi.C_LONG.withName("dwAuthzSvc"),
        winapi.C_POINTER.withName("pwszServerPrincName"),
        winapi.C_LONG.withName("dwAuthnLevel"),
        winapi.C_LONG.withName("dwImpersonationLevel"),
        winapi.C_POINTER.withName("pAuthIdentityData"),
        winapi.C_LONG.withName("dwCapabilities"),
