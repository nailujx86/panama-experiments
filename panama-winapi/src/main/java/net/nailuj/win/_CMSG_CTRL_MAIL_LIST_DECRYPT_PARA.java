...
public class _CMSG_CTRL_MAIL_LIST_DECRYPT_PARA {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_LONG.withName("dwRecipientIndex"),
        winapi.C_LONG.withName("dwKeyChoice"),
        MemoryLayout.unionLayout(
            winapi.C_LONG_LONG.withName("hKeyEncryptionKey"),
            winapi.C_POINTER.withName("pvKeyEncryptionKey")
        ).withName("$anon$8178:5")
    ...
    private static final OfLong hKeyEncryptionKey$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$8178:5"), groupElement("hKeyEncryptionKey"));
    ...
    private static final AddressLayout pvKeyEncryptionKey$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$8178:5"), groupElement("pvKeyEncryptionKey"));
