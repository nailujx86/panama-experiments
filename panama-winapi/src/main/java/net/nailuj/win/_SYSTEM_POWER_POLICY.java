...
public class _SYSTEM_POWER_POLICY {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_INT.withName("LidOpenWake"),
        winapi.C_LONG.withName("Reserved"),
        POWER_ACTION_POLICY.layout().withName("Idle"),
        winapi.C_LONG.withName("IdleTimeout"),
        winapi.C_CHAR.withName("IdleSensitivity"),
        winapi.C_CHAR.withName("DynamicThrottle"),
        MemoryLayout.sequenceLayout(2, winapi.C_CHAR).withName("Spare2"),
        winapi.C_INT.withName("MinSleep"),
        winapi.C_INT.withName("MaxSleep"),
        winapi.C_INT.withName("ReducedLatencySleep"),
        winapi.C_LONG.withName("WinLogonFlags"),
        winapi.C_LONG.withName("Spare3"),
        winapi.C_LONG.withName("DozeS4Timeout"),
        winapi.C_LONG.withName("BroadcastCapacityResolution"),
        MemoryLayout.sequenceLayout(4, SYSTEM_POWER_LEVEL.layout()).withName("DischargePolicy"),
        winapi.C_LONG.withName("VideoTimeout"),
        winapi.C_CHAR.withName("VideoDimDisplay"),
        MemoryLayout.paddingLayout(3),
        MemoryLayout.sequenceLayout(3, winapi.C_LONG).withName("VideoReserved"),
        winapi.C_LONG.withName("SpindownTimeout"),
        winapi.C_CHAR.withName("OptimizeForPower"),
        winapi.C_CHAR.withName("FanThrottleTolerance"),
        winapi.C_CHAR.withName("ForcedThrottle"),
        winapi.C_CHAR.withName("MinThrottle"),
