    ...
    public static class DeviceSpecific {
        ...
        public static class DiskInfo {
            ...
            private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
                ...
                winapi.C_INT.withName("MediaType"),
                winapi.C_LONG.withName("TracksPerCylinder"),
                winapi.C_LONG.withName("SectorsPerTrack"),
                winapi.C_LONG.withName("BytesPerSector"),
                winapi.C_LONG.withName("NumberMediaSides"),
                winapi.C_LONG.withName("MediaCharacteristics")
            ).withName("$anon$992:9");
        ...
        public static class TapeInfo {
            ...
            private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
                winapi.C_INT.withName("MediaType"),
                winapi.C_LONG.withName("MediaCharacteristics"),
                winapi.C_LONG.withName("CurrentBlockSize"),
            ...
            public static class BusSpecificData {
                ...
                public static class ScsiInformation {
                    ...
                    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
                        winapi.C_CHAR.withName("MediumType"),
                        winapi.C_CHAR.withName("DensityCode")
                    ).withName("$anon$1023:17");
