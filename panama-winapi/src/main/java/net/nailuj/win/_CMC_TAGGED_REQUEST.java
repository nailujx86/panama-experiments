...
public class _CMC_TAGGED_REQUEST {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_LONG.withName("dwTaggedRequestChoice"),
        MemoryLayout.paddingLayout(4),
        MemoryLayout.unionLayout(
            winapi.C_POINTER.withName("pTaggedCertRequest")
        ).withName("$anon$5274:5")
    ...
    private static final AddressLayout pTaggedCertRequest$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$5274:5"), groupElement("pTaggedCertRequest"));
