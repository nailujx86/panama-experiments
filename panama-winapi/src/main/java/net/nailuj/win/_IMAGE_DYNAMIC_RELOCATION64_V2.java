...
public class _IMAGE_DYNAMIC_RELOCATION64_V2 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.align(winapi.C_LONG, 1).withName("HeaderSize"),
        winapi.align(winapi.C_LONG, 1).withName("FixupInfoSize"),
        winapi.align(winapi.C_LONG_LONG, 1).withName("Symbol"),
        winapi.align(winapi.C_LONG, 1).withName("SymbolGroup"),
        winapi.align(winapi.C_LONG, 1).withName("Flags")
