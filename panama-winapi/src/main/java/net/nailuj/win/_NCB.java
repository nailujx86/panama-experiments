...
public class _NCB {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_CHAR.withName("ncb_command"),
        winapi.C_CHAR.withName("ncb_retcode"),
        winapi.C_CHAR.withName("ncb_lsn"),
        winapi.C_CHAR.withName("ncb_num"),
        MemoryLayout.paddingLayout(4),
        winapi.C_POINTER.withName("ncb_buffer"),
        winapi.C_SHORT.withName("ncb_length"),
        MemoryLayout.sequenceLayout(16, winapi.C_CHAR).withName("ncb_callname"),
        MemoryLayout.sequenceLayout(16, winapi.C_CHAR).withName("ncb_name"),
        winapi.C_CHAR.withName("ncb_rto"),
        winapi.C_CHAR.withName("ncb_sto"),
        MemoryLayout.paddingLayout(4),
        winapi.C_POINTER.withName("ncb_post"),
        winapi.C_CHAR.withName("ncb_lana_num"),
        winapi.C_CHAR.withName("ncb_cmd_cplt"),
        MemoryLayout.sequenceLayout(18, winapi.C_CHAR).withName("ncb_reserve"),
        MemoryLayout.paddingLayout(4),
        winapi.C_POINTER.withName("ncb_event")
    ).withName("_NCB");
    ...
    public static class ncb_post {
        ...
        private static final MethodHandle UP$MH = winapi.upcallHandle(ncb_post.Function.class, "apply", $DESC);
