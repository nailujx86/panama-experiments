...
public class _IMAGE_LOAD_CONFIG_DIRECTORY64 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_SHORT.withName("MajorVersion"),
        winapi.C_SHORT.withName("MinorVersion"),
        winapi.C_LONG.withName("GlobalFlagsClear"),
        winapi.C_LONG.withName("GlobalFlagsSet"),
        winapi.C_LONG.withName("CriticalSectionDefaultTimeout"),
        winapi.align(winapi.C_LONG_LONG, 4).withName("DeCommitFreeBlockThreshold"),
        winapi.align(winapi.C_LONG_LONG, 4).withName("DeCommitTotalFreeThreshold"),
        winapi.align(winapi.C_LONG_LONG, 4).withName("LockPrefixTable"),
        winapi.align(winapi.C_LONG_LONG, 4).withName("MaximumAllocationSize"),
        winapi.align(winapi.C_LONG_LONG, 4).withName("VirtualMemoryThreshold"),
        winapi.align(winapi.C_LONG_LONG, 4).withName("ProcessAffinityMask"),
        winapi.C_LONG.withName("ProcessHeapFlags"),
        winapi.C_SHORT.withName("CSDVersion"),
        winapi.C_SHORT.withName("DependentLoadFlags"),
        winapi.align(winapi.C_LONG_LONG, 4).withName("EditList"),
        winapi.align(winapi.C_LONG_LONG, 4).withName("SecurityCookie"),
        winapi.align(winapi.C_LONG_LONG, 4).withName("SEHandlerTable"),
        winapi.align(winapi.C_LONG_LONG, 4).withName("SEHandlerCount"),
        winapi.align(winapi.C_LONG_LONG, 4).withName("GuardCFCheckFunctionPointer"),
        winapi.align(winapi.C_LONG_LONG, 4).withName("GuardCFDispatchFunctionPointer"),
        winapi.align(winapi.C_LONG_LONG, 4).withName("GuardCFFunctionTable"),
        winapi.align(winapi.C_LONG_LONG, 4).withName("GuardCFFunctionCount"),
        winapi.C_LONG.withName("GuardFlags"),
        _IMAGE_LOAD_CONFIG_CODE_INTEGRITY.layout().withName("CodeIntegrity"),
        winapi.align(winapi.C_LONG_LONG, 4).withName("GuardAddressTakenIatEntryTable"),
        winapi.align(winapi.C_LONG_LONG, 4).withName("GuardAddressTakenIatEntryCount"),
        winapi.align(winapi.C_LONG_LONG, 4).withName("GuardLongJumpTargetTable"),
        winapi.align(winapi.C_LONG_LONG, 4).withName("GuardLongJumpTargetCount"),
        winapi.align(winapi.C_LONG_LONG, 4).withName("DynamicValueRelocTable"),
        winapi.align(winapi.C_LONG_LONG, 4).withName("CHPEMetadataPointer"),
        winapi.align(winapi.C_LONG_LONG, 4).withName("GuardRFFailureRoutine"),
        winapi.align(winapi.C_LONG_LONG, 4).withName("GuardRFFailureRoutineFunctionPointer"),
        winapi.C_LONG.withName("DynamicValueRelocTableOffset"),
        winapi.C_SHORT.withName("DynamicValueRelocTableSection"),
        winapi.C_SHORT.withName("Reserved2"),
        winapi.align(winapi.C_LONG_LONG, 4).withName("GuardRFVerifyStackPointerFunctionPointer"),
        winapi.C_LONG.withName("HotPatchTableOffset"),
        winapi.C_LONG.withName("Reserved3"),
        winapi.align(winapi.C_LONG_LONG, 4).withName("EnclaveConfigurationPointer"),
        winapi.align(winapi.C_LONG_LONG, 4).withName("VolatileMetadataPointer"),
        winapi.align(winapi.C_LONG_LONG, 4).withName("GuardEHContinuationTable"),
        winapi.align(winapi.C_LONG_LONG, 4).withName("GuardEHContinuationCount"),
        winapi.align(winapi.C_LONG_LONG, 4).withName("GuardXFGCheckFunctionPointer"),
        winapi.align(winapi.C_LONG_LONG, 4).withName("GuardXFGDispatchFunctionPointer"),
        winapi.align(winapi.C_LONG_LONG, 4).withName("GuardXFGTableDispatchFunctionPointer"),
        winapi.align(winapi.C_LONG_LONG, 4).withName("CastGuardOsDeterminedFailureMode"),
        winapi.align(winapi.C_LONG_LONG, 4).withName("GuardMemcpyFunctionPointer")
    ...
    private static final long GuardMemcpyFunctionPointer$OFFSET = 312;
