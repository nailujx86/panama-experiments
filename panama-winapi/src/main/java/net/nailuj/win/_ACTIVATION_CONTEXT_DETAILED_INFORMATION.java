...
public class _ACTIVATION_CONTEXT_DETAILED_INFORMATION {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_LONG.withName("ulFormatVersion"),
        winapi.C_LONG.withName("ulAssemblyCount"),
        winapi.C_LONG.withName("ulRootManifestPathType"),
        winapi.C_LONG.withName("ulRootManifestPathChars"),
        winapi.C_LONG.withName("ulRootConfigurationPathType"),
        winapi.C_LONG.withName("ulRootConfigurationPathChars"),
        winapi.C_LONG.withName("ulAppDirPathType"),
        winapi.C_LONG.withName("ulAppDirPathChars"),
        MemoryLayout.paddingLayout(4),
        winapi.C_POINTER.withName("lpRootManifestPath"),
        winapi.C_POINTER.withName("lpRootConfigurationPath"),
        winapi.C_POINTER.withName("lpAppDirPath")
