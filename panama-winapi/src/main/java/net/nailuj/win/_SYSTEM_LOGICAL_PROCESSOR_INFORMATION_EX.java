...
public class _SYSTEM_LOGICAL_PROCESSOR_INFORMATION_EX {
    ...
    private static final GroupLayout Processor$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$14040:5"), groupElement("Processor"));
    ...
    private static final GroupLayout NumaNode$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$14040:5"), groupElement("NumaNode"));
    ...
    private static final GroupLayout Cache$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$14040:5"), groupElement("Cache"));
    ...
    private static final GroupLayout Group$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$14040:5"), groupElement("Group"));
