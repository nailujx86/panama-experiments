...
public class _IMAGE_OS2_HEADER {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_SHORT.withName("ne_magic"),
        winapi.C_CHAR.withName("ne_ver"),
        winapi.C_CHAR.withName("ne_rev"),
        winapi.C_SHORT.withName("ne_enttab"),
        winapi.C_SHORT.withName("ne_cbenttab"),
        winapi.align(winapi.C_LONG, 2).withName("ne_crc"),
        winapi.C_SHORT.withName("ne_flags"),
        winapi.C_SHORT.withName("ne_autodata"),
        winapi.C_SHORT.withName("ne_heap"),
        winapi.C_SHORT.withName("ne_stack"),
        winapi.align(winapi.C_LONG, 2).withName("ne_csip"),
        winapi.align(winapi.C_LONG, 2).withName("ne_sssp"),
        winapi.C_SHORT.withName("ne_cseg"),
        winapi.C_SHORT.withName("ne_cmod"),
        winapi.C_SHORT.withName("ne_cbnrestab"),
        winapi.C_SHORT.withName("ne_segtab"),
        winapi.C_SHORT.withName("ne_rsrctab"),
        winapi.C_SHORT.withName("ne_restab"),
        winapi.C_SHORT.withName("ne_modtab"),
        winapi.C_SHORT.withName("ne_imptab"),
        winapi.align(winapi.C_LONG, 2).withName("ne_nrestab"),
        winapi.C_SHORT.withName("ne_cmovent"),
        winapi.C_SHORT.withName("ne_align"),
        winapi.C_SHORT.withName("ne_cres"),
        winapi.C_CHAR.withName("ne_exetyp"),
        winapi.C_CHAR.withName("ne_flagsothers"),
        winapi.C_SHORT.withName("ne_pretthunks"),
        winapi.C_SHORT.withName("ne_psegrefbytes"),
        winapi.C_SHORT.withName("ne_swaparea"),
        winapi.C_SHORT.withName("ne_expver")
