...
public class DISK_SPACE_INFORMATION {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_LONG_LONG.withName("ActualTotalAllocationUnits"),
        winapi.C_LONG_LONG.withName("ActualAvailableAllocationUnits"),
        winapi.C_LONG_LONG.withName("ActualPoolUnavailableAllocationUnits"),
        winapi.C_LONG_LONG.withName("CallerTotalAllocationUnits"),
        winapi.C_LONG_LONG.withName("CallerAvailableAllocationUnits"),
        winapi.C_LONG_LONG.withName("CallerPoolUnavailableAllocationUnits"),
        winapi.C_LONG_LONG.withName("UsedAllocationUnits"),
        winapi.C_LONG_LONG.withName("TotalReservedAllocationUnits"),
        winapi.C_LONG_LONG.withName("VolumeStorageReserveAllocationUnits"),
        winapi.C_LONG_LONG.withName("AvailableCommittedAllocationUnits"),
        winapi.C_LONG_LONG.withName("PoolAvailableAllocationUnits"),
        winapi.C_LONG.withName("SectorsPerAllocationUnit"),
