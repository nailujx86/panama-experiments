...
public class _JOBOBJECT_SECURITY_LIMIT_INFORMATION {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_LONG.withName("SecurityLimitFlags"),
        MemoryLayout.paddingLayout(4),
        winapi.C_POINTER.withName("JobToken"),
        winapi.C_POINTER.withName("SidsToDisable"),
        winapi.C_POINTER.withName("PrivilegesToDelete"),
