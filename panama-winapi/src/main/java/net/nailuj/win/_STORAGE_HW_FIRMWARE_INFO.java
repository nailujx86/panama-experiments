...
public class _STORAGE_HW_FIRMWARE_INFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_CHAR.withName("SlotCount"),
        winapi.C_CHAR.withName("ActiveSlot"),
        winapi.C_CHAR.withName("PendingActivateSlot"),
        winapi.C_CHAR.withName("FirmwareShared"),
        MemoryLayout.sequenceLayout(3, winapi.C_CHAR).withName("Reserved"),
        winapi.C_LONG.withName("ImagePayloadAlignment"),
        winapi.C_LONG.withName("ImagePayloadMaxSize"),
