...
public class tagCONVINFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_LONG_LONG.withName("hUser"),
        winapi.C_POINTER.withName("hConvPartner"),
        winapi.C_POINTER.withName("hszSvcPartner"),
        winapi.C_POINTER.withName("hszServiceReq"),
        winapi.C_POINTER.withName("hszTopic"),
        winapi.C_POINTER.withName("hszItem"),
        winapi.C_INT.withName("wFmt"),
        winapi.C_INT.withName("wType"),
        winapi.C_INT.withName("wStatus"),
        winapi.C_INT.withName("wConvst"),
        winapi.C_INT.withName("wLastError"),
        MemoryLayout.paddingLayout(4),
        winapi.C_POINTER.withName("hConvList"),
        tagCONVCONTEXT.layout().withName("ConvCtxt"),
        MemoryLayout.paddingLayout(4),
        winapi.C_POINTER.withName("hwnd"),
        winapi.C_POINTER.withName("hwndPartner")
