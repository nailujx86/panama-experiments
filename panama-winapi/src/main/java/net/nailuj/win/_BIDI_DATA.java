...
public class _BIDI_DATA {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_LONG.withName("dwBidiType"),
    ...
    public static class u {
        ...
        private static final GroupLayout $LAYOUT = MemoryLayout.unionLayout(
            winapi.C_INT.withName("bData"),
            winapi.C_LONG.withName("iData"),
            winapi.C_POINTER.withName("sData"),
            winapi.C_FLOAT.withName("fData"),
            _BINARY_CONTAINER.layout().withName("biData")
        ).withName("$anon$2469:9");
