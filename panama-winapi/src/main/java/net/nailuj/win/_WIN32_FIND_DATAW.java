...
public class _WIN32_FIND_DATAW {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_LONG.withName("dwFileAttributes"),
        ...
        winapi.C_LONG.withName("nFileSizeHigh"),
        winapi.C_LONG.withName("nFileSizeLow"),
        winapi.C_LONG.withName("dwReserved0"),
        winapi.C_LONG.withName("dwReserved1"),
        MemoryLayout.sequenceLayout(260, winapi.C_SHORT).withName("cFileName"),
        MemoryLayout.sequenceLayout(14, winapi.C_SHORT).withName("cAlternateFileName")
