...
public class _CERT_CHAIN_ENGINE_CONFIG {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_POINTER.withName("hRestrictedRoot"),
        winapi.C_POINTER.withName("hRestrictedTrust"),
        winapi.C_POINTER.withName("hRestrictedOther"),
        winapi.C_LONG.withName("cAdditionalStore"),
        MemoryLayout.paddingLayout(4),
        winapi.C_POINTER.withName("rghAdditionalStore"),
        winapi.C_LONG.withName("dwFlags"),
        winapi.C_LONG.withName("dwUrlRetrievalTimeout"),
        winapi.C_LONG.withName("MaximumCachedCertificates"),
        winapi.C_LONG.withName("CycleDetectionModulus"),
        winapi.C_POINTER.withName("hExclusiveRoot"),
        winapi.C_POINTER.withName("hExclusiveTrustedPeople"),
        winapi.C_LONG.withName("dwExclusiveFlags"),
        MemoryLayout.paddingLayout(4)
