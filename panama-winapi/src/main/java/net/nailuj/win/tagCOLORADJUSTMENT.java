...
public class tagCOLORADJUSTMENT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_SHORT.withName("caSize"),
        winapi.C_SHORT.withName("caFlags"),
        winapi.C_SHORT.withName("caIlluminantIndex"),
        winapi.C_SHORT.withName("caRedGamma"),
        winapi.C_SHORT.withName("caGreenGamma"),
        winapi.C_SHORT.withName("caBlueGamma"),
        winapi.C_SHORT.withName("caReferenceBlack"),
        winapi.C_SHORT.withName("caReferenceWhite"),
        winapi.C_SHORT.withName("caContrast"),
        winapi.C_SHORT.withName("caBrightness"),
        winapi.C_SHORT.withName("caColorfulness"),
        winapi.C_SHORT.withName("caRedGreenTint")
