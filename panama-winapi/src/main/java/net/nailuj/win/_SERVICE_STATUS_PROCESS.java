...
public class _SERVICE_STATUS_PROCESS {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_LONG.withName("dwCurrentState"),
        winapi.C_LONG.withName("dwControlsAccepted"),
        winapi.C_LONG.withName("dwWin32ExitCode"),
        winapi.C_LONG.withName("dwServiceSpecificExitCode"),
        winapi.C_LONG.withName("dwCheckPoint"),
        winapi.C_LONG.withName("dwWaitHint"),
        winapi.C_LONG.withName("dwProcessId"),
        winapi.C_LONG.withName("dwServiceFlags")
