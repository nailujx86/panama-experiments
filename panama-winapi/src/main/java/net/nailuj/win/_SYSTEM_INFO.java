...
public class _SYSTEM_INFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.unionLayout(
            winapi.C_LONG.withName("dwOemId"),
            MemoryLayout.structLayout(
                winapi.C_SHORT.withName("wProcessorArchitecture"),
                winapi.C_SHORT.withName("wReserved")
            ).withName("$anon$50:9")
        ).withName("$anon$48:5"),
        winapi.C_LONG.withName("dwPageSize"),
        winapi.C_POINTER.withName("lpMinimumApplicationAddress"),
        winapi.C_POINTER.withName("lpMaximumApplicationAddress"),
        winapi.C_LONG_LONG.withName("dwActiveProcessorMask"),
        winapi.C_LONG.withName("dwNumberOfProcessors"),
        winapi.C_LONG.withName("dwProcessorType"),
        winapi.C_LONG.withName("dwAllocationGranularity"),
        winapi.C_SHORT.withName("wProcessorLevel"),
        winapi.C_SHORT.withName("wProcessorRevision")
