...
public class _FILEMUIINFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_LONG.withName("dwSize"),
        winapi.C_LONG.withName("dwVersion"),
        winapi.C_LONG.withName("dwFileType"),
        MemoryLayout.sequenceLayout(16, winapi.C_CHAR).withName("pChecksum"),
        MemoryLayout.sequenceLayout(16, winapi.C_CHAR).withName("pServiceChecksum"),
        winapi.C_LONG.withName("dwLanguageNameOffset"),
        winapi.C_LONG.withName("dwTypeIDMainSize"),
        winapi.C_LONG.withName("dwTypeIDMainOffset"),
        winapi.C_LONG.withName("dwTypeNameMainOffset"),
        winapi.C_LONG.withName("dwTypeIDMUISize"),
        winapi.C_LONG.withName("dwTypeIDMUIOffset"),
        winapi.C_LONG.withName("dwTypeNameMUIOffset"),
        MemoryLayout.sequenceLayout(8, winapi.C_CHAR).withName("abBuffer")
