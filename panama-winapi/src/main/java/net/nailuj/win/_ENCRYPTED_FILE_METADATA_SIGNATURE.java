...
public class _ENCRYPTED_FILE_METADATA_SIGNATURE {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_LONG.withName("dwEfsAccessType"),
        MemoryLayout.paddingLayout(4),
        winapi.C_POINTER.withName("pCertificatesAdded"),
        winapi.C_POINTER.withName("pEncryptionCertificate"),
        winapi.C_POINTER.withName("pEfsStreamSignature")
