...
public class _CRYPT_PKCS8_IMPORT_PARAMS {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_POINTER.withName("pResolvehCryptProvFunc"),
        winapi.C_POINTER.withName("pVoidResolveFunc"),
        winapi.C_POINTER.withName("pDecryptPrivateKeyFunc"),
        winapi.C_POINTER.withName("pVoidDecryptFunc")
