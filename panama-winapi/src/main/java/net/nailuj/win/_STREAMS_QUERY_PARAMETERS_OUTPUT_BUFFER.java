...
public class _STREAMS_QUERY_PARAMETERS_OUTPUT_BUFFER {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_LONG.withName("OptimalWriteSize"),
        winapi.C_LONG.withName("StreamGranularitySize"),
        winapi.C_LONG.withName("StreamIdMin"),
        winapi.C_LONG.withName("StreamIdMax")
