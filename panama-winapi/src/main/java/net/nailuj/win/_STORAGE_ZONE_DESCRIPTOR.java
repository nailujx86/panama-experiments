...
public class _STORAGE_ZONE_DESCRIPTOR {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_INT.withName("ZoneType"),
        winapi.C_INT.withName("ZoneCondition"),
        winapi.C_CHAR.withName("ResetWritePointerRecommend"),
        MemoryLayout.sequenceLayout(3, winapi.C_CHAR).withName("Reserved0"),
        winapi.C_LONG_LONG.withName("ZoneSize"),
        winapi.C_LONG_LONG.withName("WritePointerOffset")
