...
public class _SD_QUERY_STATS_OUTPUT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_LONG_LONG.withName("SdsStreamSize"),
        winapi.C_LONG_LONG.withName("SdsAllocationSize"),
        winapi.C_LONG_LONG.withName("SiiStreamSize"),
        winapi.C_LONG_LONG.withName("SiiAllocationSize"),
        winapi.C_LONG_LONG.withName("SdhStreamSize"),
        winapi.C_LONG_LONG.withName("SdhAllocationSize"),
        winapi.C_LONG_LONG.withName("NumSDTotal"),
        winapi.C_LONG_LONG.withName("NumSDUnused")
