...
public class _SE_ACCESS_REPLY {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_LONG.withName("ResultListCount"),
        winapi.C_POINTER.withName("GrantedAccess"),
        winapi.C_POINTER.withName("AccessStatus"),
        winapi.C_POINTER.withName("AccessReason"),
