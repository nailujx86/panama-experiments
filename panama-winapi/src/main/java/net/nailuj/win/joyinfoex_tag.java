...
public class joyinfoex_tag {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.align(winapi.C_LONG, 1).withName("dwSize"),
        winapi.align(winapi.C_LONG, 1).withName("dwFlags"),
        winapi.align(winapi.C_LONG, 1).withName("dwXpos"),
        winapi.align(winapi.C_LONG, 1).withName("dwYpos"),
        winapi.align(winapi.C_LONG, 1).withName("dwZpos"),
        winapi.align(winapi.C_LONG, 1).withName("dwRpos"),
        winapi.align(winapi.C_LONG, 1).withName("dwUpos"),
        winapi.align(winapi.C_LONG, 1).withName("dwVpos"),
        winapi.align(winapi.C_LONG, 1).withName("dwButtons"),
        winapi.align(winapi.C_LONG, 1).withName("dwButtonNumber"),
        winapi.align(winapi.C_LONG, 1).withName("dwPOV"),
