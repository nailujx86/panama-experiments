...
public class _MMIOINFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.align(winapi.C_LONG, 1).withName("dwFlags"),
        winapi.align(winapi.C_LONG, 1).withName("fccIOProc"),
        winapi.align(winapi.C_POINTER, 1).withName("pIOProc"),
        winapi.align(winapi.C_INT, 1).withName("wErrorRet"),
        winapi.align(winapi.C_POINTER, 1).withName("htask"),
        winapi.align(winapi.C_LONG, 1).withName("cchBuffer"),
        winapi.align(winapi.C_POINTER, 1).withName("pchBuffer"),
        winapi.align(winapi.C_POINTER, 1).withName("pchNext"),
        winapi.align(winapi.C_POINTER, 1).withName("pchEndRead"),
        winapi.align(winapi.C_POINTER, 1).withName("pchEndWrite"),
        winapi.align(winapi.C_LONG, 1).withName("lBufOffset"),
        winapi.align(winapi.C_LONG, 1).withName("lDiskOffset"),
        MemoryLayout.sequenceLayout(3, winapi.align(winapi.C_LONG, 1)).withName("adwInfo"),
        winapi.align(winapi.C_LONG, 1).withName("dwReserved1"),
        winapi.align(winapi.C_LONG, 1).withName("dwReserved2"),
        winapi.align(winapi.C_POINTER, 1).withName("hmmio")
    ).withName("_MMIOINFO");
