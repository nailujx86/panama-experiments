...
public class tagPANOSE {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_CHAR.withName("bFamilyType"),
        winapi.C_CHAR.withName("bSerifStyle"),
        winapi.C_CHAR.withName("bWeight"),
        winapi.C_CHAR.withName("bProportion"),
        winapi.C_CHAR.withName("bContrast"),
        winapi.C_CHAR.withName("bStrokeVariation"),
        winapi.C_CHAR.withName("bArmStyle"),
        winapi.C_CHAR.withName("bLetterform"),
        winapi.C_CHAR.withName("bMidline"),
        winapi.C_CHAR.withName("bXHeight")
    ).withName("tagPANOSE");
