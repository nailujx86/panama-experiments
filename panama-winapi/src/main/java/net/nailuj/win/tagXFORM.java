...
public class tagXFORM {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_FLOAT.withName("eM11"),
        winapi.C_FLOAT.withName("eM12"),
        winapi.C_FLOAT.withName("eM21"),
        winapi.C_FLOAT.withName("eM22"),
        winapi.C_FLOAT.withName("eDx"),
        winapi.C_FLOAT.withName("eDy")
    ).withName("tagXFORM");
