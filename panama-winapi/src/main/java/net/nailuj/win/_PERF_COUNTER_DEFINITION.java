...
public class _PERF_COUNTER_DEFINITION {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_LONG.withName("ByteLength"),
        winapi.C_LONG.withName("CounterNameTitleIndex"),
        winapi.C_LONG.withName("CounterNameTitle"),
        winapi.C_LONG.withName("CounterHelpTitleIndex"),
        winapi.C_LONG.withName("CounterHelpTitle"),
        winapi.C_LONG.withName("DefaultScale"),
        winapi.C_LONG.withName("DetailLevel"),
        winapi.C_LONG.withName("CounterType"),
        winapi.C_LONG.withName("CounterSize"),
        winapi.C_LONG.withName("CounterOffset")
