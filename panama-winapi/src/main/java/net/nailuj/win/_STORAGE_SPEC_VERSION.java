...
public class _STORAGE_SPEC_VERSION {
    ...
    public static class MinorVersion {
        ...
        private static final GroupLayout $LAYOUT = MemoryLayout.unionLayout(
            MemoryLayout.structLayout(
                winapi.C_CHAR.withName("SubMinor"),
                winapi.C_CHAR.withName("Minor")
            ).withName("$anon$2919:13"),
            winapi.C_SHORT.withName("AsUshort")
        ).withName("$anon$2918:9");
        ...
        private static final OfByte SubMinor$LAYOUT = (OfByte)$LAYOUT.select(groupElement("$anon$2919:13"), groupElement("SubMinor"));
        ...
        private static final OfByte Minor$LAYOUT = (OfByte)$LAYOUT.select(groupElement("$anon$2919:13"), groupElement("Minor"));
    ...
    private static final GroupLayout MinorVersion$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$2917:5"), groupElement("MinorVersion"));
    ...
    private static final OfShort MajorVersion$LAYOUT = (OfShort)$LAYOUT.select(groupElement("$anon$2917:5"), groupElement("MajorVersion"));
