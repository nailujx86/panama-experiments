...
public class tagBIND_OPTS2 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_LONG.withName("grfFlags"),
        winapi.C_LONG.withName("grfMode"),
        winapi.C_LONG.withName("dwTickCountDeadline"),
        winapi.C_LONG.withName("dwTrackFlags"),
        winapi.C_LONG.withName("dwClassContext"),
        winapi.C_LONG.withName("locale"),
        MemoryLayout.paddingLayout(4),
        winapi.C_POINTER.withName("pServerInfo")
