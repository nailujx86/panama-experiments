...
public class _STORAGE_HW_ENDURANCE_INFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_LONG.withName("ValidFields"),
        winapi.C_LONG.withName("GroupId"),
        _STORAGE_HW_ENDURANCE_INFO.Flags.layout().withName("Flags"),
        winapi.C_LONG.withName("LifePercentage"),
        MemoryLayout.sequenceLayout(16, winapi.C_CHAR).withName("BytesReadCount"),
        MemoryLayout.sequenceLayout(16, winapi.C_CHAR).withName("ByteWriteCount")
