...
public class _STORAGE_MINIPORT_DESCRIPTOR {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_INT.withName("Portdriver"),
        winapi.C_CHAR.withName("LUNResetSupported"),
        winapi.C_CHAR.withName("TargetResetSupported"),
        winapi.C_SHORT.withName("IoTimeoutValue"),
        winapi.C_CHAR.withName("ExtraIoInfoSupported"),
        _STORAGE_MINIPORT_DESCRIPTOR.Flags.layout().withName("Flags"),
        MemoryLayout.sequenceLayout(2, winapi.C_CHAR).withName("Reserved0"),
    ...
    public static class Flags {
        ...
        private static final GroupLayout $LAYOUT = MemoryLayout.unionLayout(
            ...
            ).withName("$anon$1536:9"),
            winapi.C_CHAR.withName("AsBYTE")
        ).withName("$anon$1535:5");
