...
public class _STORAGE_LB_PROVISIONING_MAP_RESOURCES {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.paddingLayout(1),
        MemoryLayout.sequenceLayout(3, winapi.C_CHAR).withName("Reserved3"),
        winapi.C_LONG_LONG.withName("AvailableMappingResources"),
        winapi.C_LONG_LONG.withName("UsedMappingResources")
