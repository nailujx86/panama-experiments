...
public class _KEY_EVENT_RECORD {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_INT.withName("bKeyDown"),
        winapi.C_SHORT.withName("wRepeatCount"),
        winapi.C_SHORT.withName("wVirtualKeyCode"),
        winapi.C_SHORT.withName("wVirtualScanCode"),
        _KEY_EVENT_RECORD.uChar.layout().withName("uChar"),
        winapi.C_LONG.withName("dwControlKeyState")
    ...
    public static class uChar {
        ...
        private static final GroupLayout $LAYOUT = MemoryLayout.unionLayout(
            winapi.C_SHORT.withName("UnicodeChar"),
            winapi.C_CHAR.withName("AsciiChar")
        ).withName("$anon$53:5");
