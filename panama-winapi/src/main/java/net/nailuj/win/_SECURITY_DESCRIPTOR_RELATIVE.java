...
public class _SECURITY_DESCRIPTOR_RELATIVE {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_CHAR.withName("Revision"),
        winapi.C_CHAR.withName("Sbz1"),
        winapi.C_SHORT.withName("Control"),
        winapi.C_LONG.withName("Owner"),
        winapi.C_LONG.withName("Group"),
        winapi.C_LONG.withName("Sacl"),
        winapi.C_LONG.withName("Dacl")
