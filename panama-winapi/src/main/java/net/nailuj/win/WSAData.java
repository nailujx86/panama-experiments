...
public class WSAData {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_SHORT.withName("wVersion"),
        winapi.C_SHORT.withName("wHighVersion"),
        winapi.C_SHORT.withName("iMaxSockets"),
        winapi.C_SHORT.withName("iMaxUdpDg"),
        winapi.C_POINTER.withName("lpVendorInfo"),
        MemoryLayout.sequenceLayout(257, winapi.C_CHAR).withName("szDescription"),
        MemoryLayout.sequenceLayout(129, winapi.C_CHAR).withName("szSystemStatus"),
