...
public class _CACHE_RELATIONSHIP {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_CHAR.withName("Level"),
        winapi.C_CHAR.withName("Associativity"),
        winapi.C_SHORT.withName("LineSize"),
        winapi.C_LONG.withName("CacheSize"),
        winapi.C_INT.withName("Type"),
        MemoryLayout.sequenceLayout(18, winapi.C_CHAR).withName("Reserved"),
        winapi.C_SHORT.withName("GroupCount"),
        MemoryLayout.unionLayout(
            _GROUP_AFFINITY.layout().withName("GroupMask"),
            MemoryLayout.sequenceLayout(1, _GROUP_AFFINITY.layout()).withName("GroupMasks")
        ).withName("$anon$14016:5")
    ...
    private static final GroupLayout GroupMask$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$14016:5"), groupElement("GroupMask"));
    ...
    private static final SequenceLayout GroupMasks$LAYOUT = (SequenceLayout)$LAYOUT.select(groupElement("$anon$14016:5"), groupElement("GroupMasks"));
