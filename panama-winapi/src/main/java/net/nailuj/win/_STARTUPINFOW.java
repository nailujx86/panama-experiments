...
public class _STARTUPINFOW {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_LONG.withName("cb"),
        MemoryLayout.paddingLayout(4),
        winapi.C_POINTER.withName("lpReserved"),
        winapi.C_POINTER.withName("lpDesktop"),
        winapi.C_POINTER.withName("lpTitle"),
        winapi.C_LONG.withName("dwX"),
        winapi.C_LONG.withName("dwY"),
        winapi.C_LONG.withName("dwXSize"),
        winapi.C_LONG.withName("dwYSize"),
        winapi.C_LONG.withName("dwXCountChars"),
        winapi.C_LONG.withName("dwYCountChars"),
        winapi.C_LONG.withName("dwFillAttribute"),
        winapi.C_LONG.withName("dwFlags"),
        winapi.C_SHORT.withName("wShowWindow"),
        winapi.C_SHORT.withName("cbReserved2"),
        MemoryLayout.paddingLayout(4),
        winapi.C_POINTER.withName("lpReserved2"),
        winapi.C_POINTER.withName("hStdInput"),
        winapi.C_POINTER.withName("hStdOutput"),
        winapi.C_POINTER.withName("hStdError")
