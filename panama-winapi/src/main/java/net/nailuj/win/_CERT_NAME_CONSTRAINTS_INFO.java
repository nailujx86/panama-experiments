...
public class _CERT_NAME_CONSTRAINTS_INFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_LONG.withName("cPermittedSubtree"),
        MemoryLayout.paddingLayout(4),
        winapi.C_POINTER.withName("rgPermittedSubtree"),
        winapi.C_LONG.withName("cExcludedSubtree"),
        MemoryLayout.paddingLayout(4),
        winapi.C_POINTER.withName("rgExcludedSubtree")
