...
public class _PHYSICAL_ELEMENT_STATUS_DESCRIPTOR {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_LONG.withName("ElementIdentifier"),
        winapi.C_CHAR.withName("PhysicalElementType"),
        winapi.C_CHAR.withName("PhysicalElementHealth"),
        MemoryLayout.sequenceLayout(2, winapi.C_CHAR).withName("Reserved1"),
        winapi.C_LONG_LONG.withName("AssociatedCapacity"),
        MemoryLayout.sequenceLayout(4, winapi.C_LONG).withName("Reserved2")
