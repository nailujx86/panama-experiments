...
public class _OCSP_BASIC_RESPONSE_ENTRY {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_LONG.withName("dwCertStatus"),
        MemoryLayout.paddingLayout(4),
        MemoryLayout.unionLayout(
            winapi.C_POINTER.withName("pRevokedInfo")
        ).withName("$anon$5725:5"),
    ...
    private static final AddressLayout pRevokedInfo$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$5725:5"), groupElement("pRevokedInfo"));
