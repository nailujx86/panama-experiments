...
public class _SLIST_HEADER {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.unionLayout(
        MemoryLayout.structLayout(
            winapi.C_LONG_LONG.withName("Alignment"),
            winapi.C_LONG_LONG.withName("Region")
        ).withName("$anon$22461:5"),
    ...
    private static final OfLong Alignment$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$22461:5"), groupElement("Alignment"));
    ...
    private static final OfLong Region$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$22461:5"), groupElement("Region"));
