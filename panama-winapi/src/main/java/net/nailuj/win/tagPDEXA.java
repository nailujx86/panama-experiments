...
public class tagPDEXA {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_POINTER.withName("hDevMode"),
        winapi.C_POINTER.withName("hDevNames"),
        winapi.C_POINTER.withName("hDC"),
        winapi.C_LONG.withName("Flags"),
        winapi.C_LONG.withName("Flags2"),
        winapi.C_LONG.withName("ExclusionFlags"),
        winapi.C_LONG.withName("nPageRanges"),
        winapi.C_LONG.withName("nMaxPageRanges"),
        MemoryLayout.paddingLayout(4),
        winapi.C_POINTER.withName("lpPageRanges"),
        winapi.C_LONG.withName("nMinPage"),
        winapi.C_LONG.withName("nMaxPage"),
        winapi.C_LONG.withName("nCopies"),
        MemoryLayout.paddingLayout(4),
        winapi.C_POINTER.withName("hInstance"),
        winapi.C_POINTER.withName("lpPrintTemplateName"),
        winapi.C_POINTER.withName("lpCallback"),
        winapi.C_LONG.withName("nPropertyPages"),
        MemoryLayout.paddingLayout(4),
        winapi.C_POINTER.withName("lphPropertyPages"),
        winapi.C_LONG.withName("nStartPage"),
        winapi.C_LONG.withName("dwResultAction")
    ).withName("tagPDEXA");
