...
public class BITMAPV4HEADER {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_LONG.withName("bV4Size"),
        winapi.C_LONG.withName("bV4Width"),
        winapi.C_LONG.withName("bV4Height"),
        winapi.C_SHORT.withName("bV4Planes"),
        winapi.C_SHORT.withName("bV4BitCount"),
        winapi.C_LONG.withName("bV4V4Compression"),
        winapi.C_LONG.withName("bV4SizeImage"),
        winapi.C_LONG.withName("bV4XPelsPerMeter"),
        winapi.C_LONG.withName("bV4YPelsPerMeter"),
        winapi.C_LONG.withName("bV4ClrUsed"),
        winapi.C_LONG.withName("bV4ClrImportant"),
        winapi.C_LONG.withName("bV4RedMask"),
        winapi.C_LONG.withName("bV4GreenMask"),
        winapi.C_LONG.withName("bV4BlueMask"),
        winapi.C_LONG.withName("bV4AlphaMask"),
        winapi.C_LONG.withName("bV4CSType"),
        tagICEXYZTRIPLE.layout().withName("bV4Endpoints"),
        winapi.C_LONG.withName("bV4GammaRed"),
        winapi.C_LONG.withName("bV4GammaGreen"),
        winapi.C_LONG.withName("bV4GammaBlue")
    ).withName("$anon$837:9");
