...
public class tagEXTLOGPEN {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_LONG.withName("elpPenStyle"),
        winapi.C_LONG.withName("elpWidth"),
        winapi.C_INT.withName("elpBrushStyle"),
        winapi.C_LONG.withName("elpColor"),
        winapi.C_LONG_LONG.withName("elpHatch"),
        winapi.C_LONG.withName("elpNumEntries"),
        MemoryLayout.sequenceLayout(1, winapi.C_LONG).withName("elpStyleEntry")
