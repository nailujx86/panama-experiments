...
public class tagENHMETAHEADER {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_LONG.withName("iType"),
        winapi.C_LONG.withName("nSize"),
        _RECTL.layout().withName("rclBounds"),
        _RECTL.layout().withName("rclFrame"),
        winapi.C_LONG.withName("dSignature"),
        winapi.C_LONG.withName("nVersion"),
        winapi.C_LONG.withName("nBytes"),
        winapi.C_LONG.withName("nRecords"),
        winapi.C_SHORT.withName("nHandles"),
        winapi.C_SHORT.withName("sReserved"),
        winapi.C_LONG.withName("nDescription"),
        winapi.C_LONG.withName("offDescription"),
        winapi.C_LONG.withName("nPalEntries"),
        tagSIZE.layout().withName("szlDevice"),
        tagSIZE.layout().withName("szlMillimeters"),
        winapi.C_LONG.withName("cbPixelFormat"),
        winapi.C_LONG.withName("offPixelFormat"),
        winapi.C_LONG.withName("bOpenGL"),
