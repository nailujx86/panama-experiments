...
public class _nlsversioninfoex {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_LONG.withName("dwNLSVersionInfoSize"),
        winapi.C_LONG.withName("dwNLSVersion"),
        winapi.C_LONG.withName("dwDefinedVersion"),
        winapi.C_LONG.withName("dwEffectiveId"),
