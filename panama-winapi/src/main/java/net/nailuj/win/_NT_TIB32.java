...
public class _NT_TIB32 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_LONG.withName("ExceptionList"),
        winapi.C_LONG.withName("StackBase"),
        winapi.C_LONG.withName("StackLimit"),
        winapi.C_LONG.withName("SubSystemTib"),
        MemoryLayout.unionLayout(
            winapi.C_LONG.withName("FiberData"),
            winapi.C_LONG.withName("Version")
        ).withName("$anon$12779:5"),
        winapi.C_LONG.withName("ArbitraryUserPointer"),
        winapi.C_LONG.withName("Self")
    ).withName("_NT_TIB32");
    ...
    private static final OfInt FiberData$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$12779:5"), groupElement("FiberData"));
    ...
    private static final OfInt Version$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$12779:5"), groupElement("Version"));
