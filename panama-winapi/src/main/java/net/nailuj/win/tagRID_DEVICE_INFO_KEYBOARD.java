...
public class tagRID_DEVICE_INFO_KEYBOARD {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_LONG.withName("dwSubType"),
        winapi.C_LONG.withName("dwKeyboardMode"),
        winapi.C_LONG.withName("dwNumberOfFunctionKeys"),
        winapi.C_LONG.withName("dwNumberOfIndicators"),
        winapi.C_LONG.withName("dwNumberOfKeysTotal")
