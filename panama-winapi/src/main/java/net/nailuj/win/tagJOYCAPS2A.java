...
public class tagJOYCAPS2A {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.sequenceLayout(32, winapi.C_CHAR).withName("szPname"),
        winapi.align(winapi.C_INT, 1).withName("wXmin"),
        winapi.align(winapi.C_INT, 1).withName("wXmax"),
        winapi.align(winapi.C_INT, 1).withName("wYmin"),
        winapi.align(winapi.C_INT, 1).withName("wYmax"),
        winapi.align(winapi.C_INT, 1).withName("wZmin"),
        winapi.align(winapi.C_INT, 1).withName("wZmax"),
        winapi.align(winapi.C_INT, 1).withName("wNumButtons"),
        winapi.align(winapi.C_INT, 1).withName("wPeriodMin"),
        winapi.align(winapi.C_INT, 1).withName("wPeriodMax"),
        winapi.align(winapi.C_INT, 1).withName("wRmin"),
        winapi.align(winapi.C_INT, 1).withName("wRmax"),
        winapi.align(winapi.C_INT, 1).withName("wUmin"),
        winapi.align(winapi.C_INT, 1).withName("wUmax"),
        winapi.align(winapi.C_INT, 1).withName("wVmin"),
        winapi.align(winapi.C_INT, 1).withName("wVmax"),
        winapi.align(winapi.C_INT, 1).withName("wCaps"),
        winapi.align(winapi.C_INT, 1).withName("wMaxAxes"),
        winapi.align(winapi.C_INT, 1).withName("wNumAxes"),
        winapi.align(winapi.C_INT, 1).withName("wMaxButtons"),
        MemoryLayout.sequenceLayout(32, winapi.C_CHAR).withName("szRegKey"),
        MemoryLayout.sequenceLayout(260, winapi.C_CHAR).withName("szOEMVxD"),
        winapi.align(_GUID.layout(), 1).withName("ManufacturerGuid"),
        winapi.align(_GUID.layout(), 1).withName("ProductGuid"),
        winapi.align(_GUID.layout(), 1).withName("NameGuid")
