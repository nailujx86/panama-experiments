...
public class _PROPSHEETHEADERW_V2 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_POINTER.withName("pszCaption"),
        winapi.C_INT.withName("nPages"),
        MemoryLayout.paddingLayout(4),
        MemoryLayout.unionLayout(
            winapi.C_INT.withName("nStartPage"),
            winapi.C_POINTER.withName("pStartPage")
        ).withName("$anon$526:5"),
        MemoryLayout.unionLayout(
            winapi.C_POINTER.withName("ppsp"),
            winapi.C_POINTER.withName("phpage")
        ).withName("$anon$526:5"),
        winapi.C_POINTER.withName("pfnCallback"),
        MemoryLayout.unionLayout(
            winapi.C_POINTER.withName("hbmWatermark"),
            winapi.C_POINTER.withName("pszbmWatermark")
        ).withName("$anon$527:5"),
        winapi.C_POINTER.withName("hplWatermark"),
        MemoryLayout.unionLayout(
