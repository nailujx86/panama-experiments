...
public class _STORAGE_OPERATIONAL_REASON {
    ...
    public static class RawBytes {
        ...
        public static class ScsiSenseKey {
            ...
            private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
                winapi.C_CHAR.withName("SenseKey"),
                winapi.C_CHAR.withName("ASC"),
                winapi.C_CHAR.withName("ASCQ"),
                winapi.C_CHAR.withName("Reserved")
            ).withName("$anon$3146:9");
        ...
        public static class NVDIMM_N {
            ...
            private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
                winapi.C_CHAR.withName("CriticalHealth"),
                MemoryLayout.sequenceLayout(2, winapi.C_CHAR).withName("ModuleHealth"),
                winapi.C_CHAR.withName("ErrorThresholdStatus")
