...
public class _SE_ACCESS_REQUEST {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_POINTER.withName("SeSecurityDescriptor"),
        winapi.C_LONG.withName("DesiredAccess"),
        winapi.C_LONG.withName("PreviouslyGrantedAccess"),
        winapi.C_POINTER.withName("PrincipalSelfSid"),
        winapi.C_POINTER.withName("GenericMapping"),
        winapi.C_LONG.withName("ObjectTypeListCount"),
        MemoryLayout.paddingLayout(4),
        winapi.C_POINTER.withName("ObjectTypeList")
