...
public class tagMETAHEADER {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_SHORT.withName("mtType"),
        winapi.C_SHORT.withName("mtHeaderSize"),
        winapi.C_SHORT.withName("mtVersion"),
        winapi.align(winapi.C_LONG, 2).withName("mtSize"),
        winapi.C_SHORT.withName("mtNoObjects"),
        winapi.align(winapi.C_LONG, 2).withName("mtMaxRecord"),
        winapi.C_SHORT.withName("mtNoParameters")
