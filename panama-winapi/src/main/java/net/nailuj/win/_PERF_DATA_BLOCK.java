...
public class _PERF_DATA_BLOCK {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.sequenceLayout(4, winapi.C_SHORT).withName("Signature"),
        winapi.C_LONG.withName("LittleEndian"),
        ...
        winapi.C_LONG.withName("NumObjectTypes"),
        winapi.C_LONG.withName("DefaultObject"),
        ...
        winapi.C_LONG.withName("SystemNameLength"),
        winapi.C_LONG.withName("SystemNameOffset")
