...
public class IBindStatusCallbackExVtbl {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_POINTER.withName("OnStartBinding"),
        winapi.C_POINTER.withName("GetPriority"),
        winapi.C_POINTER.withName("OnLowResource"),
        winapi.C_POINTER.withName("OnProgress"),
        winapi.C_POINTER.withName("OnStopBinding"),
        winapi.C_POINTER.withName("GetBindInfo"),
        winapi.C_POINTER.withName("OnDataAvailable"),
        winapi.C_POINTER.withName("OnObjectAvailable"),
        winapi.C_POINTER.withName("GetBindInfoEx")
    ...
    public static class OnStartBinding {
        ...
        private static final MethodHandle UP$MH = winapi.upcallHandle(OnStartBinding.Function.class, "apply", $DESC);
    ...
    public static class GetPriority {
        ...
        private static final MethodHandle UP$MH = winapi.upcallHandle(GetPriority.Function.class, "apply", $DESC);
    ...
    public static class OnLowResource {
        ...
        private static final MethodHandle UP$MH = winapi.upcallHandle(OnLowResource.Function.class, "apply", $DESC);
    ...
    public static class OnProgress {
        ...
        private static final MethodHandle UP$MH = winapi.upcallHandle(OnProgress.Function.class, "apply", $DESC);
    ...
    public static class OnStopBinding {
        ...
        private static final MethodHandle UP$MH = winapi.upcallHandle(OnStopBinding.Function.class, "apply", $DESC);
    ...
    public static class GetBindInfo {
        ...
        private static final MethodHandle UP$MH = winapi.upcallHandle(GetBindInfo.Function.class, "apply", $DESC);
    ...
    public static class OnDataAvailable {
        ...
        private static final MethodHandle UP$MH = winapi.upcallHandle(OnDataAvailable.Function.class, "apply", $DESC);
    ...
    public static class OnObjectAvailable {
        ...
        private static final MethodHandle UP$MH = winapi.upcallHandle(OnObjectAvailable.Function.class, "apply", $DESC);
    ...
    public static class GetBindInfoEx {
        ...
        private static final MethodHandle UP$MH = winapi.upcallHandle(GetBindInfoEx.Function.class, "apply", $DESC);
