...
public class PrintPropertyValue {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_INT.withName("ePropertyType"),
        MemoryLayout.paddingLayout(4),
        PrintPropertyValue.value.layout().withName("value")
    ).withName("$anon$3730:13");
    ...
    public static class value {
        ...
        private static final GroupLayout $LAYOUT = MemoryLayout.unionLayout(
            winapi.C_CHAR.withName("propertyByte"),
            winapi.C_POINTER.withName("propertyString"),
            winapi.C_LONG.withName("propertyInt32"),
            winapi.C_LONG_LONG.withName("propertyInt64"),
            PrintPropertyValue.value.propertyBlob.layout().withName("propertyBlob")
        ).withName("$anon$3733:9");
        ...
        public static class propertyBlob {
            ...
            private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
                winapi.C_LONG.withName("cbBuf"),
                MemoryLayout.paddingLayout(4),
                winapi.C_POINTER.withName("pBuf")
            ).withName("$anon$3739:13");
