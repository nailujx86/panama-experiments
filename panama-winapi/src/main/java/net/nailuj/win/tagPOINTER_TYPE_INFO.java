...
public class tagPOINTER_TYPE_INFO {
    ...
    private static final GroupLayout touchInfo$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$6496:5"), groupElement("touchInfo"));
    ...
    private static final GroupLayout penInfo$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$6496:5"), groupElement("penInfo"));
