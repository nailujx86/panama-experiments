...
public class _SCM_REGION {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_LONG.withName("NfitHandle"),
        _GUID.layout().withName("LogicalDeviceGuid"),
        _GUID.layout().withName("AddressRangeType"),
        winapi.C_LONG.withName("AssociatedId"),
        MemoryLayout.paddingLayout(4),
        winapi.C_LONG_LONG.withName("Length"),
        winapi.C_LONG_LONG.withName("StartingDPA"),
        winapi.C_LONG_LONG.withName("BaseSPA"),
        winapi.C_LONG_LONG.withName("SPAOffset"),
        winapi.C_LONG_LONG.withName("RegionOffset")
