...
public class tagMSGBOXPARAMSA {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_POINTER.withName("lpszText"),
        winapi.C_POINTER.withName("lpszCaption"),
        winapi.C_LONG.withName("dwStyle"),
        MemoryLayout.paddingLayout(4),
        winapi.C_POINTER.withName("lpszIcon"),
        winapi.C_LONG_LONG.withName("dwContextHelpId"),
        winapi.C_POINTER.withName("lpfnMsgBoxCallback"),
        winapi.C_LONG.withName("dwLanguageId"),
        MemoryLayout.paddingLayout(4)
