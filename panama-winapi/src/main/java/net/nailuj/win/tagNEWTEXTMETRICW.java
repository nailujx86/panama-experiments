...
public class tagNEWTEXTMETRICW {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_SHORT.withName("tmFirstChar"),
        winapi.C_SHORT.withName("tmLastChar"),
        winapi.C_SHORT.withName("tmDefaultChar"),
        winapi.C_SHORT.withName("tmBreakChar"),
        ...
        winapi.C_LONG.withName("ntmFlags"),
        winapi.C_INT.withName("ntmSizeEM"),
        winapi.C_INT.withName("ntmCellHeight"),
        winapi.C_INT.withName("ntmAvgWidth")
