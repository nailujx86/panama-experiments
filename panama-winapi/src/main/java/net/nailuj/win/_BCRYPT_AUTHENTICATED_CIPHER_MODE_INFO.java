...
public class _BCRYPT_AUTHENTICATED_CIPHER_MODE_INFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_LONG.withName("dwInfoVersion"),
        winapi.C_POINTER.withName("pbNonce"),
        winapi.C_LONG.withName("cbNonce"),
        MemoryLayout.paddingLayout(4),
        winapi.C_POINTER.withName("pbAuthData"),
        winapi.C_LONG.withName("cbAuthData"),
        MemoryLayout.paddingLayout(4),
        winapi.C_POINTER.withName("pbTag"),
        winapi.C_LONG.withName("cbTag"),
        MemoryLayout.paddingLayout(4),
        winapi.C_POINTER.withName("pbMacContext"),
        winapi.C_LONG.withName("cbMacContext"),
        winapi.C_LONG.withName("cbAAD"),
        winapi.C_LONG_LONG.withName("cbData"),
