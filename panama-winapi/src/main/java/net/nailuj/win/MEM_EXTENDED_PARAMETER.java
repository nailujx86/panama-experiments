...
public class MEM_EXTENDED_PARAMETER {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        ).withName("$anon$14651:5"),
        MemoryLayout.unionLayout(
            winapi.C_LONG_LONG.withName("ULong64"),
            winapi.C_POINTER.withName("Pointer"),
            winapi.C_LONG_LONG.withName("Size"),
            winapi.C_POINTER.withName("Handle"),
            winapi.C_LONG.withName("ULong")
        ).withName("$anon$14656:5")
    ...
    private static final OfLong ULong64$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$14656:5"), groupElement("ULong64"));
    ...
    private static final AddressLayout Pointer$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$14656:5"), groupElement("Pointer"));
    ...
    private static final OfLong Size$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$14656:5"), groupElement("Size"));
    ...
    private static final AddressLayout Handle$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$14656:5"), groupElement("Handle"));
    ...
    private static final OfInt ULong$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$14656:5"), groupElement("ULong"));
