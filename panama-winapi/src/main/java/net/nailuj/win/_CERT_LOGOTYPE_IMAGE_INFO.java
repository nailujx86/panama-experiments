...
public class _CERT_LOGOTYPE_IMAGE_INFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_LONG.withName("dwLogotypeImageInfoChoice"),
        winapi.C_LONG.withName("dwFileSize"),
        winapi.C_LONG.withName("dwXSize"),
        winapi.C_LONG.withName("dwYSize"),
        winapi.C_LONG.withName("dwLogotypeImageResolutionChoice"),
        MemoryLayout.unionLayout(
            winapi.C_LONG.withName("dwNumBits"),
            winapi.C_LONG.withName("dwTableSize")
        ).withName("$anon$5499:5"),
        winapi.C_POINTER.withName("pwszLanguage")
    ...
    private static final OfInt dwNumBits$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$5499:5"), groupElement("dwNumBits"));
    ...
    private static final OfInt dwTableSize$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$5499:5"), groupElement("dwTableSize"));
