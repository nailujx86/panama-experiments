...
public class _cpinfoexW {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_INT.withName("MaxCharSize"),
        MemoryLayout.sequenceLayout(2, winapi.C_CHAR).withName("DefaultChar"),
        MemoryLayout.sequenceLayout(12, winapi.C_CHAR).withName("LeadByte"),
        winapi.C_SHORT.withName("UnicodeDefaultChar"),
        winapi.C_INT.withName("CodePage"),
        MemoryLayout.sequenceLayout(260, winapi.C_SHORT).withName("CodePageName")
    ).withName("_cpinfoexW");
