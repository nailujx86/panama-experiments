...
public class _DEVICE_LOCATION {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_LONG.withName("Socket"),
        winapi.C_LONG.withName("Slot"),
        winapi.C_LONG.withName("Adapter"),
        winapi.C_LONG.withName("Port"),
        MemoryLayout.unionLayout(
            MemoryLayout.structLayout(
                winapi.C_LONG.withName("Channel"),
                winapi.C_LONG.withName("Device")
            ).withName("$anon$3364:9"),
            MemoryLayout.structLayout(
                winapi.C_LONG.withName("Target"),
                winapi.C_LONG.withName("Lun")
            ).withName("$anon$3372:9")
        ).withName("$anon$3362:5")
    ...
    private static final OfInt Channel$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$3362:5"), groupElement("$anon$3364:9"), groupElement("Channel"));
    ...
    private static final OfInt Device$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$3362:5"), groupElement("$anon$3364:9"), groupElement("Device"));
    ...
    private static final OfInt Target$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$3362:5"), groupElement("$anon$3372:9"), groupElement("Target"));
    ...
    private static final OfInt Lun$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$3362:5"), groupElement("$anon$3372:9"), groupElement("Lun"));
