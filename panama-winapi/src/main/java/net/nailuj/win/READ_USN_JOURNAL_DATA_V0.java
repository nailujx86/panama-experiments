...
public class READ_USN_JOURNAL_DATA_V0 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_LONG_LONG.withName("StartUsn"),
        winapi.C_LONG.withName("ReasonMask"),
        winapi.C_LONG.withName("ReturnOnlyOnClose"),
        winapi.C_LONG_LONG.withName("Timeout"),
        winapi.C_LONG_LONG.withName("BytesToWaitFor"),
        winapi.C_LONG_LONG.withName("UsnJournalID")
    ).withName("$anon$11956:9");
