...
public class _SYSTEMTIME {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_SHORT.withName("wYear"),
        winapi.C_SHORT.withName("wMonth"),
        winapi.C_SHORT.withName("wDayOfWeek"),
        winapi.C_SHORT.withName("wDay"),
        winapi.C_SHORT.withName("wHour"),
        winapi.C_SHORT.withName("wMinute"),
        winapi.C_SHORT.withName("wSecond"),
        winapi.C_SHORT.withName("wMilliseconds")
