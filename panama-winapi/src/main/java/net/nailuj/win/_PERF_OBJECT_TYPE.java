...
public class _PERF_OBJECT_TYPE {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_LONG.withName("TotalByteLength"),
        winapi.C_LONG.withName("DefinitionLength"),
        winapi.C_LONG.withName("HeaderLength"),
        winapi.C_LONG.withName("ObjectNameTitleIndex"),
        winapi.C_LONG.withName("ObjectNameTitle"),
        winapi.C_LONG.withName("ObjectHelpTitleIndex"),
        winapi.C_LONG.withName("ObjectHelpTitle"),
        winapi.C_LONG.withName("DetailLevel"),
        winapi.C_LONG.withName("NumCounters"),
        winapi.C_LONG.withName("DefaultCounter"),
        winapi.C_LONG.withName("NumInstances"),
        winapi.C_LONG.withName("CodePage"),
