...
public class PROCESSOR_PERFSTATE_POLICY {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_CHAR.withName("MaxThrottle"),
        winapi.C_CHAR.withName("MinThrottle"),
        winapi.C_CHAR.withName("BusyAdjThreshold"),
        MemoryLayout.unionLayout(
            winapi.C_CHAR.withName("Spare"),
            PROCESSOR_PERFSTATE_POLICY.Flags.layout().withName("Flags")
        ).withName("$anon$19072:5"),
        winapi.C_LONG.withName("TimeCheck"),
        winapi.C_LONG.withName("IncreaseTime"),
        winapi.C_LONG.withName("DecreaseTime"),
        winapi.C_LONG.withName("IncreasePercent"),
        winapi.C_LONG.withName("DecreasePercent")
    ).withName("$anon$19067:9");
    ...
    private static final OfByte Spare$LAYOUT = (OfByte)$LAYOUT.select(groupElement("$anon$19072:5"), groupElement("Spare"));
    ...
    public static class Flags {
        ...
        private static final GroupLayout $LAYOUT = MemoryLayout.unionLayout(
            winapi.C_CHAR.withName("AsBYTE"),
            MemoryLayout.structLayout(
                MemoryLayout.paddingLayout(1)
            ).withName("$anon$19076:13")
        ).withName("$anon$19074:9");
    ...
    private static final GroupLayout Flags$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$19072:5"), groupElement("Flags"));
