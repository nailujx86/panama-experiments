...
public class WIN32_MEMORY_PARTITION_INFORMATION {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_LONG.withName("NumaNode"),
        winapi.C_LONG.withName("Channel"),
        winapi.C_LONG.withName("NumberOfNumaNodes"),
        winapi.C_LONG_LONG.withName("ResidentAvailablePages"),
        winapi.C_LONG_LONG.withName("CommittedPages"),
        winapi.C_LONG_LONG.withName("CommitLimit"),
        winapi.C_LONG_LONG.withName("PeakCommitment"),
        winapi.C_LONG_LONG.withName("TotalNumberOfPages"),
        winapi.C_LONG_LONG.withName("AvailablePages"),
        winapi.C_LONG_LONG.withName("ZeroPages"),
        winapi.C_LONG_LONG.withName("FreePages"),
        winapi.C_LONG_LONG.withName("StandbyPages"),
        MemoryLayout.sequenceLayout(16, winapi.C_LONG_LONG).withName("Reserved"),
        winapi.C_LONG_LONG.withName("MaximumCommitLimit"),
        winapi.C_LONG_LONG.withName("Reserved2"),
        winapi.C_LONG.withName("PartitionId"),
