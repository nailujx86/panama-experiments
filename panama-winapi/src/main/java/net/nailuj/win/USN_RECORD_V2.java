...
public class USN_RECORD_V2 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_LONG.withName("RecordLength"),
        winapi.C_SHORT.withName("MajorVersion"),
        winapi.C_SHORT.withName("MinorVersion"),
        winapi.C_LONG_LONG.withName("FileReferenceNumber"),
        winapi.C_LONG_LONG.withName("ParentFileReferenceNumber"),
