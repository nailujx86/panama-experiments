...
public class _DEVICE_DATA_SET_SCRUB_EX_OUTPUT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_LONG_LONG.withName("BytesProcessed"),
        winapi.C_LONG_LONG.withName("BytesRepaired"),
        winapi.C_LONG_LONG.withName("BytesFailed"),
        _DEVICE_DATA_SET_RANGE.layout().withName("ParityExtent"),
        winapi.C_LONG_LONG.withName("BytesScrubbed")
