...
public class _IMAGE_IMPORT_DESCRIPTOR {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.unionLayout(
            ...
            winapi.C_LONG.withName("OriginalFirstThunk")
        ).withName("$anon$20687:5"),
        winapi.C_LONG.withName("TimeDateStamp"),
        winapi.C_LONG.withName("ForwarderChain"),
        winapi.C_LONG.withName("Name"),
        winapi.C_LONG.withName("FirstThunk")
    ...
    private static final OfInt Characteristics$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$20687:5"), groupElement("Characteristics"));
    ...
    private static final OfInt OriginalFirstThunk$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$20687:5"), groupElement("OriginalFirstThunk"));
