...
public class _BCRYPT_ECCFULLKEY_BLOB {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_INT.withName("dwCurveType"),
        winapi.C_INT.withName("dwCurveGenerationAlgId"),
        winapi.C_LONG.withName("cbFieldLength"),
        winapi.C_LONG.withName("cbSubgroupOrder"),
        winapi.C_LONG.withName("cbCofactor"),
        winapi.C_LONG.withName("cbSeed")
