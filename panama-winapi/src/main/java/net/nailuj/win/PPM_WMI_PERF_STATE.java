...
public class PPM_WMI_PERF_STATE {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_LONG.withName("Frequency"),
        winapi.C_LONG.withName("Power"),
        winapi.C_CHAR.withName("PercentFrequency"),
        winapi.C_CHAR.withName("IncreaseLevel"),
        winapi.C_CHAR.withName("DecreaseLevel"),
        winapi.C_CHAR.withName("Type"),
        winapi.C_LONG.withName("IncreaseTime"),
        winapi.C_LONG.withName("DecreaseTime"),
        MemoryLayout.paddingLayout(4),
        winapi.C_LONG_LONG.withName("Control"),
        winapi.C_LONG_LONG.withName("Status"),
        winapi.C_LONG.withName("HitCount"),
        winapi.C_LONG.withName("Reserved1"),
        winapi.C_LONG_LONG.withName("Reserved2"),
        winapi.C_LONG_LONG.withName("Reserved3")
    ).withName("$anon$18612:9");
