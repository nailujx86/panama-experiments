...
public class _IMAGE_TLS_DIRECTORY64 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.align(winapi.C_LONG_LONG, 4).withName("StartAddressOfRawData"),
        winapi.align(winapi.C_LONG_LONG, 4).withName("EndAddressOfRawData"),
        winapi.align(winapi.C_LONG_LONG, 4).withName("AddressOfIndex"),
        winapi.align(winapi.C_LONG_LONG, 4).withName("AddressOfCallBacks"),
        winapi.C_LONG.withName("SizeOfZeroFill"),
        MemoryLayout.unionLayout(
            winapi.C_LONG.withName("Characteristics"),
            MemoryLayout.structLayout(
                MemoryLayout.paddingLayout(4)
            ).withName("$anon$20638:9")
        ).withName("$anon$20636:5")
    ...
    private static final OfInt Characteristics$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$20636:5"), groupElement("Characteristics"));
