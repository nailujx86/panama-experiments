...
public class _CRYPT_3DES_KEY_STATE {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.sequenceLayout(24, winapi.C_CHAR).withName("Key"),
        MemoryLayout.sequenceLayout(8, winapi.C_CHAR).withName("IV"),
        MemoryLayout.sequenceLayout(8, winapi.C_CHAR).withName("Feedback")
