...
public class _JOB_INFO_4A {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_LONG.withName("JobId"),
        MemoryLayout.paddingLayout(4),
        winapi.C_POINTER.withName("pPrinterName"),
        winapi.C_POINTER.withName("pMachineName"),
        winapi.C_POINTER.withName("pUserName"),
        winapi.C_POINTER.withName("pDocument"),
        winapi.C_POINTER.withName("pNotifyName"),
        winapi.C_POINTER.withName("pDatatype"),
        winapi.C_POINTER.withName("pPrintProcessor"),
        winapi.C_POINTER.withName("pParameters"),
        winapi.C_POINTER.withName("pDriverName"),
        winapi.C_POINTER.withName("pDevMode"),
        winapi.C_POINTER.withName("pStatus"),
        winapi.C_POINTER.withName("pSecurityDescriptor"),
        winapi.C_LONG.withName("Status"),
        winapi.C_LONG.withName("Priority"),
        winapi.C_LONG.withName("Position"),
        winapi.C_LONG.withName("StartTime"),
        winapi.C_LONG.withName("UntilTime"),
        winapi.C_LONG.withName("TotalPages"),
        winapi.C_LONG.withName("Size"),
        _SYSTEMTIME.layout().withName("Submitted"),
        winapi.C_LONG.withName("Time"),
        winapi.C_LONG.withName("PagesPrinted"),
        winapi.C_LONG.withName("SizeHigh")
