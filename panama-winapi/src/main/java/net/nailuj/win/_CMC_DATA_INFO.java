...
public class _CMC_DATA_INFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_LONG.withName("cTaggedAttribute"),
        MemoryLayout.paddingLayout(4),
        winapi.C_POINTER.withName("rgTaggedAttribute"),
        winapi.C_LONG.withName("cTaggedRequest"),
        MemoryLayout.paddingLayout(4),
        winapi.C_POINTER.withName("rgTaggedRequest"),
        winapi.C_LONG.withName("cTaggedContentInfo"),
        MemoryLayout.paddingLayout(4),
        winapi.C_POINTER.withName("rgTaggedContentInfo"),
        winapi.C_LONG.withName("cTaggedOtherMsg"),
        MemoryLayout.paddingLayout(4),
        winapi.C_POINTER.withName("rgTaggedOtherMsg")
