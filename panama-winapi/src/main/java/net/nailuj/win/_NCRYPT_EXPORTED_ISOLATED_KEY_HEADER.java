...
public class _NCRYPT_EXPORTED_ISOLATED_KEY_HEADER {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_LONG.withName("KeyUsage"),
        MemoryLayout.paddingLayout(4),
        winapi.C_LONG.withName("cbAlgName"),
        winapi.C_LONG.withName("cbNonce"),
        winapi.C_LONG.withName("cbAuthTag"),
        winapi.C_LONG.withName("cbWrappingKey"),
        winapi.C_LONG.withName("cbIsolatedKey")
