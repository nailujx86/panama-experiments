...
public class _IMAGE_EPILOGUE_DYNAMIC_RELOCATION_HEADER {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.align(winapi.C_LONG, 1).withName("EpilogueCount"),
        winapi.C_CHAR.withName("EpilogueByteCount"),
        winapi.C_CHAR.withName("BranchDescriptorElementSize"),
        winapi.align(winapi.C_SHORT, 1).withName("BranchDescriptorCount")
