...
public class _IMAGE_OPTIONAL_HEADER64 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_SHORT.withName("Magic"),
        winapi.C_CHAR.withName("MajorLinkerVersion"),
        winapi.C_CHAR.withName("MinorLinkerVersion"),
        winapi.C_LONG.withName("SizeOfCode"),
        winapi.C_LONG.withName("SizeOfInitializedData"),
        winapi.C_LONG.withName("SizeOfUninitializedData"),
        winapi.C_LONG.withName("AddressOfEntryPoint"),
        winapi.C_LONG.withName("BaseOfCode"),
        winapi.align(winapi.C_LONG_LONG, 4).withName("ImageBase"),
        winapi.C_LONG.withName("SectionAlignment"),
        winapi.C_LONG.withName("FileAlignment"),
        winapi.C_SHORT.withName("MajorOperatingSystemVersion"),
        winapi.C_SHORT.withName("MinorOperatingSystemVersion"),
        winapi.C_SHORT.withName("MajorImageVersion"),
        winapi.C_SHORT.withName("MinorImageVersion"),
        winapi.C_SHORT.withName("MajorSubsystemVersion"),
        winapi.C_SHORT.withName("MinorSubsystemVersion"),
        winapi.C_LONG.withName("Win32VersionValue"),
        winapi.C_LONG.withName("SizeOfImage"),
        winapi.C_LONG.withName("SizeOfHeaders"),
        winapi.C_LONG.withName("CheckSum"),
        winapi.C_SHORT.withName("Subsystem"),
        winapi.C_SHORT.withName("DllCharacteristics"),
        winapi.align(winapi.C_LONG_LONG, 4).withName("SizeOfStackReserve"),
        winapi.align(winapi.C_LONG_LONG, 4).withName("SizeOfStackCommit"),
        winapi.align(winapi.C_LONG_LONG, 4).withName("SizeOfHeapReserve"),
        winapi.align(winapi.C_LONG_LONG, 4).withName("SizeOfHeapCommit"),
        winapi.C_LONG.withName("LoaderFlags"),
        winapi.C_LONG.withName("NumberOfRvaAndSizes"),
