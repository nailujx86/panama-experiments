...
public class _PRINTER_INFO_2A {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_POINTER.withName("pServerName"),
        winapi.C_POINTER.withName("pPrinterName"),
        winapi.C_POINTER.withName("pShareName"),
        winapi.C_POINTER.withName("pPortName"),
        winapi.C_POINTER.withName("pDriverName"),
        winapi.C_POINTER.withName("pComment"),
        winapi.C_POINTER.withName("pLocation"),
        winapi.C_POINTER.withName("pDevMode"),
        winapi.C_POINTER.withName("pSepFile"),
        ...
        winapi.C_LONG.withName("Attributes"),
        winapi.C_LONG.withName("Priority"),
        winapi.C_LONG.withName("DefaultPriority"),
        winapi.C_LONG.withName("StartTime"),
        winapi.C_LONG.withName("UntilTime"),
        winapi.C_LONG.withName("Status"),
        winapi.C_LONG.withName("cJobs"),
        winapi.C_LONG.withName("AveragePPM")
