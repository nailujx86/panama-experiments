...
public class _CMSG_KEY_AGREE_RECIPIENT_INFO {
    ...
    private static final GroupLayout OriginatorCertId$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$7842:5"), groupElement("OriginatorCertId"));
    ...
    private static final GroupLayout OriginatorPublicKeyInfo$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$7842:5"), groupElement("OriginatorPublicKeyInfo"));
