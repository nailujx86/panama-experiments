...
public class _SCRUB_DATA_OUTPUT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_LONG.withName("Status"),
        MemoryLayout.paddingLayout(4),
        winapi.C_LONG_LONG.withName("ErrorFileOffset"),
        winapi.C_LONG_LONG.withName("ErrorLength"),
        winapi.C_LONG_LONG.withName("NumberOfBytesRepaired"),
        winapi.C_LONG_LONG.withName("NumberOfBytesFailed"),
        winapi.C_LONG_LONG.withName("InternalFileReference"),
        winapi.C_SHORT.withName("ResumeContextLength"),
        winapi.C_SHORT.withName("ParityExtentDataOffset"),
        MemoryLayout.paddingLayout(4),
        winapi.C_LONG_LONG.withName("NextStartingByteOffset"),
        winapi.C_LONG_LONG.withName("ValidDataLength"),
        MemoryLayout.sequenceLayout(4, winapi.C_LONG).withName("Reserved"),
        winapi.C_LONG_LONG.withName("NumberOfMetadataBytesProcessed"),
        winapi.C_LONG_LONG.withName("NumberOfDataBytesProcessed"),
        winapi.C_LONG_LONG.withName("TotalNumberOfMetadataBytesInUse"),
        winapi.C_LONG_LONG.withName("TotalNumberOfDataBytesInUse"),
        winapi.C_LONG_LONG.withName("DataBytesSkippedDueToNoAllocation"),
        winapi.C_LONG_LONG.withName("DataBytesSkippedDueToInvalidRun"),
        winapi.C_LONG_LONG.withName("DataBytesSkippedDueToIntegrityStream"),
        winapi.C_LONG_LONG.withName("DataBytesSkippedDueToRegionBeingClean"),
        winapi.C_LONG_LONG.withName("DataBytesSkippedDueToLockConflict"),
        winapi.C_LONG_LONG.withName("DataBytesSkippedDueToNoScrubDataFlag"),
        winapi.C_LONG_LONG.withName("DataBytesSkippedDueToNoScrubNonIntegrityStreamFlag"),
        winapi.C_LONG_LONG.withName("DataBytesScrubbed"),
        MemoryLayout.sequenceLayout(1040, winapi.C_CHAR).withName("ResumeContext")
    ...
    private static final long NextStartingByteOffset$OFFSET = 64;
    ...
    private static final long ValidDataLength$OFFSET = 72;
