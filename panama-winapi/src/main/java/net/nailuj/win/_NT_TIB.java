...
public class _NT_TIB {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_POINTER.withName("ExceptionList"),
        winapi.C_POINTER.withName("StackBase"),
        winapi.C_POINTER.withName("StackLimit"),
        winapi.C_POINTER.withName("SubSystemTib"),
        MemoryLayout.unionLayout(
            winapi.C_POINTER.withName("FiberData"),
            winapi.C_LONG.withName("Version")
        ).withName("$anon$12757:5"),
        winapi.C_POINTER.withName("ArbitraryUserPointer"),
        winapi.C_POINTER.withName("Self")
    ).withName("_NT_TIB");
    ...
    private static final AddressLayout FiberData$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$12757:5"), groupElement("FiberData"));
    ...
    private static final OfInt Version$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$12757:5"), groupElement("Version"));
