...
public class _CRYPTNET_URL_CACHE_RESPONSE_INFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_SHORT.withName("wResponseType"),
        winapi.C_SHORT.withName("wResponseFlags"),
        _FILETIME.layout().withName("LastModifiedTime"),
        winapi.C_LONG.withName("dwMaxAge"),
        MemoryLayout.paddingLayout(4),
        winapi.C_POINTER.withName("pwszETag"),
        winapi.C_LONG.withName("dwProxyId"),
        MemoryLayout.paddingLayout(4)
