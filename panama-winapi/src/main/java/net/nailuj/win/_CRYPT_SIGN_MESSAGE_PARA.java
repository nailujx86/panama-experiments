...
public class _CRYPT_SIGN_MESSAGE_PARA {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_POINTER.withName("pSigningCert"),
        _CRYPT_ALGORITHM_IDENTIFIER.layout().withName("HashAlgorithm"),
        winapi.C_POINTER.withName("pvHashAuxInfo"),
        winapi.C_LONG.withName("cMsgCert"),
        MemoryLayout.paddingLayout(4),
        winapi.C_POINTER.withName("rgpMsgCert"),
        winapi.C_LONG.withName("cMsgCrl"),
        MemoryLayout.paddingLayout(4),
        winapi.C_POINTER.withName("rgpMsgCrl"),
        ...
        winapi.C_LONG.withName("dwInnerContentType")
