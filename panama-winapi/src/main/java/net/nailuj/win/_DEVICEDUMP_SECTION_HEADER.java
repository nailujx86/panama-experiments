...
public class _DEVICEDUMP_SECTION_HEADER {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.align(_GUID.layout(), 1).withName("guidDeviceDataId"),
        MemoryLayout.sequenceLayout(16, winapi.C_CHAR).withName("sOrganizationID"),
        winapi.align(winapi.C_LONG, 1).withName("dwFirmwareRevision"),
        MemoryLayout.sequenceLayout(32, winapi.C_CHAR).withName("sModelNumber"),
        MemoryLayout.sequenceLayout(32, winapi.C_CHAR).withName("szDeviceManufacturingID"),
        winapi.align(winapi.C_LONG, 1).withName("dwFlags"),
        winapi.align(winapi.C_LONG, 1).withName("bRestrictedPrivateDataVersion"),
        winapi.align(winapi.C_LONG, 1).withName("dwFirmwareIssueId"),
        MemoryLayout.sequenceLayout(132, winapi.C_CHAR).withName("szIssueDescriptionString")
