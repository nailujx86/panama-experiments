...
public class _IMAGE_THUNK_DATA32 {
    ...
    public static class u1 {
        ...
        private static final GroupLayout $LAYOUT = MemoryLayout.unionLayout(
            winapi.C_LONG.withName("ForwarderString"),
            winapi.C_LONG.withName("Function"),
            winapi.C_LONG.withName("Ordinal"),
            winapi.C_LONG.withName("AddressOfData")
        ).withName("$anon$20603:5");
