...
public class _CERT_CHAIN_ELEMENT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_POINTER.withName("pCertContext"),
        _CERT_TRUST_STATUS.layout().withName("TrustStatus"),
        winapi.C_POINTER.withName("pRevocationInfo"),
        winapi.C_POINTER.withName("pIssuanceUsage"),
        winapi.C_POINTER.withName("pApplicationUsage"),
        winapi.C_POINTER.withName("pwszExtendedErrorInfo")
