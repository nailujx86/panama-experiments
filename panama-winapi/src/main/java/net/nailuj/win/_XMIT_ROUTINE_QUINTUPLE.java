...
public class _XMIT_ROUTINE_QUINTUPLE {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_POINTER.withName("pfnTranslateToXmit"),
        winapi.C_POINTER.withName("pfnTranslateFromXmit"),
        winapi.C_POINTER.withName("pfnFreeXmit"),
        winapi.C_POINTER.withName("pfnFreeInst")
