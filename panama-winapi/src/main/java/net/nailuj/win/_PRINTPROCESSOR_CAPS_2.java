...
public class _PRINTPROCESSOR_CAPS_2 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_LONG.withName("dwLevel"),
        winapi.C_LONG.withName("dwNupOptions"),
        winapi.C_LONG.withName("dwPageOrderFlags"),
        winapi.C_LONG.withName("dwNumberOfCopies"),
        winapi.C_LONG.withName("dwDuplexHandlingCaps"),
        winapi.C_LONG.withName("dwNupDirectionCaps"),
        winapi.C_LONG.withName("dwNupBorderCaps"),
        winapi.C_LONG.withName("dwBookletHandlingCaps"),
        winapi.C_LONG.withName("dwScalingCaps")
