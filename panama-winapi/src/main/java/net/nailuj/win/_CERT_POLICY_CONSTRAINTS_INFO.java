...
public class _CERT_POLICY_CONSTRAINTS_INFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_INT.withName("fRequireExplicitPolicy"),
        winapi.C_LONG.withName("dwRequireExplicitPolicySkipCerts"),
        winapi.C_INT.withName("fInhibitPolicyMapping"),
        winapi.C_LONG.withName("dwInhibitPolicyMappingSkipCerts")
