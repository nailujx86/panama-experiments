...
public class tagCOMPAREITEMSTRUCT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_INT.withName("CtlType"),
        winapi.C_INT.withName("CtlID"),
        winapi.C_POINTER.withName("hwndItem"),
        winapi.C_INT.withName("itemID1"),
        MemoryLayout.paddingLayout(4),
        winapi.C_LONG_LONG.withName("itemData1"),
        winapi.C_INT.withName("itemID2"),
        MemoryLayout.paddingLayout(4),
        winapi.C_LONG_LONG.withName("itemData2"),
        winapi.C_LONG.withName("dwLocaleId"),
        MemoryLayout.paddingLayout(4)
