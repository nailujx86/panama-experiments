...
public class NUMPARSE {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_INT.withName("cDig"),
        winapi.C_LONG.withName("dwInFlags"),
        winapi.C_LONG.withName("dwOutFlags"),
        winapi.C_INT.withName("cchUsed"),
        winapi.C_INT.withName("nBaseShift"),
        winapi.C_INT.withName("nPwr10")
    ).withName("$anon$735:9");
