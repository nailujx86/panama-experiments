...
public class tagTOUCHINPUT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_LONG.withName("x"),
        winapi.C_LONG.withName("y"),
        winapi.C_POINTER.withName("hSource"),
        winapi.C_LONG.withName("dwID"),
        winapi.C_LONG.withName("dwFlags"),
        winapi.C_LONG.withName("dwMask"),
        winapi.C_LONG.withName("dwTime"),
        winapi.C_LONG_LONG.withName("dwExtraInfo"),
        winapi.C_LONG.withName("cxContact"),
        winapi.C_LONG.withName("cyContact")
