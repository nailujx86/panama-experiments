...
public class _HTTPSPolicyCallbackData {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.unionLayout(
            winapi.C_LONG.withName("cbStruct"),
            winapi.C_LONG.withName("cbSize")
        ).withName("$anon$20280:5"),
        winapi.C_LONG.withName("dwAuthType"),
        winapi.C_LONG.withName("fdwChecks"),
        MemoryLayout.paddingLayout(4),
        winapi.C_POINTER.withName("pwszServerName")
    ...
    private static final OfInt cbStruct$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$20280:5"), groupElement("cbStruct"));
    ...
    private static final OfInt cbSize$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$20280:5"), groupElement("cbSize"));
