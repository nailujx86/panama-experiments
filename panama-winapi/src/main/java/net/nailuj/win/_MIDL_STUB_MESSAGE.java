...
public class _MIDL_STUB_MESSAGE {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_POINTER.withName("RpcMsg"),
        winapi.C_POINTER.withName("Buffer"),
        winapi.C_POINTER.withName("BufferStart"),
        winapi.C_POINTER.withName("BufferEnd"),
        winapi.C_POINTER.withName("BufferMark"),
        winapi.C_LONG.withName("BufferLength"),
        winapi.C_LONG.withName("MemorySize"),
        winapi.C_POINTER.withName("Memory"),
        winapi.C_CHAR.withName("IsClient"),
        winapi.C_CHAR.withName("Pad"),
        winapi.C_SHORT.withName("uFlags2"),
        winapi.C_INT.withName("ReuseBuffer"),
        winapi.C_POINTER.withName("pAllocAllNodesContext"),
        winapi.C_POINTER.withName("pPointerQueueState"),
        winapi.C_INT.withName("IgnoreEmbeddedPointers"),
        MemoryLayout.paddingLayout(4),
        winapi.C_POINTER.withName("PointerBufferMark"),
        winapi.C_CHAR.withName("CorrDespIncrement"),
        winapi.C_CHAR.withName("uFlags"),
        winapi.C_SHORT.withName("UniquePtrCount"),
        MemoryLayout.paddingLayout(4),
        winapi.C_LONG_LONG.withName("MaxCount"),
        winapi.C_LONG.withName("Offset"),
        winapi.C_LONG.withName("ActualCount"),
        winapi.C_POINTER.withName("pfnAllocate"),
        winapi.C_POINTER.withName("pfnFree"),
        winapi.C_POINTER.withName("StackTop"),
        winapi.C_POINTER.withName("pPresentedType"),
        winapi.C_POINTER.withName("pTransmitType"),
        winapi.C_POINTER.withName("SavedHandle"),
        winapi.C_POINTER.withName("StubDesc"),
        winapi.C_POINTER.withName("FullPtrXlatTables"),
        winapi.C_LONG.withName("FullPtrRefId"),
        winapi.C_LONG.withName("PointerLength"),
        MemoryLayout.paddingLayout(4),
        winapi.C_LONG.withName("dwDestContext"),
        winapi.C_POINTER.withName("pvDestContext"),
        winapi.C_POINTER.withName("SavedContextHandles"),
        winapi.C_LONG.withName("ParamNumber"),
        MemoryLayout.paddingLayout(4),
        winapi.C_POINTER.withName("pRpcChannelBuffer"),
        winapi.C_POINTER.withName("pArrayInfo"),
        winapi.C_POINTER.withName("SizePtrCountArray"),
        winapi.C_POINTER.withName("SizePtrOffsetArray"),
        winapi.C_POINTER.withName("SizePtrLengthArray"),
        winapi.C_POINTER.withName("pArgQueue"),
        winapi.C_LONG.withName("dwStubPhase"),
        MemoryLayout.paddingLayout(4),
        winapi.C_POINTER.withName("LowStackMark"),
        winapi.C_POINTER.withName("pAsyncMsg"),
        winapi.C_POINTER.withName("pCorrInfo"),
        winapi.C_POINTER.withName("pCorrMemory"),
        winapi.C_POINTER.withName("pMemoryList"),
        winapi.C_LONG_LONG.withName("pCSInfo"),
        winapi.C_POINTER.withName("ConformanceMark"),
        winapi.C_POINTER.withName("VarianceMark"),
        winapi.C_LONG_LONG.withName("Unused"),
        winapi.C_POINTER.withName("pContext"),
        winapi.C_POINTER.withName("ContextHandleHash"),
        winapi.C_POINTER.withName("pUserMarshalList"),
        winapi.C_POINTER.withName("pFullPtrFormat"),
        winapi.C_LONG_LONG.withName("Reserved51_4"),
        winapi.C_LONG_LONG.withName("Reserved51_5")
    ...
    public static class pfnAllocate {
        ...
        private static final MethodHandle UP$MH = winapi.upcallHandle(pfnAllocate.Function.class, "apply", $DESC);
    ...
    public static class pfnFree {
        ...
        private static final MethodHandle UP$MH = winapi.upcallHandle(pfnFree.Function.class, "apply", $DESC);
    ...
    private static final long pFullPtrFormat$OFFSET = 376;
