...
public class _FILESYSTEM_STATISTICS_EX {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_SHORT.withName("FileSystemType"),
        winapi.C_SHORT.withName("Version"),
        winapi.C_LONG.withName("SizeOfCompleteStructure"),
        winapi.C_LONG_LONG.withName("UserFileReads"),
        winapi.C_LONG_LONG.withName("UserFileReadBytes"),
        winapi.C_LONG_LONG.withName("UserDiskReads"),
        winapi.C_LONG_LONG.withName("UserFileWrites"),
        winapi.C_LONG_LONG.withName("UserFileWriteBytes"),
        winapi.C_LONG_LONG.withName("UserDiskWrites"),
        winapi.C_LONG_LONG.withName("MetaDataReads"),
        winapi.C_LONG_LONG.withName("MetaDataReadBytes"),
        winapi.C_LONG_LONG.withName("MetaDataDiskReads"),
        winapi.C_LONG_LONG.withName("MetaDataWrites"),
        winapi.C_LONG_LONG.withName("MetaDataWriteBytes"),
        winapi.C_LONG_LONG.withName("MetaDataDiskWrites")
