...
public class _IMAGE_ENCLAVE_IMPORT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_LONG.withName("MatchType"),
        winapi.C_LONG.withName("MinimumSecurityVersion"),
        MemoryLayout.sequenceLayout(32, winapi.C_CHAR).withName("UniqueOrAuthorID"),
        ...
        winapi.C_LONG.withName("ImportName"),
