...
public class mmtime_tag {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.align(winapi.C_INT, 1).withName("wType"),
    ...
    public static class u {
        ...
        private static final GroupLayout $LAYOUT = MemoryLayout.unionLayout(
            winapi.align(winapi.C_LONG, 1).withName("ms"),
            winapi.align(winapi.C_LONG, 1).withName("sample"),
            winapi.align(winapi.C_LONG, 1).withName("cb"),
            winapi.align(winapi.C_LONG, 1).withName("ticks"),
        ...
        public static class smpte {
            ...
            private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
                winapi.C_CHAR.withName("hour"),
                winapi.C_CHAR.withName("min"),
                winapi.C_CHAR.withName("sec"),
                winapi.C_CHAR.withName("frame"),
                winapi.C_CHAR.withName("fps"),
                winapi.C_CHAR.withName("dummy"),
                MemoryLayout.sequenceLayout(2, winapi.C_CHAR).withName("pad")
            ).withName("$anon$118:9");
        ...
        public static class midi {
            ...
            private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
                winapi.align(winapi.C_LONG, 1).withName("songptrpos")
            ).withName("$anon$132:9");
