...
public class _CSV_QUERY_MDS_PATH_V2 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_LONG_LONG.withName("Version"),
        winapi.C_LONG.withName("RequiredSize"),
        winapi.C_LONG.withName("MdsNodeId"),
        winapi.C_LONG.withName("DsNodeId"),
        winapi.C_LONG.withName("Flags"),
        winapi.C_INT.withName("DiskConnectivity"),
        _GUID.layout().withName("VolumeId"),
        winapi.C_LONG.withName("IpAddressOffset"),
        winapi.C_LONG.withName("IpAddressLength"),
        winapi.C_LONG.withName("PathOffset"),
        winapi.C_LONG.withName("PathLength"),
