...
public class _CHANGER_PRODUCT_DATA {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.sequenceLayout(8, winapi.C_CHAR).withName("VendorId"),
        MemoryLayout.sequenceLayout(16, winapi.C_CHAR).withName("ProductId"),
        MemoryLayout.sequenceLayout(4, winapi.C_CHAR).withName("Revision"),
