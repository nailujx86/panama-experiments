...
public class PPM_WMI_IDLE_STATE {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_LONG.withName("Latency"),
        winapi.C_LONG.withName("Power"),
        winapi.C_LONG.withName("TimeCheck"),
        winapi.C_CHAR.withName("PromotePercent"),
        winapi.C_CHAR.withName("DemotePercent"),
        winapi.C_CHAR.withName("StateType"),
        winapi.C_CHAR.withName("Reserved"),
        winapi.C_LONG.withName("StateFlags"),
        winapi.C_LONG.withName("Context"),
        winapi.C_LONG.withName("IdleHandler"),
        winapi.C_LONG.withName("Reserved1")
    ).withName("$anon$18580:9");
