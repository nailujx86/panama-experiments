...
public class _RPC_MESSAGE {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_LONG.withName("DataRepresentation"),
        MemoryLayout.paddingLayout(4),
        winapi.C_POINTER.withName("Buffer"),
        winapi.C_INT.withName("BufferLength"),
        winapi.C_INT.withName("ProcNum"),
        winapi.C_POINTER.withName("TransferSyntax"),
        winapi.C_POINTER.withName("RpcInterfaceInformation"),
        winapi.C_POINTER.withName("ReservedForRuntime"),
        winapi.C_POINTER.withName("ManagerEpv"),
        winapi.C_POINTER.withName("ImportContext"),
        winapi.C_LONG.withName("RpcFlags"),
        MemoryLayout.paddingLayout(4)
