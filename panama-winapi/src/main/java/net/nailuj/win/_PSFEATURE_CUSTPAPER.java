...
public class _PSFEATURE_CUSTPAPER {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_LONG.withName("lOrientation"),
        winapi.C_LONG.withName("lWidth"),
        winapi.C_LONG.withName("lHeight"),
        winapi.C_LONG.withName("lWidthOffset"),
        winapi.C_LONG.withName("lHeightOffset")
