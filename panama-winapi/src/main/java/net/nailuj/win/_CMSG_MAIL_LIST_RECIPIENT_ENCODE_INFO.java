...
public class _CMSG_MAIL_LIST_RECIPIENT_ENCODE_INFO {
    ...
    private static final OfLong hKeyEncryptionKey$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$7034:5"), groupElement("hKeyEncryptionKey"));
    ...
    private static final AddressLayout pvKeyEncryptionKey$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$7034:5"), groupElement("pvKeyEncryptionKey"));
