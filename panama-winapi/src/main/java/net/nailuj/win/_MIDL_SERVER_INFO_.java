...
public class _MIDL_SERVER_INFO_ {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_POINTER.withName("pStubDesc"),
        winapi.C_POINTER.withName("DispatchTable"),
        winapi.C_POINTER.withName("ProcString"),
        winapi.C_POINTER.withName("FmtStringOffset"),
        winapi.C_POINTER.withName("ThunkTable"),
        winapi.C_POINTER.withName("pTransferSyntax"),
        winapi.C_LONG_LONG.withName("nCount"),
        winapi.C_POINTER.withName("pSyntaxInfo")
