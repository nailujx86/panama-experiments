...
public class _TOKEN_GROUPS_AND_PRIVILEGES {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_LONG.withName("SidCount"),
        winapi.C_LONG.withName("SidLength"),
        winapi.C_POINTER.withName("Sids"),
        winapi.C_LONG.withName("RestrictedSidCount"),
        winapi.C_LONG.withName("RestrictedSidLength"),
        winapi.C_POINTER.withName("RestrictedSids"),
        winapi.C_LONG.withName("PrivilegeCount"),
        winapi.C_LONG.withName("PrivilegeLength"),
        winapi.C_POINTER.withName("Privileges"),
