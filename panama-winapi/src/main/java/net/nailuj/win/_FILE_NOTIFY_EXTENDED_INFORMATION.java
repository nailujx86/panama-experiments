...
public class _FILE_NOTIFY_EXTENDED_INFORMATION {
    ...
    private static final OfInt ReparsePointTag$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$15010:5"), groupElement("ReparsePointTag"));
    ...
    private static final OfInt EaSize$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$15010:5"), groupElement("EaSize"));
