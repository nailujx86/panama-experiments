...
public class _IMAGE_ARM64_RUNTIME_FUNCTION_ENTRY {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.unionLayout(
            ...
            ).withName("$anon$21325:9")
        ).withName("$anon$21323:5")
    ...
    private static final OfInt UnwindData$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$21323:5"), groupElement("UnwindData"));
