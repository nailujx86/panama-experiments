...
public class tagTYPEATTR {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_LONG.withName("lcid"),
        winapi.C_LONG.withName("dwReserved"),
        winapi.C_LONG.withName("memidConstructor"),
        winapi.C_LONG.withName("memidDestructor"),
        winapi.C_POINTER.withName("lpstrSchema"),
        winapi.C_LONG.withName("cbSizeInstance"),
        winapi.C_INT.withName("typekind"),
        winapi.C_SHORT.withName("cFuncs"),
        winapi.C_SHORT.withName("cVars"),
        winapi.C_SHORT.withName("cImplTypes"),
        winapi.C_SHORT.withName("cbSizeVft"),
        winapi.C_SHORT.withName("cbAlignment"),
        winapi.C_SHORT.withName("wTypeFlags"),
        winapi.C_SHORT.withName("wMajorVerNum"),
        winapi.C_SHORT.withName("wMinorVerNum"),
