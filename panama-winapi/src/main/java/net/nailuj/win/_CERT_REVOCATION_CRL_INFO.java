...
public class _CERT_REVOCATION_CRL_INFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_POINTER.withName("pBaseCrlContext"),
        winapi.C_POINTER.withName("pDeltaCrlContext"),
        winapi.C_POINTER.withName("pCrlEntry"),
        winapi.C_INT.withName("fDeltaCrlEntry"),
        MemoryLayout.paddingLayout(4)
