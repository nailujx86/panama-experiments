...
public class _RPC_SECURITY_QOS_V5_W {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_LONG.withName("IdentityTracking"),
        winapi.C_LONG.withName("ImpersonationType"),
        winapi.C_LONG.withName("AdditionalSecurityInfoType"),
        MemoryLayout.paddingLayout(4),
        _RPC_SECURITY_QOS_V5_W.u.layout().withName("u"),
        winapi.C_POINTER.withName("Sid"),
        winapi.C_INT.withName("EffectiveOnly"),
        MemoryLayout.paddingLayout(4),
        winapi.C_POINTER.withName("ServerSecurityDescriptor")
    ...
    public static class u {
        ...
        private static final GroupLayout $LAYOUT = MemoryLayout.unionLayout(
            winapi.C_POINTER.withName("HttpCredentials")
