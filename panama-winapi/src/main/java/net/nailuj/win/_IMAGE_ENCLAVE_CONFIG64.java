...
public class _IMAGE_ENCLAVE_CONFIG64 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_LONG.withName("MinimumRequiredConfigSize"),
        winapi.C_LONG.withName("PolicyFlags"),
        winapi.C_LONG.withName("NumberOfImports"),
        winapi.C_LONG.withName("ImportList"),
        winapi.C_LONG.withName("ImportEntrySize"),
        ...
        winapi.C_LONG.withName("ImageVersion"),
        winapi.C_LONG.withName("SecurityVersion"),
        winapi.align(winapi.C_LONG_LONG, 4).withName("EnclaveSize"),
        winapi.C_LONG.withName("NumberOfThreads"),
        winapi.C_LONG.withName("EnclaveFlags")
