...
public class _CRYPT_PROVIDER_REF {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_LONG.withName("dwInterface"),
        MemoryLayout.paddingLayout(4),
        winapi.C_POINTER.withName("pszFunction"),
        winapi.C_POINTER.withName("pszProvider"),
        winapi.C_LONG.withName("cProperties"),
        MemoryLayout.paddingLayout(4),
        winapi.C_POINTER.withName("rgpProperties"),
        winapi.C_POINTER.withName("pUM"),
        winapi.C_POINTER.withName("pKM")
