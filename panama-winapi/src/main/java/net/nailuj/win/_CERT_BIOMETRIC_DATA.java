...
public class _CERT_BIOMETRIC_DATA {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_LONG.withName("dwTypeOfBiometricDataChoice"),
        MemoryLayout.paddingLayout(4),
        MemoryLayout.unionLayout(
            winapi.C_LONG.withName("dwPredefined"),
            winapi.C_POINTER.withName("pszObjId")
    ...
    private static final OfInt dwPredefined$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$5596:5"), groupElement("dwPredefined"));
    ...
    private static final AddressLayout pszObjId$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$5596:5"), groupElement("pszObjId"));
