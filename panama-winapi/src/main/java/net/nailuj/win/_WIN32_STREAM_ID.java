...
public class _WIN32_STREAM_ID {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_LONG.withName("dwStreamId"),
        winapi.C_LONG.withName("dwStreamAttributes"),
        _LARGE_INTEGER.layout().withName("Size"),
        winapi.C_LONG.withName("dwStreamNameSize"),
        MemoryLayout.sequenceLayout(1, winapi.C_SHORT).withName("cStreamName"),
