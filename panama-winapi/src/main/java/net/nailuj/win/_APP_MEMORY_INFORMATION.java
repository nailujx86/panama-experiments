...
public class _APP_MEMORY_INFORMATION {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_LONG_LONG.withName("AvailableCommit"),
        winapi.C_LONG_LONG.withName("PrivateCommitUsage"),
        winapi.C_LONG_LONG.withName("PeakPrivateCommitUsage"),
        winapi.C_LONG_LONG.withName("TotalCommitUsage")
