...
public class _FILE_NOTIFY_FULL_INFORMATION {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.unionLayout(
            winapi.C_LONG.withName("ReparsePointTag"),
            winapi.C_LONG.withName("EaSize")
        ).withName("$anon$15038:5"),
        _LARGE_INTEGER.layout().withName("FileId"),
        _LARGE_INTEGER.layout().withName("ParentFileId"),
        winapi.C_SHORT.withName("FileNameLength"),
        winapi.C_CHAR.withName("FileNameFlags"),
        winapi.C_CHAR.withName("Reserved"),
        MemoryLayout.sequenceLayout(1, winapi.C_SHORT).withName("FileName"),
    ...
    private static final OfInt ReparsePointTag$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$15038:5"), groupElement("ReparsePointTag"));
    ...
    private static final OfInt EaSize$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$15038:5"), groupElement("EaSize"));
    ...
    private static final long EaSize$OFFSET = 60;
    ...
    private static final long FileNameFlags$OFFSET = 82;
    ...
    private static final long Reserved$OFFSET = 83;
