...
public class _FSCTL_SET_INTEGRITY_INFORMATION_BUFFER_EX {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_CHAR.withName("EnableIntegrity"),
        winapi.C_CHAR.withName("KeepIntegrityStateUnchanged"),
        winapi.C_SHORT.withName("Reserved"),
        winapi.C_LONG.withName("Flags"),
        winapi.C_CHAR.withName("Version"),
        MemoryLayout.sequenceLayout(7, winapi.C_CHAR).withName("Reserved2")
