...
public class _IMAGE_RELOCATION {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.unionLayout(
            winapi.align(winapi.C_LONG, 2).withName("VirtualAddress"),
            winapi.align(winapi.C_LONG, 2).withName("RelocCount")
        ).withName("$anon$20062:5"),
        winapi.align(winapi.C_LONG, 2).withName("SymbolTableIndex"),
    ...
    private static final OfInt VirtualAddress$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$20062:5"), groupElement("VirtualAddress"));
    ...
    private static final OfInt RelocCount$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$20062:5"), groupElement("RelocCount"));
