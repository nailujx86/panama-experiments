...
public class _SD_CHANGE_MACHINE_SID_INPUT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_SHORT.withName("CurrentMachineSIDOffset"),
        winapi.C_SHORT.withName("CurrentMachineSIDLength"),
        winapi.C_SHORT.withName("NewMachineSIDOffset"),
        winapi.C_SHORT.withName("NewMachineSIDLength")
