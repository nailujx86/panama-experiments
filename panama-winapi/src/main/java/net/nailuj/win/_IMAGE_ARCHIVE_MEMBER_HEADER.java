...
public class _IMAGE_ARCHIVE_MEMBER_HEADER {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.sequenceLayout(16, winapi.C_CHAR).withName("Name"),
        MemoryLayout.sequenceLayout(12, winapi.C_CHAR).withName("Date"),
        MemoryLayout.sequenceLayout(6, winapi.C_CHAR).withName("UserID"),
        MemoryLayout.sequenceLayout(6, winapi.C_CHAR).withName("GroupID"),
        MemoryLayout.sequenceLayout(8, winapi.C_CHAR).withName("Mode"),
        MemoryLayout.sequenceLayout(10, winapi.C_CHAR).withName("Size"),
        MemoryLayout.sequenceLayout(2, winapi.C_CHAR).withName("EndHeader")
