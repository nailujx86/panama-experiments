...
public class _CRYPT_RETRIEVE_AUX_INFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_POINTER.withName("pLastSyncTime"),
        winapi.C_LONG.withName("dwMaxUrlRetrievalByteCount"),
        MemoryLayout.paddingLayout(4),
        winapi.C_POINTER.withName("pPreFetchInfo"),
        winapi.C_POINTER.withName("pFlushInfo"),
        winapi.C_POINTER.withName("ppResponseInfo"),
        winapi.C_POINTER.withName("pwszCacheFileNamePrefix"),
        winapi.C_POINTER.withName("pftCacheResync"),
        winapi.C_INT.withName("fProxyCacheRetrieval"),
        winapi.C_LONG.withName("dwHttpStatusCode"),
        winapi.C_POINTER.withName("ppwszErrorResponseHeaders"),
        winapi.C_POINTER.withName("ppErrorContentBlob")
