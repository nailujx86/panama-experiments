...
public class tagPOINTER_DEVICE_INFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_LONG.withName("displayOrientation"),
        MemoryLayout.paddingLayout(4),
        winapi.C_POINTER.withName("device"),
        winapi.C_INT.withName("pointerDeviceType"),
        MemoryLayout.paddingLayout(4),
        winapi.C_POINTER.withName("monitor"),
        winapi.C_LONG.withName("startingCursorId"),
        winapi.C_SHORT.withName("maxActiveContacts"),
        MemoryLayout.sequenceLayout(520, winapi.C_SHORT).withName("productString"),
