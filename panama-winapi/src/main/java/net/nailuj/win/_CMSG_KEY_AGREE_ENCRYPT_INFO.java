...
public class _CMSG_KEY_AGREE_ENCRYPT_INFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_LONG.withName("dwOriginatorChoice"),
        MemoryLayout.paddingLayout(4),
        MemoryLayout.unionLayout(
            _CERT_ID.layout().withName("OriginatorCertId"),
            _CERT_PUBLIC_KEY_INFO.layout().withName("OriginatorPublicKeyInfo")
        ).withName("$anon$8658:5"),
        winapi.C_LONG.withName("cKeyAgreeKeyEncryptInfo"),
        MemoryLayout.paddingLayout(4),
        winapi.C_POINTER.withName("rgpKeyAgreeKeyEncryptInfo"),
    ...
    private static final GroupLayout OriginatorCertId$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$8658:5"), groupElement("OriginatorCertId"));
    ...
    private static final GroupLayout OriginatorPublicKeyInfo$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$8658:5"), groupElement("OriginatorPublicKeyInfo"));
