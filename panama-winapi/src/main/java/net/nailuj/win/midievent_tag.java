...
public class midievent_tag {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.align(winapi.C_LONG, 1).withName("dwDeltaTime"),
        winapi.align(winapi.C_LONG, 1).withName("dwStreamID"),
        winapi.align(winapi.C_LONG, 1).withName("dwEvent"),
        MemoryLayout.sequenceLayout(1, winapi.align(winapi.C_LONG, 1)).withName("dwParms")
