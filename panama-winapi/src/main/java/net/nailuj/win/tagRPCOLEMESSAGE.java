...
public class tagRPCOLEMESSAGE {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_POINTER.withName("reserved1"),
        winapi.C_LONG.withName("dataRepresentation"),
        MemoryLayout.paddingLayout(4),
        winapi.C_POINTER.withName("Buffer"),
        winapi.C_LONG.withName("cbBuffer"),
        winapi.C_LONG.withName("iMethod"),
        MemoryLayout.sequenceLayout(5, winapi.C_POINTER).withName("reserved2"),
