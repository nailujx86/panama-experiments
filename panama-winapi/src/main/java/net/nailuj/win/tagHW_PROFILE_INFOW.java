...
public class tagHW_PROFILE_INFOW {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_LONG.withName("dwDockInfo"),
        MemoryLayout.sequenceLayout(39, winapi.C_SHORT).withName("szHwProfileGuid"),
        MemoryLayout.sequenceLayout(80, winapi.C_SHORT).withName("szHwProfileName"),
