...
public class tagSCROLLBARINFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_INT.withName("dxyLineButton"),
        winapi.C_INT.withName("xyThumbTop"),
        winapi.C_INT.withName("xyThumbBottom"),
        winapi.C_INT.withName("reserved"),
        MemoryLayout.sequenceLayout(6, winapi.C_LONG).withName("rgstate")
