...
public class tagRPC_EE_INFO_PARAM {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_INT.withName("ParameterType"),
    ...
    public static class u {
        ...
        private static final GroupLayout $LAYOUT = MemoryLayout.unionLayout(
            winapi.C_POINTER.withName("AnsiString"),
            winapi.C_POINTER.withName("UnicodeString"),
            winapi.C_LONG.withName("LVal"),
            winapi.C_SHORT.withName("SVal"),
            winapi.C_LONG_LONG.withName("PVal"),
