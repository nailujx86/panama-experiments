...
public class _CERT_BASIC_CONSTRAINTS_INFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_INT.withName("fPathLenConstraint"),
        winapi.C_LONG.withName("dwPathLenConstraint"),
        winapi.C_LONG.withName("cSubtreesConstraint"),
        MemoryLayout.paddingLayout(4),
        winapi.C_POINTER.withName("rgSubtreesConstraint")
