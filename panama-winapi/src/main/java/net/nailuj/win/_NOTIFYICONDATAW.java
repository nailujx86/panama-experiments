...
public class _NOTIFYICONDATAW {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_INT.withName("uID"),
        winapi.C_INT.withName("uFlags"),
        winapi.C_INT.withName("uCallbackMessage"),
        MemoryLayout.paddingLayout(4),
        winapi.C_POINTER.withName("hIcon"),
        MemoryLayout.sequenceLayout(128, winapi.C_SHORT).withName("szTip"),
        winapi.C_LONG.withName("dwState"),
        winapi.C_LONG.withName("dwStateMask"),
        MemoryLayout.sequenceLayout(256, winapi.C_SHORT).withName("szInfo"),
        MemoryLayout.unionLayout(
            winapi.C_INT.withName("uTimeout"),
            winapi.C_INT.withName("uVersion")
        ).withName("$anon$1058:5"),
        MemoryLayout.sequenceLayout(64, winapi.C_SHORT).withName("szInfoTitle"),
        winapi.C_LONG.withName("dwInfoFlags"),
        _GUID.layout().withName("guidItem"),
        winapi.C_POINTER.withName("hBalloonIcon")
