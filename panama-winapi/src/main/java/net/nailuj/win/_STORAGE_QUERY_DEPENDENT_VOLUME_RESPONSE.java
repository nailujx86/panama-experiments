...
public class _STORAGE_QUERY_DEPENDENT_VOLUME_RESPONSE {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_LONG.withName("ResponseLevel"),
        winapi.C_LONG.withName("NumberEntries"),
    ...
    private static final SequenceLayout Lev1Depends$LAYOUT = (SequenceLayout)$LAYOUT.select(groupElement("$anon$14634:5"), groupElement("Lev1Depends"));
    ...
    private static final SequenceLayout Lev2Depends$LAYOUT = (SequenceLayout)$LAYOUT.select(groupElement("$anon$14634:5"), groupElement("Lev2Depends"));
