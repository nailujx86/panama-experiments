...
public class _WOW64_CONTEXT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_LONG.withName("Dr0"),
        winapi.C_LONG.withName("Dr1"),
        winapi.C_LONG.withName("Dr2"),
        winapi.C_LONG.withName("Dr3"),
        winapi.C_LONG.withName("Dr6"),
        winapi.C_LONG.withName("Dr7"),
        _WOW64_FLOATING_SAVE_AREA.layout().withName("FloatSave"),
        winapi.C_LONG.withName("SegGs"),
        winapi.C_LONG.withName("SegFs"),
        winapi.C_LONG.withName("SegEs"),
        winapi.C_LONG.withName("SegDs"),
        winapi.C_LONG.withName("Edi"),
        winapi.C_LONG.withName("Esi"),
        winapi.C_LONG.withName("Ebx"),
        winapi.C_LONG.withName("Edx"),
        winapi.C_LONG.withName("Ecx"),
        winapi.C_LONG.withName("Eax"),
        winapi.C_LONG.withName("Ebp"),
        winapi.C_LONG.withName("Eip"),
        winapi.C_LONG.withName("SegCs"),
        winapi.C_LONG.withName("EFlags"),
        winapi.C_LONG.withName("Esp"),
        winapi.C_LONG.withName("SegSs"),
        MemoryLayout.sequenceLayout(512, winapi.C_CHAR).withName("ExtendedRegisters")
