...
public class tagWINDOWINFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_LONG.withName("dwWindowStatus"),
        winapi.C_INT.withName("cxWindowBorders"),
        winapi.C_INT.withName("cyWindowBorders"),
        winapi.C_SHORT.withName("atomWindowType"),
        winapi.C_SHORT.withName("wCreatorVersion")
