...
public class tagDVTARGETDEVICE {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_LONG.withName("tdSize"),
        winapi.C_SHORT.withName("tdDriverNameOffset"),
        winapi.C_SHORT.withName("tdDeviceNameOffset"),
        winapi.C_SHORT.withName("tdPortNameOffset"),
        winapi.C_SHORT.withName("tdExtDevmodeOffset"),
        MemoryLayout.sequenceLayout(1, winapi.C_CHAR).withName("tdData"),
