...
public class tagPDA {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_SHORT.withName("nFromPage"),
        winapi.C_SHORT.withName("nToPage"),
        winapi.C_SHORT.withName("nMinPage"),
        winapi.C_SHORT.withName("nMaxPage"),
        winapi.C_SHORT.withName("nCopies"),
        MemoryLayout.paddingLayout(2),
        winapi.C_POINTER.withName("hInstance"),
        winapi.C_LONG_LONG.withName("lCustData"),
        winapi.C_POINTER.withName("lpfnPrintHook"),
        winapi.C_POINTER.withName("lpfnSetupHook"),
        winapi.C_POINTER.withName("lpPrintTemplateName"),
        winapi.C_POINTER.withName("lpSetupTemplateName"),
        winapi.C_POINTER.withName("hPrintTemplate"),
        winapi.C_POINTER.withName("hSetupTemplate")
    ).withName("tagPDA");
