...
public class _CERT_POLICY95_QUALIFIER1 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_POINTER.withName("pszPracticesReference"),
        winapi.C_POINTER.withName("pszNoticeIdentifier"),
        winapi.C_POINTER.withName("pszNSINoticeIdentifier"),
        winapi.C_LONG.withName("cCPSURLs"),
        MemoryLayout.paddingLayout(4),
        winapi.C_POINTER.withName("rgCPSURLs")
