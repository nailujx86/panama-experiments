...
public class SCARD_READERSTATEA {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_POINTER.withName("szReader"),
        winapi.C_POINTER.withName("pvUserData"),
        winapi.C_LONG.withName("dwCurrentState"),
        winapi.C_LONG.withName("dwEventState"),
        winapi.C_LONG.withName("cbAtr"),
        MemoryLayout.sequenceLayout(36, winapi.C_CHAR).withName("rgbAtr")
    ).withName("$anon$504:9");
