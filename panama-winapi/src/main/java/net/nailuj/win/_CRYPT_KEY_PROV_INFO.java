...
public class _CRYPT_KEY_PROV_INFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_POINTER.withName("pwszContainerName"),
        winapi.C_POINTER.withName("pwszProvName"),
        winapi.C_LONG.withName("dwProvType"),
        winapi.C_LONG.withName("dwFlags"),
        winapi.C_LONG.withName("cProvParam"),
        MemoryLayout.paddingLayout(4),
        winapi.C_POINTER.withName("rgProvParam"),
