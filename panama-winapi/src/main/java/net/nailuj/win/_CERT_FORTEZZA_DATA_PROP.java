...
public class _CERT_FORTEZZA_DATA_PROP {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.sequenceLayout(8, winapi.C_CHAR).withName("SerialNumber"),
        winapi.C_INT.withName("CertIndex"),
        MemoryLayout.sequenceLayout(36, winapi.C_CHAR).withName("CertLabel")
