...
public class _CMSG_CONTENT_ENCRYPT_INFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_LONG.withName("cRecipients"),
        MemoryLayout.paddingLayout(4),
        winapi.C_POINTER.withName("rgCmsRecipients"),
        winapi.C_POINTER.withName("pfnAlloc"),
        winapi.C_POINTER.withName("pfnFree"),
        winapi.C_LONG.withName("dwEncryptFlags"),
        MemoryLayout.paddingLayout(4),
        MemoryLayout.unionLayout(
            winapi.C_LONG_LONG.withName("hContentEncryptKey"),
            winapi.C_POINTER.withName("hCNGContentEncryptKey")
        ).withName("$anon$8485:5"),
        winapi.C_LONG.withName("dwFlags"),
        winapi.C_INT.withName("fCNG"),
        winapi.C_POINTER.withName("pbCNGContentEncryptKeyObject"),
        winapi.C_POINTER.withName("pbContentEncryptKey"),
        winapi.C_LONG.withName("cbContentEncryptKey"),
        MemoryLayout.paddingLayout(4)
    ...
    private static final OfLong hContentEncryptKey$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$8485:5"), groupElement("hContentEncryptKey"));
    ...
    private static final AddressLayout hCNGContentEncryptKey$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$8485:5"), groupElement("hCNGContentEncryptKey"));
