...
public class _OFSTRUCT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_CHAR.withName("cBytes"),
        winapi.C_CHAR.withName("fFixedDisk"),
        winapi.C_SHORT.withName("nErrCode"),
        winapi.C_SHORT.withName("Reserved1"),
        winapi.C_SHORT.withName("Reserved2"),
        MemoryLayout.sequenceLayout(128, winapi.C_CHAR).withName("szPathName")
    ).withName("_OFSTRUCT");
