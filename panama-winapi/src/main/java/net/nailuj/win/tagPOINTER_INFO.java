...
public class tagPOINTER_INFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_LONG.withName("pointerType"),
        winapi.C_INT.withName("pointerId"),
        winapi.C_INT.withName("frameId"),
        winapi.C_INT.withName("pointerFlags"),
        winapi.C_POINTER.withName("sourceDevice"),
        winapi.C_POINTER.withName("hwndTarget"),
        ...
        winapi.C_INT.withName("historyCount"),
        winapi.C_INT.withName("InputData"),
        winapi.C_LONG.withName("dwKeyStates"),
        winapi.C_LONG_LONG.withName("PerformanceCount"),
        winapi.C_INT.withName("ButtonChangeType"),
