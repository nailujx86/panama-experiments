...
public class tagBITMAPCOREHEADER {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_LONG.withName("bcSize"),
        winapi.C_SHORT.withName("bcWidth"),
        winapi.C_SHORT.withName("bcHeight"),
        winapi.C_SHORT.withName("bcPlanes"),
        winapi.C_SHORT.withName("bcBitCount")
