...
public class _MEMORY_PARTITION_DEDICATED_MEMORY_INFORMATION {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_LONG.withName("SizeOfInformation"),
        winapi.C_LONG.withName("Flags"),
        winapi.C_LONG.withName("AttributesOffset"),
        winapi.C_LONG.withName("AttributeCount"),
        winapi.C_LONG.withName("Reserved"),
        winapi.C_LONG_LONG.withName("TypeId")
