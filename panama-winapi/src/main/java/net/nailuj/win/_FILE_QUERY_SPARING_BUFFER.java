...
public class _FILE_QUERY_SPARING_BUFFER {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_LONG.withName("SparingUnitBytes"),
        winapi.C_CHAR.withName("SoftwareSparing"),
        MemoryLayout.paddingLayout(3),
        winapi.C_LONG.withName("TotalSpareBlocks"),
        winapi.C_LONG.withName("FreeSpareBlocks")
