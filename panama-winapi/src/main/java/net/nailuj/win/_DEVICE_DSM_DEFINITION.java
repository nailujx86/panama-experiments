...
public class _DEVICE_DSM_DEFINITION {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_CHAR.withName("SingleRange"),
        MemoryLayout.paddingLayout(3),
        winapi.C_LONG.withName("ParameterBlockAlignment"),
        winapi.C_LONG.withName("ParameterBlockLength"),
        winapi.C_CHAR.withName("HasOutput"),
        MemoryLayout.paddingLayout(3),
        winapi.C_LONG.withName("OutputBlockAlignment"),
        winapi.C_LONG.withName("OutputBlockLength")
