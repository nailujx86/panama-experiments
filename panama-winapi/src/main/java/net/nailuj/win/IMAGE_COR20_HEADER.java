...
public class IMAGE_COR20_HEADER {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_SHORT.withName("MajorRuntimeVersion"),
        winapi.C_SHORT.withName("MinorRuntimeVersion"),
        _IMAGE_DATA_DIRECTORY.layout().withName("MetaData"),
        winapi.C_LONG.withName("Flags"),
        MemoryLayout.unionLayout(
            winapi.C_LONG.withName("EntryPointToken"),
            winapi.C_LONG.withName("EntryPointRVA")
        ).withName("$anon$21799:5"),
    ...
    private static final OfInt EntryPointToken$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$21799:5"), groupElement("EntryPointToken"));
    ...
    private static final OfInt EntryPointRVA$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$21799:5"), groupElement("EntryPointRVA"));
