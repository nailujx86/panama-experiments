...
public class _OUTLINETEXTMETRICA {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_INT.withName("otmSize"),
        tagTEXTMETRICA.layout().withName("otmTextMetrics"),
        winapi.C_CHAR.withName("otmFiller"),
        tagPANOSE.layout().withName("otmPanoseNumber"),
        MemoryLayout.paddingLayout(1),
        winapi.C_INT.withName("otmfsSelection"),
        winapi.C_INT.withName("otmfsType"),
        winapi.C_INT.withName("otmsCharSlopeRise"),
        winapi.C_INT.withName("otmsCharSlopeRun"),
        winapi.C_INT.withName("otmItalicAngle"),
        winapi.C_INT.withName("otmEMSquare"),
        winapi.C_INT.withName("otmAscent"),
        winapi.C_INT.withName("otmDescent"),
        winapi.C_INT.withName("otmLineGap"),
        winapi.C_INT.withName("otmsCapEmHeight"),
        winapi.C_INT.withName("otmsXHeight"),
        tagRECT.layout().withName("otmrcFontBox"),
        winapi.C_INT.withName("otmMacAscent"),
        winapi.C_INT.withName("otmMacDescent"),
        winapi.C_INT.withName("otmMacLineGap"),
        winapi.C_INT.withName("otmusMinimumPPEM"),
        ...
        winapi.C_INT.withName("otmsStrikeoutSize"),
        winapi.C_INT.withName("otmsStrikeoutPosition"),
        winapi.C_INT.withName("otmsUnderscoreSize"),
        winapi.C_INT.withName("otmsUnderscorePosition"),
        MemoryLayout.paddingLayout(4),
        winapi.C_POINTER.withName("otmpFamilyName"),
        winapi.C_POINTER.withName("otmpFaceName"),
        winapi.C_POINTER.withName("otmpStyleName"),
        winapi.C_POINTER.withName("otmpFullName")
