...
public class tagMIXERCONTROLA {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.align(winapi.C_LONG, 1).withName("dwControlID"),
        winapi.align(winapi.C_LONG, 1).withName("dwControlType"),
        winapi.align(winapi.C_LONG, 1).withName("fdwControl"),
        winapi.align(winapi.C_LONG, 1).withName("cMultipleItems"),
        MemoryLayout.sequenceLayout(16, winapi.C_CHAR).withName("szShortName"),
        MemoryLayout.sequenceLayout(64, winapi.C_CHAR).withName("szName"),
    ...
    public static class Bounds {
        ...
        private static final GroupLayout $LAYOUT = MemoryLayout.unionLayout(
            MemoryLayout.structLayout(
                winapi.align(winapi.C_LONG, 1).withName("lMinimum"),
                winapi.align(winapi.C_LONG, 1).withName("lMaximum")
            ).withName("$anon$2064:9"),
            MemoryLayout.structLayout(
                winapi.align(winapi.C_LONG, 1).withName("dwMinimum"),
                winapi.align(winapi.C_LONG, 1).withName("dwMaximum")
            ).withName("$anon$2068:9"),
            MemoryLayout.sequenceLayout(6, winapi.align(winapi.C_LONG, 1)).withName("dwReserved")
    ...
    public static class Metrics {
        ...
        private static final GroupLayout $LAYOUT = MemoryLayout.unionLayout(
            winapi.align(winapi.C_LONG, 1).withName("cSteps"),
            winapi.align(winapi.C_LONG, 1).withName("cbCustomData"),
            MemoryLayout.sequenceLayout(6, winapi.align(winapi.C_LONG, 1)).withName("dwReserved")
