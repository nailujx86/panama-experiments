...
public class BITMAPV5HEADER {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_LONG.withName("bV5Size"),
        winapi.C_LONG.withName("bV5Width"),
        winapi.C_LONG.withName("bV5Height"),
        winapi.C_SHORT.withName("bV5Planes"),
        winapi.C_SHORT.withName("bV5BitCount"),
        winapi.C_LONG.withName("bV5Compression"),
        winapi.C_LONG.withName("bV5SizeImage"),
        winapi.C_LONG.withName("bV5XPelsPerMeter"),
        winapi.C_LONG.withName("bV5YPelsPerMeter"),
        winapi.C_LONG.withName("bV5ClrUsed"),
        winapi.C_LONG.withName("bV5ClrImportant"),
        winapi.C_LONG.withName("bV5RedMask"),
        winapi.C_LONG.withName("bV5GreenMask"),
        winapi.C_LONG.withName("bV5BlueMask"),
        winapi.C_LONG.withName("bV5AlphaMask"),
        winapi.C_LONG.withName("bV5CSType"),
        tagICEXYZTRIPLE.layout().withName("bV5Endpoints"),
        winapi.C_LONG.withName("bV5GammaRed"),
        winapi.C_LONG.withName("bV5GammaGreen"),
        winapi.C_LONG.withName("bV5GammaBlue"),
        winapi.C_LONG.withName("bV5Intent"),
        winapi.C_LONG.withName("bV5ProfileData"),
        winapi.C_LONG.withName("bV5ProfileSize"),
        winapi.C_LONG.withName("bV5Reserved")
    ).withName("$anon$868:9");
