...
public class _SCM_PD_DEVICE_INFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_LONG.withName("UnsafeShutdownCount"),
        MemoryLayout.paddingLayout(4),
        winapi.C_LONG_LONG.withName("PersistentMemorySizeInBytes"),
        winapi.C_LONG_LONG.withName("VolatileMemorySizeInBytes"),
        winapi.C_LONG_LONG.withName("TotalMemorySizeInBytes"),
        winapi.C_LONG.withName("SlotNumber"),
        winapi.C_LONG.withName("DeviceHandle"),
        winapi.C_SHORT.withName("PhysicalId"),
        winapi.C_CHAR.withName("NumberOfFormatInterfaceCodes"),
        MemoryLayout.paddingLayout(1),
        MemoryLayout.sequenceLayout(8, winapi.C_SHORT).withName("FormatInterfaceCodes"),
        winapi.C_LONG.withName("VendorId"),
        winapi.C_LONG.withName("ProductId"),
        winapi.C_LONG.withName("SubsystemDeviceId"),
        winapi.C_LONG.withName("SubsystemVendorId"),
        winapi.C_CHAR.withName("ManufacturingLocation"),
        winapi.C_CHAR.withName("ManufacturingWeek"),
        winapi.C_CHAR.withName("ManufacturingYear"),
        MemoryLayout.paddingLayout(1),
        winapi.C_LONG.withName("SerialNumber4Byte"),
        winapi.C_LONG.withName("SerialNumberLengthInChars"),
        MemoryLayout.sequenceLayout(1, winapi.C_CHAR).withName("SerialNumber"),
