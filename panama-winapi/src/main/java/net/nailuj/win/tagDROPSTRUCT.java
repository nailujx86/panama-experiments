...
public class tagDROPSTRUCT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_POINTER.withName("hwndSource"),
        winapi.C_POINTER.withName("hwndSink"),
        winapi.C_LONG.withName("wFmt"),
        MemoryLayout.paddingLayout(4),
        winapi.C_LONG_LONG.withName("dwData"),
        tagPOINT.layout().withName("ptDrop"),
        winapi.C_LONG.withName("dwControlData"),
        MemoryLayout.paddingLayout(4)
