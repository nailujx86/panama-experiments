...
public class _CHANGER_ELEMENT_STATUS_EX {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_LONG.withName("ExceptionCode"),
        winapi.C_CHAR.withName("TargetId"),
        winapi.C_CHAR.withName("Lun"),
        winapi.C_SHORT.withName("Reserved"),
        MemoryLayout.sequenceLayout(36, winapi.C_CHAR).withName("PrimaryVolumeID"),
        MemoryLayout.sequenceLayout(36, winapi.C_CHAR).withName("AlternateVolumeID"),
        MemoryLayout.sequenceLayout(8, winapi.C_CHAR).withName("VendorIdentification"),
        MemoryLayout.sequenceLayout(16, winapi.C_CHAR).withName("ProductIdentification"),
        MemoryLayout.sequenceLayout(32, winapi.C_CHAR).withName("SerialNumber")
