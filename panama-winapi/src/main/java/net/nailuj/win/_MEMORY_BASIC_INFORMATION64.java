...
public class _MEMORY_BASIC_INFORMATION64 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_LONG_LONG.withName("BaseAddress"),
        winapi.C_LONG_LONG.withName("AllocationBase"),
        winapi.C_LONG.withName("AllocationProtect"),
        winapi.C_LONG.withName("__alignment1"),
        winapi.C_LONG_LONG.withName("RegionSize"),
        winapi.C_LONG.withName("State"),
        winapi.C_LONG.withName("Protect"),
        winapi.C_LONG.withName("Type"),
        winapi.C_LONG.withName("__alignment2")
