...
public class _MODEMDEVCAPS {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_LONG.withName("dwActualSize"),
        winapi.C_LONG.withName("dwRequiredSize"),
        winapi.C_LONG.withName("dwDevSpecificOffset"),
        winapi.C_LONG.withName("dwDevSpecificSize"),
        winapi.C_LONG.withName("dwModemProviderVersion"),
        winapi.C_LONG.withName("dwModemManufacturerOffset"),
        winapi.C_LONG.withName("dwModemManufacturerSize"),
        winapi.C_LONG.withName("dwModemModelOffset"),
        winapi.C_LONG.withName("dwModemModelSize"),
        winapi.C_LONG.withName("dwModemVersionOffset"),
        winapi.C_LONG.withName("dwModemVersionSize"),
        winapi.C_LONG.withName("dwDialOptions"),
        winapi.C_LONG.withName("dwCallSetupFailTimer"),
        winapi.C_LONG.withName("dwInactivityTimeout"),
        winapi.C_LONG.withName("dwSpeakerVolume"),
        winapi.C_LONG.withName("dwSpeakerMode"),
        winapi.C_LONG.withName("dwModemOptions"),
        winapi.C_LONG.withName("dwMaxDTERate"),
        winapi.C_LONG.withName("dwMaxDCERate"),
        MemoryLayout.sequenceLayout(1, winapi.C_CHAR).withName("abVariablePortion"),
