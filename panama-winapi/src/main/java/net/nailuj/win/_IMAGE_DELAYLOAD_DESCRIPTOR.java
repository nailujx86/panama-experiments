...
public class _IMAGE_DELAYLOAD_DESCRIPTOR {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_LONG.withName("DllNameRVA"),
        winapi.C_LONG.withName("ModuleHandleRVA"),
        winapi.C_LONG.withName("ImportAddressTableRVA"),
        winapi.C_LONG.withName("ImportNameTableRVA"),
        winapi.C_LONG.withName("BoundImportAddressTableRVA"),
        winapi.C_LONG.withName("UnloadInformationTableRVA"),
    ...
    public static class Attributes {
        ...
        private static final GroupLayout $LAYOUT = MemoryLayout.unionLayout(
            winapi.C_LONG.withName("AllAttributes"),
            MemoryLayout.structLayout(
                MemoryLayout.paddingLayout(4)
            ).withName("$anon$20722:9")
        ).withName("$anon$20720:5");
