...
public class _IMAGE_THUNK_DATA64 {
    ...
    public static class u1 {
        ...
        private static final GroupLayout $LAYOUT = MemoryLayout.unionLayout(
            winapi.C_LONG_LONG.withName("ForwarderString"),
            winapi.C_LONG_LONG.withName("Function"),
            winapi.C_LONG_LONG.withName("Ordinal"),
            winapi.C_LONG_LONG.withName("AddressOfData")
        ).withName("$anon$20590:5");
