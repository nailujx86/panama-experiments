...
public class _IMAGE_ALPHA64_RUNTIME_FUNCTION_ENTRY {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.align(winapi.C_LONG_LONG, 4).withName("BeginAddress"),
        winapi.align(winapi.C_LONG_LONG, 4).withName("EndAddress"),
        winapi.align(winapi.C_LONG_LONG, 4).withName("ExceptionHandler"),
        winapi.align(winapi.C_LONG_LONG, 4).withName("HandlerData"),
        winapi.align(winapi.C_LONG_LONG, 4).withName("PrologEndAddress")
