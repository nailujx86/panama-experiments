...
public class _RPC_BINDING_HANDLE_SECURITY_V1_A {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_POINTER.withName("ServerPrincName"),
        winapi.C_LONG.withName("AuthnLevel"),
        winapi.C_LONG.withName("AuthnSvc"),
        winapi.C_POINTER.withName("AuthIdentity"),
        winapi.C_POINTER.withName("SecurityQos")
