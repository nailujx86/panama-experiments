...
public class _NTFS_STATISTICS {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_LONG.withName("MftReads"),
        winapi.C_LONG.withName("MftReadBytes"),
        winapi.C_LONG.withName("MftWrites"),
        winapi.C_LONG.withName("MftWriteBytes"),
        _NTFS_STATISTICS.MftWritesUserLevel.layout().withName("MftWritesUserLevel"),
        winapi.C_SHORT.withName("MftWritesFlushForLogFileFull"),
        winapi.C_SHORT.withName("MftWritesLazyWriter"),
        winapi.C_SHORT.withName("MftWritesUserRequest"),
        MemoryLayout.paddingLayout(2),
        winapi.C_LONG.withName("Mft2Writes"),
        winapi.C_LONG.withName("Mft2WriteBytes"),
        _NTFS_STATISTICS.Mft2WritesUserLevel.layout().withName("Mft2WritesUserLevel"),
        winapi.C_SHORT.withName("Mft2WritesFlushForLogFileFull"),
        winapi.C_SHORT.withName("Mft2WritesLazyWriter"),
        winapi.C_SHORT.withName("Mft2WritesUserRequest"),
        MemoryLayout.paddingLayout(2),
        winapi.C_LONG.withName("RootIndexReads"),
        winapi.C_LONG.withName("RootIndexReadBytes"),
        winapi.C_LONG.withName("RootIndexWrites"),
        winapi.C_LONG.withName("RootIndexWriteBytes"),
        winapi.C_LONG.withName("BitmapReads"),
        winapi.C_LONG.withName("BitmapReadBytes"),
        winapi.C_LONG.withName("BitmapWrites"),
        winapi.C_LONG.withName("BitmapWriteBytes"),
        winapi.C_SHORT.withName("BitmapWritesFlushForLogFileFull"),
        winapi.C_SHORT.withName("BitmapWritesLazyWriter"),
        winapi.C_SHORT.withName("BitmapWritesUserRequest"),
        _NTFS_STATISTICS.BitmapWritesUserLevel.layout().withName("BitmapWritesUserLevel"),
        winapi.C_LONG.withName("MftBitmapReads"),
        winapi.C_LONG.withName("MftBitmapReadBytes"),
        winapi.C_LONG.withName("MftBitmapWrites"),
        winapi.C_LONG.withName("MftBitmapWriteBytes"),
        winapi.C_SHORT.withName("MftBitmapWritesFlushForLogFileFull"),
        winapi.C_SHORT.withName("MftBitmapWritesLazyWriter"),
        winapi.C_SHORT.withName("MftBitmapWritesUserRequest"),
        _NTFS_STATISTICS.MftBitmapWritesUserLevel.layout().withName("MftBitmapWritesUserLevel"),
        MemoryLayout.paddingLayout(2),
        winapi.C_LONG.withName("UserIndexReads"),
        winapi.C_LONG.withName("UserIndexReadBytes"),
        winapi.C_LONG.withName("UserIndexWrites"),
        winapi.C_LONG.withName("UserIndexWriteBytes"),
        winapi.C_LONG.withName("LogFileReads"),
        winapi.C_LONG.withName("LogFileReadBytes"),
        winapi.C_LONG.withName("LogFileWrites"),
        winapi.C_LONG.withName("LogFileWriteBytes"),
    ...
    public static class MftWritesUserLevel {
        ...
        private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
            winapi.C_SHORT.withName("Write"),
            winapi.C_SHORT.withName("Create"),
            winapi.C_SHORT.withName("SetInfo"),
            winapi.C_SHORT.withName("Flush")
    ...
    public static class Allocate {
        ...
        private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
            ...
            winapi.C_LONG.withName("Clusters"),
            winapi.C_LONG.withName("Hints"),
            winapi.C_LONG.withName("RunsReturned"),
            winapi.C_LONG.withName("HintsHonored"),
            winapi.C_LONG.withName("HintsClusters"),
            winapi.C_LONG.withName("Cache"),
            winapi.C_LONG.withName("CacheClusters"),
            winapi.C_LONG.withName("CacheMiss"),
            winapi.C_LONG.withName("CacheMissClusters")
        ).withName("$anon$12621:5");
