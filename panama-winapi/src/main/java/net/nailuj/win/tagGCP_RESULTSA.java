...
public class tagGCP_RESULTSA {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_POINTER.withName("lpOutString"),
        winapi.C_POINTER.withName("lpOrder"),
        winapi.C_POINTER.withName("lpDx"),
        winapi.C_POINTER.withName("lpCaretPos"),
        winapi.C_POINTER.withName("lpClass"),
        winapi.C_POINTER.withName("lpGlyphs"),
        winapi.C_INT.withName("nGlyphs"),
        winapi.C_INT.withName("nMaxFit")
