...
public class _FAT_STATISTICS {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_LONG.withName("CreateHits"),
        winapi.C_LONG.withName("SuccessfulCreates"),
        winapi.C_LONG.withName("FailedCreates"),
        winapi.C_LONG.withName("NonCachedReads"),
        winapi.C_LONG.withName("NonCachedReadBytes"),
        winapi.C_LONG.withName("NonCachedWrites"),
        winapi.C_LONG.withName("NonCachedWriteBytes"),
        winapi.C_LONG.withName("NonCachedDiskReads"),
        winapi.C_LONG.withName("NonCachedDiskWrites")
