...
public class _SYSTEM_POWER_STATUS {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_CHAR.withName("ACLineStatus"),
        winapi.C_CHAR.withName("BatteryFlag"),
        winapi.C_CHAR.withName("BatteryLifePercent"),
        winapi.C_CHAR.withName("SystemStatusFlag"),
        winapi.C_LONG.withName("BatteryLifeTime"),
        winapi.C_LONG.withName("BatteryFullLifeTime")
