...
public class _XSAVE_FORMAT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_SHORT.withName("ControlWord"),
        winapi.C_SHORT.withName("StatusWord"),
        winapi.C_CHAR.withName("TagWord"),
        winapi.C_CHAR.withName("Reserved1"),
        winapi.C_SHORT.withName("ErrorOpcode"),
        winapi.C_LONG.withName("ErrorOffset"),
        winapi.C_SHORT.withName("ErrorSelector"),
        winapi.C_SHORT.withName("Reserved2"),
        winapi.C_LONG.withName("DataOffset"),
        winapi.C_SHORT.withName("DataSelector"),
        winapi.C_SHORT.withName("Reserved3"),
        winapi.C_LONG.withName("MxCsr"),
        winapi.C_LONG.withName("MxCsr_Mask"),
        ...
        MemoryLayout.sequenceLayout(96, winapi.C_CHAR).withName("Reserved4")
