...
public class _ENCRYPTION_KEY_CTRL_INPUT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_LONG.withName("HeaderSize"),
        winapi.C_LONG.withName("StructureSize"),
        winapi.C_SHORT.withName("KeyOffset"),
        winapi.C_SHORT.withName("KeySize"),
        winapi.C_LONG.withName("DplLock"),
        winapi.C_LONG_LONG.withName("DplUserId"),
        winapi.C_LONG_LONG.withName("DplCredentialId")
