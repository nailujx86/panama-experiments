...
public class _STORAGE_DEVICE_DESCRIPTOR {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_CHAR.withName("DeviceType"),
        winapi.C_CHAR.withName("DeviceTypeModifier"),
        winapi.C_CHAR.withName("RemovableMedia"),
        winapi.C_CHAR.withName("CommandQueueing"),
        winapi.C_LONG.withName("VendorIdOffset"),
        winapi.C_LONG.withName("ProductIdOffset"),
        winapi.C_LONG.withName("ProductRevisionOffset"),
        winapi.C_LONG.withName("SerialNumberOffset"),
        winapi.C_INT.withName("BusType"),
        winapi.C_LONG.withName("RawPropertiesLength"),
        MemoryLayout.sequenceLayout(1, winapi.C_CHAR).withName("RawDeviceProperties"),
