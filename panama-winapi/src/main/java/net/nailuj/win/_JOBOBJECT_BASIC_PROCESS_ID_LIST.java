...
public class _JOBOBJECT_BASIC_PROCESS_ID_LIST {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_LONG.withName("NumberOfAssignedProcesses"),
        winapi.C_LONG.withName("NumberOfProcessIdsInList"),
        MemoryLayout.sequenceLayout(1, winapi.C_LONG_LONG).withName("ProcessIdList")
