...
public class _CMSG_KEY_AGREE_RECIPIENT_ENCODE_INFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_POINTER.withName("pvKeyEncryptionAuxInfo"),
        _CRYPT_ALGORITHM_IDENTIFIER.layout().withName("KeyWrapAlgorithm"),
        winapi.C_POINTER.withName("pvKeyWrapAuxInfo"),
        winapi.C_LONG_LONG.withName("hCryptProv"),
        winapi.C_LONG.withName("dwKeySpec"),
        winapi.C_LONG.withName("dwKeyChoice"),
        MemoryLayout.unionLayout(
            winapi.C_POINTER.withName("pEphemeralAlgorithm"),
            winapi.C_POINTER.withName("pSenderId")
        ).withName("$anon$6989:5"),
        _CRYPTOAPI_BLOB.layout().withName("UserKeyingMaterial"),
        winapi.C_LONG.withName("cRecipientEncryptedKeys"),
        MemoryLayout.paddingLayout(4),
        winapi.C_POINTER.withName("rgpRecipientEncryptedKeys")
    ...
    private static final AddressLayout pEphemeralAlgorithm$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$6989:5"), groupElement("pEphemeralAlgorithm"));
    ...
    private static final AddressLayout pSenderId$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$6989:5"), groupElement("pSenderId"));
