...
public class _REASON_CONTEXT {
    ...
    public static class Reason {
        ...
        private static final GroupLayout $LAYOUT = MemoryLayout.unionLayout(
            ...
            winapi.C_POINTER.withName("SimpleReasonString")
        ).withName("$anon$276:5");
        ...
        public static class Detailed {
            ...
            private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
                winapi.C_POINTER.withName("LocalizedReasonModule"),
                winapi.C_LONG.withName("LocalizedReasonId"),
                winapi.C_LONG.withName("ReasonStringCount"),
                winapi.C_POINTER.withName("ReasonStrings")
            ).withName("$anon$277:9");
