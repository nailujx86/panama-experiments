...
public class tagMETHODDATA {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_POINTER.withName("szName"),
        winapi.C_POINTER.withName("ppdata"),
        winapi.C_LONG.withName("dispid"),
        winapi.C_INT.withName("iMeth"),
        winapi.C_INT.withName("cc"),
        winapi.C_INT.withName("cArgs"),
        winapi.C_SHORT.withName("wFlags"),
        winapi.C_SHORT.withName("vtReturn"),
