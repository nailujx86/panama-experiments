...
public class _IMAGE_RESOURCE_DIRECTORY_ENTRY {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.unionLayout(
            ...
            ).withName("$anon$20789:9"),
            winapi.C_LONG.withName("Name"),
            winapi.C_SHORT.withName("Id")
        ).withName("$anon$20788:5"),
        MemoryLayout.unionLayout(
            winapi.C_LONG.withName("OffsetToData"),
            MemoryLayout.structLayout(
                MemoryLayout.paddingLayout(4)
            ).withName("$anon$20798:9")
        ).withName("$anon$20796:5")
    ...
    private static final OfInt Name$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$20788:5"), groupElement("Name"));
    ...
    private static final OfShort Id$LAYOUT = (OfShort)$LAYOUT.select(groupElement("$anon$20788:5"), groupElement("Id"));
    ...
    private static final OfInt OffsetToData$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$20796:5"), groupElement("OffsetToData"));
