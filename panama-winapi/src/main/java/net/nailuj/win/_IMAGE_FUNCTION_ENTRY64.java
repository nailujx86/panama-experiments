...
public class _IMAGE_FUNCTION_ENTRY64 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.align(winapi.C_LONG_LONG, 4).withName("StartingAddress"),
        winapi.align(winapi.C_LONG_LONG, 4).withName("EndingAddress"),
        MemoryLayout.unionLayout(
            winapi.align(winapi.C_LONG_LONG, 4).withName("EndOfPrologue"),
            winapi.align(winapi.C_LONG_LONG, 4).withName("UnwindInfoAddress")
        ).withName("$anon$21600:5")
    ...
    private static final OfLong EndOfPrologue$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$21600:5"), groupElement("EndOfPrologue"));
    ...
    private static final OfLong UnwindInfoAddress$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$21600:5"), groupElement("UnwindInfoAddress"));
