...
public class tagRemSTGMEDIUM {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_LONG.withName("dwHandleType"),
        winapi.C_LONG.withName("pData"),
        winapi.C_LONG.withName("pUnkForRelease"),
        winapi.C_LONG.withName("cbData"),
        MemoryLayout.sequenceLayout(1, winapi.C_CHAR).withName("data"),
