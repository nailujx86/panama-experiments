...
public class _PROV_ENUMALGS_EX {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_INT.withName("aiAlgid"),
        winapi.C_LONG.withName("dwDefaultLen"),
        winapi.C_LONG.withName("dwMinLen"),
        winapi.C_LONG.withName("dwMaxLen"),
        winapi.C_LONG.withName("dwProtocols"),
        winapi.C_LONG.withName("dwNameLen"),
        MemoryLayout.sequenceLayout(20, winapi.C_CHAR).withName("szName"),
        winapi.C_LONG.withName("dwLongNameLen"),
        MemoryLayout.sequenceLayout(40, winapi.C_CHAR).withName("szLongName")
