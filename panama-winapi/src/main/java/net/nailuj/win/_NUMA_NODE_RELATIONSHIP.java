...
public class _NUMA_NODE_RELATIONSHIP {
    ...
    private static final GroupLayout GroupMask$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$14001:5"), groupElement("GroupMask"));
    ...
    private static final SequenceLayout GroupMasks$LAYOUT = (SequenceLayout)$LAYOUT.select(groupElement("$anon$14001:5"), groupElement("GroupMasks"));
