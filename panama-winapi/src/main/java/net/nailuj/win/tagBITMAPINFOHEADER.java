...
public class tagBITMAPINFOHEADER {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_LONG.withName("biSize"),
        winapi.C_LONG.withName("biWidth"),
        winapi.C_LONG.withName("biHeight"),
        winapi.C_SHORT.withName("biPlanes"),
        winapi.C_SHORT.withName("biBitCount"),
        winapi.C_LONG.withName("biCompression"),
        winapi.C_LONG.withName("biSizeImage"),
        winapi.C_LONG.withName("biXPelsPerMeter"),
        winapi.C_LONG.withName("biYPelsPerMeter"),
        winapi.C_LONG.withName("biClrUsed"),
        winapi.C_LONG.withName("biClrImportant")
