...
public class midihdr_tag {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.align(winapi.C_POINTER, 1).withName("lpData"),
        winapi.align(winapi.C_LONG, 1).withName("dwBufferLength"),
        winapi.align(winapi.C_LONG, 1).withName("dwBytesRecorded"),
        winapi.align(winapi.C_LONG_LONG, 1).withName("dwUser"),
        winapi.align(winapi.C_LONG, 1).withName("dwFlags"),
        winapi.align(winapi.C_POINTER, 1).withName("lpNext"),
        winapi.align(winapi.C_LONG_LONG, 1).withName("reserved"),
        winapi.align(winapi.C_LONG, 1).withName("dwOffset"),
        MemoryLayout.sequenceLayout(8, winapi.align(winapi.C_LONG_LONG, 1)).withName("dwReserved")
