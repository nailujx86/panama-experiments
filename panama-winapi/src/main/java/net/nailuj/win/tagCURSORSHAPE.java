...
public class tagCURSORSHAPE {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_INT.withName("xHotSpot"),
        winapi.C_INT.withName("yHotSpot"),
        winapi.C_INT.withName("cx"),
        winapi.C_INT.withName("cy"),
        winapi.C_INT.withName("cbWidth"),
        winapi.C_CHAR.withName("Planes"),
        winapi.C_CHAR.withName("BitsPixel"),
