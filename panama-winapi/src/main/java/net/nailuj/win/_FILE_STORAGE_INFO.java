...
public class _FILE_STORAGE_INFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        winapi.C_LONG.withName("LogicalBytesPerSector"),
        winapi.C_LONG.withName("PhysicalBytesPerSectorForAtomicity"),
        winapi.C_LONG.withName("PhysicalBytesPerSectorForPerformance"),
        winapi.C_LONG.withName("FileSystemEffectivePhysicalBytesPerSectorForAtomicity"),
        winapi.C_LONG.withName("Flags"),
        winapi.C_LONG.withName("ByteOffsetForSectorAlignment"),
        winapi.C_LONG.withName("ByteOffsetForPartitionAlignment")
