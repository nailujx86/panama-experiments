...
public class _STORAGE_ALLOCATE_BC_STREAM_INPUT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_LONG.withName("RequestsPerPeriod"),
        winapi.C_LONG.withName("Period"),
        winapi.C_CHAR.withName("RetryFailures"),
        winapi.C_CHAR.withName("Discardable"),
        MemoryLayout.sequenceLayout(2, winapi.C_CHAR).withName("Reserved1"),
        winapi.C_LONG.withName("AccessType"),
        winapi.C_LONG.withName("AccessMode")
