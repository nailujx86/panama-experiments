...
public class _TXFS_GET_METADATA_INFO_OUT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        winapi.C_LONG_LONG.withName("LastLsn"),
        winapi.C_LONG.withName("TransactionState"),
    ...
    public static class TxfFileId {
        ...
        private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
            winapi.C_LONG_LONG.withName("LowPart"),
            winapi.C_LONG_LONG.withName("HighPart")
        ).withName("$anon$13917:5");
